...
// ADC-capable pins are declared as PIN_Ax so they resolve through
// analogInputPin[] (see variant.cpp). They remain usable as ordinary GPIO.
#define PA0    PIN_A0
#define PA1    PIN_A1
#define PA2    PIN_A2
#define PA3    PIN_A3
...
// SPI Definitions - SPI1 on EXP2 (SD/LCD)
#define PIN_SPI_SS              PA4
#define PIN_SPI_MOSI            PA7
#define PIN_SPI_MISO            PA6
#define PIN_SPI_SCK             PA5

// I2C Definitions - No I2C header on the Leviathan (PB8/PB9 defaults unused)
...
// UART Definitions
// USART1 (PA9/PA10) is the host UART header (J9)
