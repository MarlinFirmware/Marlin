...
if pioutil.is_pio_build():
    ...
    def sanity_check_target():
        ...
        #
        if 'FILAMENT_RUNOUT_SENSOR' in env['MARLIN_FEATURES']:
            if 'NUM_RUNOUT_SENSORS' in env['MARLIN_FEATURES']:
                if env['MARLIN_FEATURES']['NUM_RUNOUT_SENSORS'].isdigit():
                    if int(env['MARLIN_FEATURES']['NUM_RUNOUT_SENSORS']) > 1:
