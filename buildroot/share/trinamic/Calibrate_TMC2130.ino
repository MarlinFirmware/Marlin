  ...
  while (1) {
    if (Serial.available() > 0) {
      ...
      if (c == "1+") {
        ...
        if (config.stealth_freq == 3) Serial.println(F("Max stealth_freq=3"));
        else {
          config.stealth_freq++;
          reportCurrentSettings();
          driver.stealth_freq(config.stealth_freq);
