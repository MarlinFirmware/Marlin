...
#
LANGS_DEFAULT="an bg ca cz da de el el_CY en es eu fi fr fr_na gl hinglish hr hu id it jp_kana ko_KR nl pl pt pt_br ro ru sk sv tr uk vi zh_CN zh_TW test"
