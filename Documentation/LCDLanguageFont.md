...
* Full graphic displays
  ...
  Until now we used a
  1.) Marlin-font similar to ISO10646-1 but with special Symbols at the end what made 'ц' and 'ь' unaccessible in the size 6x10.
...
## The Languages
  ...
  * jp    [Japanese](http://www.thingiverse.com/thing:664397)
  ...
  The Germans want to use "ƒa÷ц№ья" the Finnish at least "дц". Other European languages want to see their accents an their letters.
  ...
  The German translation used utf8 'д' and 'ь' and did not care about showing garbage on all displays.
...
## Translators handbook
  ...
  d.) With a mapper different to MAPPER_NON UTF8 input is used. Instead of "\xe1" (on a display with Japanese font) or STR_ae simply use "?". When the string is read byte by byte , the "?" will expand to "\0xc3\0xa4" or "Я" will expand to "0xd0\0xaf" or "?" will expand to "\0xe3\0x83\0x9b"
