...
#define STRING_CONFIG_H_AUTHOR "(DrDitto, SKR V1.3 For Tevo Flash )" // Who made the changes.
...
//Displayed in the LCD "Ok" message
#define CUSTOM_MACHINE_NAME "Tevo Flash SKR V1.3, (XYZ TMC2208), (E0,E1 LV8729),(All Enabled)"
...
#ifdef DEFAULT_LCD_CONTRAST
  #undef DEFAULT_LCD_CONTRAST
  #define DEFAULT_LCD_CONTRAST 185
#endif
#endif
