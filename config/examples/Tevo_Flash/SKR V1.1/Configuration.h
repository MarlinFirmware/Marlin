...
#define STRING_CONFIG_H_AUTHOR "(DrDitto, SKR V1.1 For Tevo Flash )" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tevo Flash SKR V1.1, (XYZ TMC2208-SA), (E0,E1 LV8729),(All Enabled)"
