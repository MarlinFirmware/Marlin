...
#define STRING_CONFIG_H_AUTHOR "(olli, olli mk1 config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 3200, 415 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.74   // Z offset: -below +above  [the nozzle]
