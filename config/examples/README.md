...
If you want to start optimization, tuning and adoption, the following configurations are a good starting point.
  ...
  | Creality<br />__CR 20 pro__ | [config/examples/Creality/CR-20 Pro](Creality/CR-20 pro)<br />`N/A` | [Creality](Creality) __[Ramps](../../Marlin/src/pins/ramps/pins_BOARD_RAMPS_14_EFB.h)__ (w/ A4988)<br />`BOARD_BOARD_RAMPS_14_EFB` |
