 ...
 */
  ...
  //#define PID_EXTRUSION_SCALING //no noticable gains
 ...
 */
#define CASE_LIGHT_ENABLE //the led header on the board will power a small strip of leds tested working
...
#if ENABLED(BLTOUCH)
#define Z_MIN_PROBE_REPEATABILITY_TEST //costs 76b // Enable the M48 repeatability test to test probe accuracy
  /**
...
// Not working O
//#define XY_FREQUENCY_LIMIT  15 //negative probe accuracy effect
 ...
 */
//#define ADAPTIVE_STEP_SMOOTHING // negative probe accuracy effect
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { HOMING_FEEDRATE_XY, HOMING_FEEDRATE_XY, HOMING_FEEDRATE_Z, 60 } // Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LCD_SHOW_E_TOTAL
  ...
  //#define LCD_PROGRESS_BAR              // Show a progress bar on HD44780 LCDs for SD printing
    ...
    #define PROGRESS_BAR_MSG_TIME 60000    // (ms) Amount of time to show the status message
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.2       // Unit: mm compression per 1mm/s extruder speed // 0 is effectivly off
...
#if DISABLED (GTA30) && DISABLED (GTE180) && DISABLED (GTM201)
#define EMERGENCY_PARSER // saves 13b
#endif
...
//#define ADVANCED_OK //negative effect on probe accuracy
 ...
 */
#define ADVANCED_PAUSE_FEATURE //52b
 ...
 */
#define NO_VOLUMETRICS //VOLUMETRICS does not work with linear advance
 ...
 */
#define CUSTOM_USER_MENUS //free
#if ENABLED(CUSTOM_USER_MENUS)
  #define CUSTOM_USER_MENU_TITLE "Lin Adv Presets"
  #define USER_SCRIPT_DONE "M117 Lin Adv Set"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "K0.2 PLA"
  #define USER_GCODE_1 "M900 K0.2\nM500"

  #define USER_DESC_2 "K0.3 PETG"
