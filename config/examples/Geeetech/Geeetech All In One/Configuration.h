 ...
 */
#pragma once
#include "Start_here.h" // adds code from build.h
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#if ENABLED (GTA30) || ENABLED (GTE180) || ENABLED (GTM201) 
...
// Choose the name from boards.h that matches your setup
  ...
  #elif ENABLED (GTA30) || ENABLED (GTE180) || ENABLED (GTM201) 
  #define MOTHERBOARD BOARD_GTM32_PRO_VB //A30/E180/M201
  #endif 
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #elif ENABLED (MIX) || ENABLED (MIXT) || ENABLED (CYCLOPS) || ENABLED (CYCLOPST) || ENABLED (DUELEX) || ENABLED (TRIEX)
...
//#define NOZZLE_TO_PROBE_OFFSET { -37, -1, 0 } //moved

// Certain types of probes need to stay away from edges
//#define MIN_PROBE_EDGE 10 //moved
...
#define Z_PROBE_SPEED_SLOW 30 // slower tends to be more accurate 30-60 seems to be the sweet spot
 ...
 */
//#define MULTIPLE_PROBING 2   //testing showed multi probing degraded accuracy
//#define EXTRA_PROBING    1   //reduced speed enchanced accuracy
...
#define Z_CLEARANCE_DEPLOY_PROBE    ZCLEARANCE // Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  ZCLEARANCE // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     ZCLEARANCE // Z Clearance between multiple probes
#define Z_AFTER_PROBING             ZCLEARANCE // Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping

// For M851 give a range for adjusting the Z probe offset
#define Z_PROBE_OFFSET_RANGE_MIN -10  // realistic values
...
#define Z_HOMING_HEIGHT ZCLEARANCE  // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#elif ENABLED (I3PROW) || ENABLED (I3PROC) || ENABLED (I3PROB) || ENABLED (I3PROA)
...
#if ENABLED (MECREATOR2) || ENABLED (I3PROW) || ENABLED (I3PROC) || ENABLED (I3PROA) || ENABLED (I3PROX) || ENABLED (GTM201)
#define X_MIN_POS 0 
#define Y_MIN_POS 0
#elif ENABLED (I3PROB)
#define X_MIN_POS -12
 ...
 */
#if DISABLED (GTA30) && DISABLED (GTE180) && ENABLED (RUNOUT)
#define FILAMENT_RUNOUT_SENSOR 
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
   #if ENABLED (MIXT) || ENABLED (CYCLOPST)
   #define NUM_RUNOUT_SENSORS   1
   #define FIL_RUNOUT_PIN      66
   //#define FIL_RUNOUT2_PIN     67
   //#define FIL_RUNOUT3_PIN     68
   #elif ENABLED (MIX) || ENABLED (CYCLOPS)
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  //#define G26_MESH_VALIDATION     //total waste
...
#define LEVEL_BED_CORNERS // only use with UBL deactivated
  ...
  #define LEVEL_CORNERS_Z_HOP  ZCLEARANCE  // (mm) Move nozzle up before moving between corners
 ...
 */
#define NOZZLE_PARK_FEATURE //12b
...
//
#if ENABLED (GTA10) || ENABLED (I3PROW) || ENABLED (MECREATOR2) || ENABLED (GTA30) || ENABLED (GTE180) || ENABLED (I3PROA) || ENABLED (I3PROB) || ENABLED (I3PROC) || ENABLED (I3PROX) || ENABLED (GTM201) 
