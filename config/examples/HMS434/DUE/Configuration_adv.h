 ...
 */
  ...
  #define THERMAL_PROTECTION_CHAMBER_PERIOD     1800 // Seconds
...
#define TEMP_SENSOR_AD595_GAIN    1.348
...
#define MIN_STEPS_PER_SEGMENT 2 // mm/step 6micron for X, 5micron for Y, 1micron for Z , 7micron for E
