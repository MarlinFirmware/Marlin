...
/**
 * Anet V1.0 Controller board pin assignments for PipetBot-A8 by DerAndere
 * Copyright 2018 - 2020 DerAndere
 *
 * This Software is includes parts of
 * Marlin 3D Printer Firmware
 * Copyright (c) 2020 MarlinFirmware [https://github.com/MarlinFirmware/Marlin]
 *
 * This Software is includes parts of
 * SkyNet3D Marlin (Anet V1.0 board pin assignments Rev B)
 * Copyright 2017 Hans Raaf (oderwat)
