...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN P2_04 // HEATER_1_PIN (HE1) // Set a custom pin for the controller fan
 ...
 */
#define E0_AUTO_FAN_PIN P1_28 // X_MAX_PIN
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN P1_26 // Y_MAX_PIN // Override the default pin if needed
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 18*60, 200 } // Feedrates for manual moves along X, Y, Z, E from panel
...
#define MICROSTEP_MODES { 16, 16, 32, 16, 16, 16 } // [1,2,4,8,16]
...
#define LCD_TIMEOUT_TO_STATUS 120000 // 2 min
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL    400  // (mm/s^2) Lower acceleration may allow a faster feedrate.
 ...
 */
  ...
  #define Z_HYBRID_THRESHOLD      18 // stay in stealth
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Enc Heater On"
  #define USER_GCODE_1 "M42 P63 S255"

  #define USER_DESC_2 "Enc Heater Off"
  #define USER_GCODE_2 "M42 P63 S0"
