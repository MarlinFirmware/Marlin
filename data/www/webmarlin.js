  ...
  Connect: function() {
    try {
      if(wmWebSoket.WSObject === null) {
        jsLog.Debug("WebSocket: Trying connecting to "+wmSettings.WsUrl);
        wmWebSoket.WSObject = new WebSocket(wmSettings.WsUrl);
        wmWebSoket.SetWsStatusBar(wmWebSoket.WSObject.readyState);
        wmWebSoket.WSObject.onopen = function () {
          jsLog.Info("WebSocket: Successfully connected to " + wmSettings.WsUrl);
          wmWebSoket.SetWsStatusBar(wmWebSoket.WSObject.readyState);
          WmControls.Enable(WmButtonGroups.All());
          wmWebSoket.Send(wmGCommands.SdPrintStatus);
        };
        wmWebSoket.WSObject.onclose = function () {
          jsLog.Info("WebSocket: Disconnected from "+wmSettings.WsUrl);
  ...
  SetWsStatusBar: function(rs) {
    ...
    switch (rs) {
      case wmEnums.WSSatuses.CONNECTING:
        cli.SetValues("Connecting to "+wmSettings.WsUrl, wmEnums.WSMsgDirection.SENT, wmEnums.ConsoleLevels.INFO);
      ...
      case wmEnums.WSSatuses.OPEN:
        cli.SetValues("Connected to "+wmSettings.WsUrl, wmEnums.WSMsgDirection.RECEIVED, wmEnums.ConsoleLevels.SUCCESS);
      ...
      case wmEnums.WSSatuses.CLOSED:
        cli.SetValues("Disconnected from "+wmSettings.WsUrl, wmEnums.WSMsgDirection.RECEIVED, wmEnums.ConsoleLevels.ERROR);
      ...
      case wmEnums.WSSatuses.CLOSING:
        cli.SetValues("Disconnecting from "+wmSettings.WsUrl, wmEnums.WSMsgDirection.SENT, wmEnums.ConsoleLevels.WARNING);
