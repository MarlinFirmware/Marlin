...
/// **************************new******************************************
//*******************************adaptate pins to z_min_endstop for MKS 1.4 board
#if ENABLED(Z_MIN_PROBE_ENDSTOP)
  // Define a pin to use as the signal pin on Arduino for the Z_PROBE endstop.
  #if MB(MKS_BASE) //BOARD_MKS_BASE ***************************************************************************** evaluar **************************+
    #define Z_MIN_PROBE_PIN 18 // evaluar si funciona*****MKS 1.4 board for Delta printer need this*****
  #else
    #define Z_MIN_PROBE_PIN 32 // 32 this for ramps_14.h only 
  #endif
#endif
