...
#define HEATER_0_MINTEMP 0 //Cambiar esto a 5 cuando montemos los termisores
#define HEATER_1_MINTEMP 0 //Cambiar esto a 5 cuando montemos los termisores
#define HEATER_2_MINTEMP 0 
#define BED_MINTEMP 5      //Cambiar esto a 5 cuando montemos los termisores
...
#define DEFAULT_RETRACT_ACCELERATION  5000   //3000 X, Y, Z and E max acceleration in mm/s^2 for r retracts

// Offset of the extruders (uncomment if using more than one and relying on firmware to position when changing).
// The offset has to be X=0, Y=0 for the extruder 0 hotend (default extruder).
// For the other hotends it is their distance from the extruder 0 hotend.
#define EXTRUDER_OFFSET_X {0.0,-34.5} // (in mm) for each extruder, offset of the hotend on the X axis
