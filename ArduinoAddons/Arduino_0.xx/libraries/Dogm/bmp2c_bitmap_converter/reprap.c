...
//const unsigned char code reprapbmp[]= { //Keil
//const rom unsigned char reprapbmp[]= { //Microchip C18
//const unsigned char reprapbmp[]= { //SDCC

prog_uchar reprapbmp[]= { //AVR-GCC, WinAVR
