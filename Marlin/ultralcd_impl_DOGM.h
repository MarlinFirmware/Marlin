...
// LCD selection
  ...
  // The MINIPanel display
    ...
    //U8GLIB_MINI12864 u8g(DOGLCD_SCK,DOGLCD_MOSI,DOGLCD_CS, DOGLCD_A0,U8G_PIN_NONE); // 8 stripes
    U8GLIB_MINI12864_2X u8g(DOGLCD_SCK, DOGLCD_MOSI, DOGLCD_CS, DOGLCD_A0, U8G_PIN_NONE); // 4 stripes
  #else
