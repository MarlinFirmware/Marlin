...
#define MSG_PROGRESS_BAR_TEST               _UxGT("Barra de Progresso Teste")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("Fim nivelacao!")
...
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Editar Malha Customizada")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("Ajuste Fino da Malha")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Fim da Edicao da Malha")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Montar malha Customizada")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("Montar malha")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("Montar malha PLA")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("Montar malha ABS")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Montar malha fria")
#define MSG_UBL_MESH_HEIGHT_ADJUST          _UxGT("Ajustar altura da malha")
#define MSG_UBL_MESH_HEIGHT_AMOUNT          _UxGT("Tamanho da Elevacao")
#define MSG_UBL_VALIDATE_MESH_MENU          _UxGT("Checar Malha")
#define MSG_UBL_VALIDATE_PLA_MESH           _UxGT("Checar Malha PLA")
#define MSG_UBL_VALIDATE_ABS_MESH           _UxGT("Checar Malha ABS")
#define MSG_UBL_VALIDATE_CUSTOM_MESH        _UxGT("Checar Malha Customizada")
#define MSG_UBL_CONTINUE_MESH               _UxGT("Continuar malha da mesa")
#define MSG_UBL_MESH_LEVELING               _UxGT("Nivelacao da Malha")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("Nivelacao 3 pontos")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Nivelacao da malha em grade")
...
#define MSG_UBL_OUTPUT_MAP_HOST             _UxGT("Enviar malha para o Host")
#define MSG_UBL_OUTPUT_MAP_CSV              _UxGT("Salvar malha CSV")
#define MSG_UBL_OUTPUT_MAP_BACKUP           _UxGT("Salvar backup da malha")
#define MSG_UBL_INFO_UBL                    _UxGT("Informacao do UBL")
#define MSG_UBL_EDIT_MESH_MENU              _UxGT("Editar Malha")
#define MSG_UBL_FILLIN_AMOUNT               _UxGT("Quantidade de Enchimento")
...
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("Ajuste fino de Tudo")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Ajuste fino do Próximo")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Armazenamento da Malha")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot de Memória")
#define MSG_UBL_LOAD_MESH                   _UxGT("Ler malha da mesa")
#define MSG_UBL_SAVE_MESH                   _UxGT("Salvar malha da mesa")
...
#define MSG_UBL_RESTORE_ERROR               _UxGT("Erro ao restaurar UBL")
...
#define MSG_USERWAIT                        _UxGT("Clique para continuar")
...
#define MSG_SKEW_FACTOR                     _UxGT("Fator de Cisalhamento")
...
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("Erro: Temperatura Redundante")
#define MSG_THERMAL_RUNAWAY                 _UxGT("ESCAPE TERMICO")
#define MSG_ERR_MAXTEMP                     _UxGT("Erro: Maxima Temperatura")
#define MSG_ERR_MINTEMP                     _UxGT("Erro: Minima Temperatura")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Erro: Mesa Maxima Temperatura")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Erro: Mesa Minima Temperatura")
...
#define MSG_DELTA_SETTINGS                  _UxGT("Config. Delta")
#define MSG_DELTA_AUTO_CALIBRATE            _UxGT("Calibracao Automatica")
#define MSG_DELTA_HEIGHT_CALIBRATE          _UxGT("Calibrar Delta Altura")
#define MSG_DELTA_DIAG_ROD                  _UxGT("Haste Diagonal")
#define MSG_DELTA_HEIGHT                    _UxGT("Delta Altura")
#define MSG_DELTA_RADIUS                    _UxGT("Delta Raio")
...
#define MSG_UBL_LEVELING                    _UxGT("UBL-Nivelamento Unificado de Mesa ")
...
#define MSG_INFO_PRINT_COUNT                _UxGT("Contagem de Impressao")
...
#define MSG_DAC_EEPROM_WRITE                _UxGT("ESCREVER EEPROM COM DAC")
#define MSG_FILAMENT_CHANGE_HEADER          _UxGT("IMPR. PAUSADA")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("OPCÕES PARA CONTINUAR:")
...
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temperatura Minnima ")
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Bocal: ")
#define MSG_ERR_HOMING_FAILED               _UxGT("Falha ao Ir para origem")
...
#define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Esperando ")
#define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("extrusao de filamento")
