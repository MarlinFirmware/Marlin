...
#define MSG_Z_FADE_HEIGHT                   _UxGT("Vervaag Hoogte")
...
#define MSG_LEVEL_CORNERS                   _UxGT("Level hoeken")
#define MSG_NEXT_CORNER                     _UxGT("Volgende hoek")
#define MSG_EDITING_STOPPED                 _UxGT("Mesh bewerken gestopt")
#define MSG_USER_MENU                       _UxGT("Aangepaste Commands")
#define MSG_UBL_DOING_G29                   _UxGT("G29 aan het doen")
#define MSG_UBL_UNHOMED                     _UxGT("Home XYZ eerst")
#define MSG_UBL_TOOLS                       _UxGT("UBL Gereedschap")
#define MSG_UBL_LEVEL_BED                   _UxGT("Unified Bed Leveling")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Handmatig Mesh opbouwen")

#define MSG_UBL_BC_INSERT                   _UxGT("Plaats de shim & meet")
#define MSG_UBL_BC_INSERT2                  _UxGT("Meet")
#define MSG_UBL_BC_REMOVE                   _UxGT("Verwijder & meet bed")
#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Verhuizen naar de volgende")
#define MSG_UBL_ACTIVATE_MESH               _UxGT("Activeer UBL")
#define MSG_UBL_DEACTIVATE_MESH             _UxGT("Deactiveer UBL")
#define MSG_UBL_SET_BED_TEMP                _UxGT("Bed Temp")
#define MSG_UBL_CUSTOM_BED_TEMP             MSG_UBL_SET_BED_TEMP
#define MSG_UBL_SET_HOTEND_TEMP             _UxGT("Hotend Temp")
#define MSG_UBL_CUSTOM_HOTEND_TEMP          MSG_UBL_SET_HOTEND_TEMP
#define MSG_UBL_MESH_EDIT                   _UxGT("Mesh Aanpassen")
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Custom mesh bewerken")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("Fine Tuning Mesh")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Klaar met bewerken van de Mesh")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Bouw Custom mesh")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("Bouw Mesh")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("Bouw PLA Mesh")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("Bouw ABS Mesh")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Bouw Cold Mesh")
#define MSG_UBL_MESH_HEIGHT_ADJUST          _UxGT("Pas de Mesh aan")
#define MSG_UBL_MESH_HEIGHT_AMOUNT          _UxGT("Height Amount")
#define MSG_UBL_VALIDATE_MESH_MENU          _UxGT("Valideer Mesh")
#define MSG_UBL_VALIDATE_PLA_MESH           _UxGT("Valideer PLA Mesh")
#define MSG_UBL_VALIDATE_ABS_MESH           _UxGT("Valideer ABS Mesh")
#define MSG_UBL_VALIDATE_CUSTOM_MESH        _UxGT("Valideer Custom Mesh")
#define MSG_UBL_CONTINUE_MESH               _UxGT("Continue Bed Mesh")
#define MSG_UBL_MESH_LEVELING               _UxGT("Mesh Leveling")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("3-Punt Leveling")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Grid Mesh Leveling")
#define MSG_UBL_MESH_LEVEL                  _UxGT("Level Mesh")
#define MSG_UBL_SIDE_POINTS                 _UxGT("Zijpunten")
#define MSG_UBL_MAP_TYPE                    _UxGT("Kaartsoort")
#define MSG_UBL_OUTPUT_MAP                  _UxGT("Output Mesh kaart")
#define MSG_UBL_OUTPUT_MAP_HOST             _UxGT("Output voor Host")
#define MSG_UBL_OUTPUT_MAP_CSV              _UxGT("Output voor CSV")
#define MSG_UBL_OUTPUT_MAP_BACKUP           _UxGT("Uit Printerback-up")
#define MSG_UBL_INFO_UBL                    _UxGT("Output UBL Info")
#define MSG_UBL_EDIT_MESH_MENU              _UxGT("Mesh bewerken")
#define MSG_UBL_FILLIN_AMOUNT               _UxGT("Invul Aantal")
#define MSG_UBL_MANUAL_FILLIN               _UxGT("Handmatig invullen")
#define MSG_UBL_SMART_FILLIN                _UxGT("Slim invullen")
#define MSG_UBL_FILLIN_MESH                 _UxGT("Invul Mesh")
#define MSG_UBL_INVALIDATE_ALL              _UxGT("Alles ongeldig maken")
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Maak dichtbijzijnste ongeldig")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("Stem alles af")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Dichtbijzijnste afstellen")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Mesh opslag")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Geheugenslot")
#define MSG_UBL_LOAD_MESH                   _UxGT("Laad Bed Mesh")
#define MSG_UBL_SAVE_MESH                   _UxGT("Bed Mesh Opslaan")
#define MSG_MESH_LOADED                     _UxGT("Mesh %i geladen")
#define MSG_MESH_SAVED                      _UxGT("Mesh %i opgeslagen")
#define MSG_NO_STORAGE                      _UxGT("Geen opslag")
#define MSG_UBL_SAVE_ERROR                  _UxGT("Err: UBL Opslaan")
#define MSG_UBL_RESTORE_ERROR               _UxGT("Err: UBL Herstellen")
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("Z-Offset Gestopt")
#define MSG_UBL_STEP_BY_STEP_MENU           _UxGT("Stap-voor-Stap UBL")
#define MSG_LED_CONTROL                     _UxGT("LED Bediening")
#define MSG_LEDS                            _UxGT("Licht")
#define MSG_LED_PRESETS                     _UxGT("Licht voorinstellingen")
#define MSG_SET_LEDS_RED                    _UxGT("Rood")
#define MSG_SET_LEDS_ORANGE                 _UxGT("Orange")
#define MSG_SET_LEDS_YELLOW                 _UxGT("Geel")
#define MSG_SET_LEDS_GREEN                  _UxGT("Groen")
#define MSG_SET_LEDS_BLUE                   _UxGT("Blauw")
#define MSG_SET_LEDS_INDIGO                 _UxGT("Indigo")
#define MSG_SET_LEDS_VIOLET                 _UxGT("Paars")
#define MSG_SET_LEDS_WHITE                  _UxGT("Wit")
#define MSG_SET_LEDS_DEFAULT                _UxGT("Standaard")
#define MSG_CUSTOM_LEDS                     _UxGT("Custom verlichting")
#define MSG_INTENSITY_R                     _UxGT("Rood Intensiteit")
#define MSG_INTENSITY_G                     _UxGT("Groen Intensiteit")
#define MSG_INTENSITY_B                     _UxGT("Blauw Intensiteit")
#define MSG_INTENSITY_W                     _UxGT("Wit Intensiteit")
#define MSG_LED_BRIGHTNESS                  _UxGT("Helderheid")
...
#define MSG_EXTRA_FAN_SPEED                 _UxGT("Extra fan snelheid")
...
#define MSG_VELOCITY                        _UxGT("Snelheid")
#define MSG_VMAX                            _UxGT("Vmax ")
#define MSG_VMIN                            _UxGT("Vmin")
#define MSG_VTRAV_MIN                       _UxGT("VTrav min")
#define MSG_ACCELERATION                    _UxGT("Versnelling")
...
#define MSG_FILAMENT_UNLOAD                 _UxGT("Ontlaad mm")
#define MSG_FILAMENT_LOAD                   _UxGT("Laad mm")
...
#define MSG_POWER_LOSS_RECOVERY             _UxGT("Stroomuitval herstel")
...
#define MSG_PRINT_PAUSED                    _UxGT("Print onderbroken")
#define MSG_PRINTING                        _UxGT("Printen...")
...
//above this line is synced until English file; 723 of https://github.com/MarlinFirmware/Marlin/blob/1.1.x/Marlin/language_en.h
