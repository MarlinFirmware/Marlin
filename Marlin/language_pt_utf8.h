...
#define MSG_SD_INSERTED                     _UxGT("CartГЈo inserido")
#define MSG_SD_REMOVED                      _UxGT("CartГЈo removido")
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("PrГіximo ponto")
...
#define MSG_PREHEAT_1_SETTINGS              _UxGT("DefiniГ§Гµes PLA")
...
#define MSG_PREHEAT_2_SETTINGS              _UxGT("DefiniГ§Гµes ABS")
...
#define MSG_AUTOTEMP                        _UxGT("Temp. AutomГЎtica")
...
#define MSG_A_RETRACT                       _UxGT("A-retracГ§ГЈo")
...
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impressГЈo")
#define MSG_RESUME_PRINT                    _UxGT("Retomar impressГЈo")
#define MSG_STOP_PRINT                      _UxGT("Parar impressГЈo")
#define MSG_CARD_MENU                       _UxGT("Imprimir do SD")
#define MSG_NO_CARD                         _UxGT("Sem cartГЈo SD")
#define MSG_DWELL                           _UxGT("Em espera...")
#define MSG_USERWAIT                        _UxGT("ГЃ espera de ordem")
#define MSG_PRINT_ABORTED                   _UxGT("ImpressГЈo cancelada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("EMERGГЉNCIA. ")
...
#define MSG_INIT_SDCARD                     _UxGT("Inici. cartГЈo SD")
#define MSG_CNG_SDCARD                      _UxGT("Trocar cartГЈo SD")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Err: T MГЎxima")
#define MSG_ERR_MINTEMP                     _UxGT("Err: T MГ­nima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Err: T Base MГЎxima")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Err: T Base MГ­nima")
#define MSG_HEATING                         _UxGT("Aquecendo...")
#define MSG_BED_HEATING                     _UxGT("Aquecendo base...")
#define MSG_DELTA_CALIBRATE                 _UxGT("CalibraГ§ГЈo Delta")
