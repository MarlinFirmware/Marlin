 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 373 } //H2V2S 932, BMG 373
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, 0, 0 } //{ 55, 0, 0 } //H2V2S
...
#define INVERT_E0_DIR true //false, true for BMG Wind
