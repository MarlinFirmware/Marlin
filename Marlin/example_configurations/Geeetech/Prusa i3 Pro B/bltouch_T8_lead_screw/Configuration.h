...
#define STRING_CONFIG_H_AUTHOR "(Wysocki, Gtech 1.1.8 02212018)" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.29  // Z offset: -below +above  [the nozzle]
