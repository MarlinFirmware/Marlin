...
#define STRING_CONFIG_H_AUTHOR "(Martin Kuvandzhiev, GT2560 config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_GT2560
#endif
...
#define PID_AUTOTUNE_MENU // Add PID Autotune to the LCD "Temperature" menu to run M303 and apply the result.
  ...
  // Geeetech Prusa i3 Pro B - MK8 Extruder

  #define DEFAULT_Kp 13.27
  #define DEFAULT_Ki 0.45
  #define DEFAULT_Kd 98.13
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //from pidautotune
  #define  DEFAULT_bedKp 312.62
  #define  DEFAULT_bedKi 50.48
  #define  DEFAULT_bedKd 484.01
...
#define HOMING_FEEDRATE {3000, 3000, 240, 0}  // set the homing speeds (mm/min)   ***** MakiBox A6 *****

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,93}  // MXL, Z M8=1.25, MK8
#define DEFAULT_MAX_FEEDRATE          {400, 400, 2, 45}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,50,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
