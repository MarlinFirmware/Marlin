...
#define EXTRUDER_1_AUTO_FAN_PIN 5   // If EXTRUDERS == 1, a 2nd fan for extruder 0 may be connected here
                                    // TODO: (Re-)implement this redundant fan feature
...
//===========================================================================
  ...
  #define FSR_TRIGGER_ADJUST 20         // At minimum, there should be an increase of xx degrees to trigger, changeable
  #define FSR_RECOVERY_ADJUST 8         // Value to bump up or down the threshold for recovery by
