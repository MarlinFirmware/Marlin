...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 38
...
#define Z_HOME_BUMP_MM 4 // deltas need the same for all three axes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_Y_POS -120               // Y position of hotend
  #define PAUSE_PARK_Z_ADD 10                 // Z addition of hotend (lift)
  #define PAUSE_PARK_XY_FEEDRATE 100          // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define PAUSE_PARK_Z_FEEDRATE 100           // Z axis feedrate in mm/s (not used for delta printers)
...
//#define CUSTOM_USER_MENUS
  ...
  //#define USER_DESC_8 "Home & UBL Info"
