...
/**
 * Equipment options for My Creality CR-10 Mini
 * X=300mm  Y=220mm  Z=300Mm
 * E3DV6 Hotend
 * Titan Extruder
 * Factory display for Creality CR-10 & CR-10Mini uses //#define CR10_STOCKDISPLAY
...
//
// Enable to show the bitmap in Marlin/_Bootscreen.h on the status screen.
