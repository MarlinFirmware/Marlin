...
#define STRING_CONFIG_H_AUTHOR "(Sauron, Infitary HBi3)" // Who made the changes - http://adrian.siemieniak.net
...
#define CUSTOM_MACHINE_NAME "Infitary HBi3"
...
/**
 * PrĹŻĹˇa MK2 Single Nozzle Multi-Material Multiplexer, and variants.
 *
...
#define PID_AUTOTUNE_MENU // Add PID Autotune to the LCD "Temperature" menu to run M303 and apply the result.
  ...
  // Infinitary HBi3 MK8 extruder (with non original fan!)
  //(measured after M106 S255 with M303 E0 S210)
  // Kp: 70.29 Ki: 13.00 Kd: 95.01
  #define  DEFAULT_Kp 70.29
  #define  DEFAULT_Ki 13.00
  #define  DEFAULT_Kd 95.01
...
//
// MKS OLED 1.3" 128 Ă— 64 FULL GRAPHICS CONTROLLER
