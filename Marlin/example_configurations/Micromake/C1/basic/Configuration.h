...
#define STRING_CONFIG_H_AUTHOR "(MetalSearch, Micromake C1)" // Who made the changes.
...
#define DEFAULT_MAX_FEEDRATE          {200, 200, 200, 30} // MicroMake C1
...
#define DEFAULT_MAX_ACCELERATION      {3000,3000,3000,4000} // MicroMake C1
