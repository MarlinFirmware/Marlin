...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // is used to estimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_1_X 15	//ROBO-BH
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0	//Need to experiment with this number, should be about -1.25 mm //ROBO-BH
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 2  //How much the extruder will be raised when travelling from between next probing points	//ROBO-BH
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,810}  // default steps per unit for Robo {80,80,2560,723.38}	//ROBO-BH
...
#define DEFAULT_NOMINAL_FILAMENT_DIA  1.75  //Enter the diameter (in mm) of the filament generally used (3.0 mm or 1.75 mm) - this is then used in the slicer software.  Used for sensor reading validation //Robo
#define MEASURED_UPPER_LIMIT          2.00  //upper limit factor used for sensor reading validation in mm  //Robo
#define MEASURED_LOWER_LIMIT          1.50  //lower limit factor for sensor reading validation in mm  //Robo
