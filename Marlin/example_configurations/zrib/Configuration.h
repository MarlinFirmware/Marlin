 ...
 * it under the terms of the GNU General Public License as published byBLT
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Zonestart P802NR2 + 3mm Borosilicate
  #define  DEFAULT_bedKp 359.05
  #define  DEFAULT_bedKi 47.64
  #define  DEFAULT_bedKd 676.5
...
// GJR had 6500 here, now sticking to default
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_PROBE_PT_1_Y 25      // of the mesh.
...
//GJR: I had the following:
//#define Z_PROBE_END_SCRIPT "G1 Z15 F100\nG1 X0 Y0 F5000"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (110)    // Y point for Z homing when homing all axis (G28).
#endif
