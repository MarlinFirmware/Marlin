...
#define DEFAULT_STEPPER_DEACTIVE_TIME 60 // Hictop398=60, was=120
...
//#define LCD_DECIMAL_SMALL_XY
  ...
  #define LCD_PROGRESS_BAR // 3axis enabled
...
#define USE_WATCHDOG // 3axis disabled in Hictop398, left enabled
...
//    draining.
//
#define ENSURE_SMOOTH_MOVES // 3axis enabled
...
#if ENABLED(ULTIPANEL) // 3axis not enabled in configuration.h
