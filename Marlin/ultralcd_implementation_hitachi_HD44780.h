...
#    endif // (defined(BTN_ENC) && (BTN_ENC > -1))
...
#      else // (defined(BTN_ENC) && (BTN_ENC > -1)) 
...
#  else // Standard directly connected LCD implementations
...
#  else
  lcd.begin(LCD_WIDTH, LCD_HEIGHT);
#  endif // defined(LCDI2C_TYPE_PCF8575)
...
#    endif // (defined(LCD_I2C_PANELOLU2) || defined(LCD_I2C_VIKI))
}
