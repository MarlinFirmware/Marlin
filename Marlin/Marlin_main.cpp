 ...
 * M150 - Set Status LED Color as R<red> U<green> B<blue>. Values 0-255. (Requires BLINKM, RGB_LED or LED_STRIPO)
...
inline void gcode_M109() {
  ...
  do {
    ...
    float temp = thermalManager.degHotend(target_extruder);
        ...
        if(wait_for_heatup) {
          // Gradually change LED strip from violet to red as bed heats up
          int r, g, b;
          r = 255;
          g = 0;
          set_led_color(r, g, b);
