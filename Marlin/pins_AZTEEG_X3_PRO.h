...
#define BEEPER_PIN         33
  ...
  #undef BEEPER_PIN           // added 8 NOV 2016
  #define  BEEPER_PIN  12     // added 8 NOV 2016 - 33 isn't physically available to the LCD display
#else
...
#undef  SPINDLE_SPEED_LASER_POWER_PIN     //definitions in pins_ramps.h are no good with the AzteegX3 board
...
#undef  SPINDLE_DIR_PIN
  ...
  #endif
  #define SPINDLE_SPEED_LASER_POWER_PIN      7  // must have a hardware PWM
  #define SPINDLE_LASER_ENABLE_PIN    20  // should have a pullup resistor on this pin
