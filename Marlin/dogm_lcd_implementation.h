...
static void lcd_printPGM(const char* str) {
    char c;
    while((c = pgm_read_byte(str++)) != '\0') { u8g.print(c); }
}
...
static void _drawmenu_sd(uint8_t row, const char* pstr, const char* filename, bool isDir, bool isSelected) {
    char c;
...
#endif //__ULTRA_LCD_IMPLEMENTATION_DOGM_H
