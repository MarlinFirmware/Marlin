...
// spindle control M3, M4 & M5 commands
    ...
    #define SPINDLE_LASER_ENABLE_PIN   4     // should have a pull up/down on it
    #define SPINDLE_SPEED_LASER_POWER_PIN  6     // MUST BE A HARDWARE PWM
    #define SPINDLE_DIR_PIN    5
  #elif !(ENABLED(ULTRA_LCD) && ENABLED(NEWPANEL) \
      && (ENABLED(PANEL_ONE) || ENABLED(VIKI2) || ENABLED(miniVIKI) || ENABLED(MINIPANEL) || ENABLED(REPRAPWORLD_KEYPAD)))  // try to use AUX 2
    #define SPINDLE_LASER_ENABLE_PIN  40     // should have a pull up/down on it
    #define SPINDLE_SPEED_LASER_POWER_PIN 44     // MUST BE A HARDWARE PWM
