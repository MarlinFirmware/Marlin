...
static void lcd_implementation_status_screen() {
  ...
  #define lcd_implementation_drawmenu_setting_edit_float42(sel, row, pstr, pstr2, data, minValue, maxValue) lcd_implementation_drawmenu_setting_edit_generic(sel, row, pstr, '>', ftostr42sign(*(data)))
  ...
  #define lcd_implementation_drawmenu_setting_edit_callback_float42(sel, row, pstr, pstr2, data, minValue, maxValue, callback) lcd_implementation_drawmenu_setting_edit_generic(sel, row, pstr, '>', ftostr42sign(*(data)))
