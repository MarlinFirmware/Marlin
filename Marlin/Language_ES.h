...
const char ES_SCREEN_MOVE_INFO_TEXT[] PROGMEM           = "Se ha perdido la posicin, realice una accion antes de continuar";
...
const char ES_SCREEN_WIZARD_LANGUAGE[] PROGMEM          = "Espaol";
...
const char ES_OPTION_INFO[] PROGMEM                     = "Version";
