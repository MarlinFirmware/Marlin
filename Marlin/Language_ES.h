...
const char ES_SCREEN_UNLOAD_INFO_TEXT[] PROGMEM         = "Espera a que expulse el filamento y luego ret""\xed""ralo";
...
const char ES_SCREEN_MOVE_INFO_TEXT[] PROGMEM           = "Se ha perdido la posici""\xf3""n, realice un home antes de continuar";
...
const char ES_SCREEN_OFFSET_INFO_TEXT[] PROGMEM         = "Gira el bot""\xf3""n hasta que el extrusor toque la base";
