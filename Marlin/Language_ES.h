...
const char ES_SCREEN_EMERGENCY_TEXT[] PROGMEM           = "Mant\xe9n pulsado para desbloquear la impresora";
const char ES_SCREEN_EMERGENCY_BOX[] PROGMEM            = "Bloqueado";
const char ES_SCREEN_SD_LIST_TITLE[] PROGMEM            = "Imprimir desde SD";
const char ES_SCREEN_SD_LIST_CONFIRM[] PROGMEM          = "\xbfImprimir archivo?";
...
const char ES_SCREEN_UNLOAD_INIT_TEXT[] PROGMEM         = "\xbfIniciar proceso?";
const char ES_SCREEN_UNLOAD_HOME_TITLE[] PROGMEM        = "Retirar filamento";
const char ES_SCREEN_UNLOAD_HOME_TEXT[] PROGMEM         = "Ajustando posici\xf3n";
...
const char ES_SCREEN_UNLOAD_INFO_TEXT[] PROGMEM         = "Espera a que expulse el filamento y luego ret\xedralo";
...
const char ES_SCREEN_UNLOAD_CONFIRM_TEXT[] PROGMEM      = "\xbfTodo correcto?";
const char ES_SCREEN_LOAD_INIT_TITLE[] PROGMEM          = "Insertar filamento";
const char ES_SCREEN_LOAD_INIT_TEXT[] PROGMEM           = "\xbfIniciar proceso?";
const char ES_SCREEN_LOAD_HOME_TITLE[] PROGMEM          = "Insertar filamento";
const char ES_SCREEN_LOAD_HOME_TEXT[] PROGMEM           = "Ajustando posici\xf3n";
...
const char ES_SCREEN_LOAD_CONFIRM_TEXT[] PROGMEM        = "\xbfTodo correcto?";
const char ES_SCREEN_LEVEL_INIT_TITLE[] PROGMEM         = "Nivelar base";
const char ES_SCREEN_LEVEL_INIT_TEXT[] PROGMEM          = "\xbfIniciar proceso?";
const char ES_SCREEN_LEVEL_PREHEATING_TITLE[] PROGMEM   = "Temperatura";
const char ES_SCREEN_LEVEL_HOMING_TITLE[] PROGMEM       = "Home";
const char ES_SCREEN_LEVEL_HOMING_TEXT[] PROGMEM        = "Ajustando posici\xf3n...";
...
const char ES_SCREEN_LEVEL_CONFIRM_TEXT[] PROGMEM       = "\xbfTodo correcto?";
const char ES_SCREEN_AUTOHOME_INIT_TITLE[] PROGMEM      = "Home";
const char ES_SCREEN_AUTOHOME_INIT_TEXT[] PROGMEM       = "\xbfIniciar proceso?";
const char ES_SCREEN_AUTOHOME_HEATING_TITLE[] PROGMEM   = "Temperatura";
const char ES_SCREEN_AUTOHOME_HOMING_TITLE[] PROGMEM    = "Home";
const char ES_SCREEN_AUTOHOME_HOMING_TEXT[] PROGMEM     = "Ajustando posici\xf3n";
const char ES_SCREEN_SETTINGS_TITLE[] PROGMEM           = "Ajustes";
const char ES_SCREEN_SETTINGS_TEXT[] PROGMEM            = "Selecciona opci\xf3n";
const char ES_SCREEN_MOVE_INFO_TITLE[] PROGMEM          = "Mover ejes";
const char ES_SCREEN_MOVE_INFO_TEXT[] PROGMEM           = "Se ha perdido la posici\xf3n, realice un home antes de continuar";
const char ES_SCREEN_MOVE_TITLE[] PROGMEM               = "Mover ejes";
const char ES_SCREEN_MOVE_TEXT[] PROGMEM                = "Selecciona opci\xf3n";
const char ES_SCREEN_MOVE_CONFIRM_TITLE[] PROGMEM       = "Extrusor / Mover mm";
const char ES_SCREEN_MOVE_CONFIRM_TEXT[] PROGMEM        = "\xbfCalentar extrusor?";
const char ES_SCREEN_MOVE_HEATING_TITLE[] PROGMEM       = "Temperatura";
const char ES_SCREEN_MOVE_X_TITLE[] PROGMEM             = "Eje X / Mover mm";
const char ES_SCREEN_MOVE_X_TEXT[] PROGMEM              = "Selecciona opci\xf3n";
const char ES_SCREEN_MOVE_Y_TITLE[] PROGMEM             = "Eje Y / Mover mm";
const char ES_SCREEN_MOVE_Y_TEXT[] PROGMEM              = "Selecciona opci\xf3n";
const char ES_SCREEN_MOVE_Z_TITLE[] PROGMEM             = "Eje Z / Mover mm";
const char ES_SCREEN_MOVE_Z_TEXT[] PROGMEM              = "Selecciona opci\xf3n";
const char ES_SCREEN_MOVE_E_TITLE[] PROGMEM             = "Extrusor / Mover mm";
const char ES_SCREEN_MOVE_E_TEXT[] PROGMEM              = "Selecciona opci\xf3n";
...
const char ES_SCREEN_INFO_TITLE[] PROGMEM               = "Versi\xf3n";
const char ES_SCREEN_OFFSET_INIT_TITLE[] PROGMEM        = "Ajustar offset";
const char ES_SCREEN_OFFSET_INIT_TEXT[] PROGMEM         = "\xbfIniciar proceso?";
...
const char ES_SCREEN_OFFSET_HOME_TEXT[] PROGMEM         = "Ajustando posici\xf3n...";
...
const char ES_SCREEN_OFFSET_INFO_TEXT[] PROGMEM         = "Gira el bot\xf3n hasta que el extrusor toque la base";
const char ES_SCREEN_OFFSET_SET_TITLE[] PROGMEM         = "Ajustar offset";
const char ES_SCREEN_OFFSET_FINISH_TITLE[] PROGMEM      = "Finalizado";
const char ES_SCREEN_OFFSET_FINISH_TEXT[] PROGMEM       = "\xbfTodo correcto?";
...
const char ES_SCREEN_PRINT_COMPLETE_TITLE[] PROGMEM     = "Impresi\xf3n finalizada";
...
const char ES_SCREEN_CHANGE_INIT_TEXT[] PROGMEM         = "\xbfIniciar proceso?";
...
const char ES_SCREEN_CHANGE_INFO1_TEXT[] PROGMEM        = "Espera a que expulse el filamento y luego ret\xedralo";
...
const char ES_SCREEN_CHANGE_CONFIRM_TEXT[] PROGMEM      = "\xbfTodo correcto?";
...
const char ES_SCREEN_WIZARD_LANGUAGE[] PROGMEM          = "Espa\xf1ol";
const char ES_SCREEN_WIZARD_TEXT1[] PROGMEM             = "\xa1Bienvenido! Vamos a empezar preparando la impesora";
...
const char ES_SCREEN_WIZARD_TEXT4[] PROGMEM             = "\xa1Disfruta de tu MACHINE_NAME! Si puedes imaginarlo puedes hacerlo";
...
const char ES_OPTION_INFO[] PROGMEM                     = "Versi\xf3n";
