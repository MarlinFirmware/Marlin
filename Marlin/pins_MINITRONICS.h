...
//  M3, M4 & M5 support
//
#if ENABLED(SPINDLE_ENABLE)  // assumes we're only doing CNC work (no 3D printing)
  ...
  #define SPINDLE_ENABLE_PIN 52 // using A6 because it already has a pull up on it
  #define SPINDLE_SPEED_PIN   3 // WARNING - LED & resistor pull up to +12/+24V stepper voltage
