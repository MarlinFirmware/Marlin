...
//#define USE_CONTROLLER_FAN
    ...
    #define CONTROLLERFAN_SPEED_MIN         70 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
#define COOLER_AUTO_FAN_PIN -1 // default pin setting -1 to disable cooler

#define EXTRUDER_AUTO_FAN_TEMPERATURE 35
#define EXTRUDER_AUTO_FAN_SPEED 255   // 255 == full speed
#define CHAMBER_AUTO_FAN_TEMPERATURE 30
#define CHAMBER_AUTO_FAN_SPEED 255
#define COOLER_AUTO_FAN_TEMPERATURE EXTRUDER_AUTO_FAN_TEMPERATURE  // default is 18
...
// @section bltouch
     ...
     */
    #define BLTOUCH_HS_MODE true // default state false
...
#define Z_STEPPER_AUTO_ALIGN
     ...
     */
    //#define Z_STEPPER_ALIGN_XY { {  35, 170 }, { 335,  170 } }
...
#define ASSISTED_TRAMMING
    ...
    #define TRAMMING_POINT_XY  { {  35, 60 }, { 335,  60 }, { 335, 305 }, { 35, 305 } }
...
// LCD Print Progress options. Multiple times may be displayed in turn.
    ...
    #define PRINT_PROGRESS_SHOW_DECIMALS  // Show/report progress with decimal digits, not all UIs support this
        ...
        #define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing
            ...
            #define PROGRESS_BAR_BAR_TIME 7000  // (ms) Amount of time to show the bar
            #define PROGRESS_BAR_MSG_TIME 7000  // (ms) Amount of time to show the status message
            #define PROGRESS_MSG_EXPIRE   2000  // (ms) Amount of time to retain the status message (0=forever)
    ...
    //#define USB_FLASH_DRIVE_SUPPORT
        ...
        _#define DISABLE_DUE_SD_MMC // Disable USB Host access to USB Drive to prevent hangs on block access for DUE platform
...
#define FWRETRACT
    ...
    #define RETRACT_LENGTH_SWAP          7   // (mm) Default swap retract length (positive value)
    #define RETRACT_FEEDRATE             45   // (mm/s) Default feedrate for retracting
    #define RETRACT_ZRAISE                0.6   // (mm) Default retract Z-raise
    #define RETRACT_RECOVER_LENGTH        0.6   // (mm) Default additional recover length (added to retract length on recover)
