...
//#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_FEEDRATE_SLOW             (1*60) // mm/min
  #define CALIBRATION_FEEDRATE_FAST            (20*60) // mm/min
  #define CALIBRATION_FEEDRATE_TRAVEL          (50*60) // mm/min
 ...
 */
  ...
  //#define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY_FEEDRATE (100*60) // (mm/min)
