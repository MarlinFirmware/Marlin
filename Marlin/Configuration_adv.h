 ...
 *
 * Note For SINGLENOZZLE swapping is now integrated in toolchange
 * All values are not used here
 * Swapping tool have setting in SINGLENOZZLE parameters
 */
#define FWRETRACT  // ONLY PARTIALLY TESTED
#if ENABLED(FWRETRACT)
  //#define FW_SWAPPING                   // Allow swapping 'For separated extruders or mixing , but not for singlenozzle with toolchange process'
