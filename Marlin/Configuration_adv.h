 ...
 */
#define E0_AUTO_FAN_PIN PB5 //hotend cooling fan
...
//CHOPPER_MARLIN_119   { 5,  2, 3 }
//CHOPPER_DEFAULT_24V  { 4,  2, 1 }
//CHOPPER_PRUSAMK3_24V { 3, -2, 6 }
//CHOPPER_09STEP_24V   { 3, -1, 5 }

//{3, 6, 8} -> baseline
//{3, 8, 8} -> at 30mm/s worse than {3, 6, 8}
//{3, 4, 8} -> not cheked yet

//increase incremental hysteresis_end[-3..12], when limit reached increase one increment hysteresis_start[1..8]
//if hysteresis_start[1..8] reaches the limit or you can still hear it reduce off_time[1..15] by one increment and start again

  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)
  #define CHOPPER_TIMING_X  {3, 6, 8}      // For X Axes (override below)
  //#define CHOPPER_TIMING_X2 CHOPPER_TIMING_X
  #define CHOPPER_TIMING_Y  {3, 6, 8}      // For Y Axes (override below)
  //#define CHOPPER_TIMING_Y2 CHOPPER_TIMING_Y
  #define CHOPPER_TIMING_Z  {3, -3, 1}        // For Z Axes (override below)
  //#define CHOPPER_TIMING_Z2 CHOPPER_TIMING_Z
  //#define CHOPPER_TIMING_Z3 CHOPPER_TIMING_Z
  //#define CHOPPER_TIMING_Z4 CHOPPER_TIMING_Z
  #define CHOPPER_TIMING_E  {3, -3, 1}        // For Extruders (override below)
