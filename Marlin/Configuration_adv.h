...
//#define FT_MOTION
  ...
  #define FTM_DEFAULT_X_COMPENSATOR ftMotionShaper_NONE // Default compensation / shaper mode on X axis.
  #define FTM_DEFAULT_Y_COMPENSATOR ftMotionShaper_NONE // Default compensation / shaper mode on Y axis.
