...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { HOMING_FEEDRATE_XY, HOMING_FEEDRATE_XY, HOMING_FEEDRATE_Z, (HOMING_FEEDRATE_Z/2) } // Feedrates for manual moves along X, Y, Z, E from panel
