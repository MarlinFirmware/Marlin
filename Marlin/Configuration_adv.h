...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_LOAD_FEEDRATE 15     // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_LOAD_LENGTH 70       // (mm) Load length of filament, from extruder gear to nozzle.
                                              //   For Bowden, the full length of the tube and nozzle.
                                              //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_EXTRUDE_FEEDRATE 6.6   // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_EXTRUDE_LENGTH 3.2    // (mm) Length to extrude after loading.
...
//
  #define USER_DESC_2 "Buse 250 deg"
  #define USER_GCODE_2 "M104 S250"
//
  #define USER_DESC_3 "Fan Full"
  #define USER_GCODE_3 "M106 S255"
//
  #define USER_DESC_4 "Fan Light"
  #define USER_GCODE_4 "M106 S50" 
//
