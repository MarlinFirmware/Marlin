...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*40, 50*40, 50*40, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
#define STARTUP_COMMANDS "M117 Marlin 2.0.6 D_Bot Online :)\n"
