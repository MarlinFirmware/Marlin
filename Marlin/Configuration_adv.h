...
//#define USE_CONTROLLER_FAN // Do not enable here. Enable per machine config.
...
// Enable for 2560 and higher boards??
...
//
// For Z set the number of stepper drivers //Enable per machine config?
//
...
// Something to test and see if this makes things cleaner - specifically on 8 bit boards
...
// Play a beep when the feedrate is changed from the Status Screen //might be annoying? try it out
...
//#define LCD_DECIMAL_SMALL_XY
...
#if HAS_CHARACTER_LCD && EITHER(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY) //this is only for 2004 lcd machines
  ...
  //#define POWER_LOSS_RECOVERY //enable from the main config
  ...
  //#define OVERLAY_GFX_REVERSE
    ...
    //#define LIGHTWEIGHT_UI //new feature. could be good for 1284p boards
