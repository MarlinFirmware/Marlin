...
//#define ASSISTED_TRAMMING
  ...
  // Define positions names for probe points.
...
#if EITHER(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY) && ANY(HAS_MARLINUI_U8GLIB, HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL, EXTENSIBLE_UI, TFT_COLOR_UI)
