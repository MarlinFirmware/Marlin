...
//define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN P2_04  FAN0_PIN //-1           // Set a custom pin for the controller fan
...
//
//#define LCD_BACKLIGHT_TIMEOUT_MINS 300  // (minutes) Timeout before turning off the backlight
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_GREEN      50  // User defined GREEN value
      #define LED_USER_PRESET_BLUE         10  // User defined BLUE value
      #define LED_USER_PRESET_WHITE      20  // User defined WHITE value
      #define LED_USER_PRESET_BRIGHTNESS 20  // User defined intensity
...
#define CUSTOM_MENU_MAIN_TITLE "My Menu"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
 // #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

 // #define MAIN_MENU_ITEM_20_DESC "Home & UBL Info"
  //#define MAIN_MENU_ITEM_20_GCODE "G28\nG29 W"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  //#define MAIN_MENU_ITEM_19_DESC "Preheat for " PREHEAT_1_LABEL
  //#define MAIN_MENU_ITEM_19_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  //#define MAIN_MENU_ITEM_2_CONFIRM
 
 // #define MAIN_MENU_DESC_18 "G26 PLA"
  //#define MAIN_MENU_GCODE_18 "G28\nG26 C1 B40 H200 P5 Q1" //R20

  //#define MAIN_MENU_DESC_16 "G26 PLA 3mm ret"
  //#define MAIN_MENU_GCODE_16 "G28\nG26 C1 B40 H200 P5 Q3" //R20


  #define MAIN_MENU_DESC_9 "G26 PET 0.4"
  #define MAIN_MENU_GCODE_9 "G28\nG26 C1 B50 H235 S0.4 P5 Q1"

  #define MAIN_MENU_DESC_1 "Calibrate"
  #define MAIN_MENU_GCODE_1 "G28\nG33 V3\nM500\nM0 UBL Level...\nG29 P1\nG29 P3\nG29 S1 V4\nG29 T\nG29 A\nG29 F 10.0\nM500\nM117 happy xmas"

#define MAIN_MENU_DESC_2 "G33 P1 V3"
  #define MAIN_MENU_GCODE_2 "G33 P1 V3"

  #define MAIN_MENU_DESC_10 "G26 PLA 0.8"
  #define MAIN_MENU_GCODE_10 "G28\nG26 C1 B40 H200 L0.6 S0.8 P5 Q1"

  #define MAIN_MENU_DESC_6 "FW Update / Reset"
  #define MAIN_MENU_GCODE6 "M997"

  #define MAIN_MENU_DESC_3 "BL On & Z Off Test 0mm"
  #define MAIN_MENU_GCODE_3 "G28\nM420 S1\nG0 F11000 Z10\nG0 F200\nG0 Z0"

  #define MAIN_MENU_DESC_5 "BL On & Z Off Test 1mm"
  #define MAIN_MENU_GCODE_5 "G28\nM420 S1\nG0 F11000 Z10\nG0 F200\nG0 Z1"

  #define MAIN_MENU_DESC_11 "Home & Info"
  #define MAIN_MENU_GCODE_11 "M300 S2637 P133\nM300 S2349 P133\nM300 S1479 P266\nM300 S1661 P266\nM300 S2217 P133\nM300 S987 P133\nM300 S1174 P266\nM300 S1318 P266\nM300 S987 P133\nM300 S880 P133\nM300 S1108 P266\nM300 S1318 P266\nM300 S880 P532\nM300 S2637 P133\nM300 S2349 P133\nM300 S1479 P266\nM300 S1661 P266\nM300 S2217 P133\nM300 S987 P133\nM300 S1174 P266\nM300 S1318 P266\nM300 S987 P133\nM300 S880 P133\nM300 S1108 P266\nM300 S1318 P266\nM300 S880 P532\nM300 S2637 P133\nM300 S2349 P133\nM300 S1479 P266\nM300 S1661 P266\nM300 S2217 P133\nM300 S987 P133\nM300 S1174 P266\nM300 S1318 P266\nM300 S987 P133\nM300 S880 P133\nM300 S1108 P266\nM300 S1318 P266\nM300 S880 P532"

  #define MAIN_MENU_DESC_4 "It Doesnt Really Matter"
  #define MAIN_MENU_GCODE_4 "M300 S987 P250\nM300 S2637 P250\nM300 S3322 P250\nM300 S1760 P250\nM300 S3322 P250\nM300 S2637 P250\nM300 S987 P250\nM300 S880 P250\nM300 S3322 P250\nM300 S880 P250\nM300 S987 P750\nM300 S0 P500\nM300 S987 P125\nM300 S987 P125\nM300 S2637 P250\nM300 S3322 P250\nM300 S1760 P250\nM300 S3322 P250\nM300 S2637 P250\nM300 S987 P250\nM300 S880 P250\nM300 S1661 P250\nM300 S880 P250\nM300 S987 P750\nM300 S0 P250\nM300 S987 P125\nM300 S987 P125\nM300 S2217 P250\nM300 S2217 P125\nM300 S2637 P250\nM300 S2637 P125\nM300 S2959 P375\nM300 S2637 P125\nM300 S2637 P250\nM300 S0 P250\nM300 S2637 P125\nM300 S2637 P125\nM300 S2217 P250\nM300 S2217 P250\nM300 S2637 P250\nM300 S2637 P250\nM300 S2959 P250\nM300 S2637 P250\nM300 S2959 P250\nM300 S3322 P750\nM300 S0 P2000\nM300 S987 P500\nM300 S987 P500\nM300 S987 P250\nM300 S2959 P125"

  #define MAIN_MENU_DESC_7 "Smooth Criminal"
  #define MAIN_MENU_GCODE_7 "M300 S0 P75\nM300 S1108 P300\nM300 S1108 P600\nM300 S1108 P112\nM300 S1108 P112\nM300 S1244 P225\nM300 S1244 P450\nM300 S1108 P112\nM300 S1244 P112\nM300 S1318 P225\nM300 S1318 P600\nM300 S1244 P112\nM300 S1318 P112\nM300 S1244 P225\nM300 S493 P225\nM300 S1244 P225\nM300 S1108 P450\nM300 S1108 P225\nM300 S1108 P112\nM300 S1108 P112\nM300 S1108 P112\nM300 S1108 P112\nM300 S1244 P225\nM300 S1244 P450\nM300 S1108 P112\nM300 S1244 P112\nM300 S1318 P225\nM300 S1318 P450\nM300 S1244 P112\nM300 S1318 P112\nM300 S1244 P225\nM300 S493 P225\nM300 S1244 P225\nM300 S1108 P450\nM300 S1108 P225\nM300 S1108 P112\nM300 S1108 P112\nM300 S1108 P112\nM300 S1108 P112\nM300 S1244 P225\nM300 S1244 P450\nM300 S1108 P112\nM300 S1244 P112\nM300 S1318 P225\nM300 S1318 P450\nM300 S1244 P112\nM300 S1318 P112\nM300 S1244 P225\nM300 S493 P225\nM300 S1244 P225"

  #define MAIN_MENU_DESC_12 "Axel F"
  #define MAIN_MENU_GCODE_12 "M300 S1567 P480\nM300 S932 P360\nM300 S1567 P120\nM300 S0 P120\nM300 S1567 P120\nM300 S2093 P240\nM300 S1567 P240\nM300 S1396 P240\nM300 S1567 P480\nM300 S2349 P360\nM300 S1567 P120\nM300 S0 P120\nM300 S1567 P120\nM300 S2489 P240\nM300 S2349 P240\nM300 S932 P240\nM300 S1567 P240\nM300 S2349 P240\nM300 S3135 P240\nM300 S1567 P120\nM300 S1396 P120\nM300 S0 P120\nM300 S1396 P120\nM300 S1174 P240\nM300 S932 P240\nM300 S1567 P960\nM300 S0 P480\nM300 S2793 P120\nM300 S2349 P240\nM300 S2093 P240\nM300 S932 P240\nM300 S1567 P480\nM300 S932 P360\nM300 S1567 P120\nM300 S0 P120\nM300 S1567 P120\nM300 S2093 P240\nM300 S1567 P240\nM300 S1396 P240\nM300 S1567 P480\nM300 S2349 P360\nM300 S1567 P120\nM300 S0 P120\nM300 S1567 P120\nM300 S2489 P240\nM300 S2349 P240\nM300 S932 P240\nM300 S1567 P240\nM300 S2349 P240"

  #define MAIN_MENU_DESC_13 "Beethoven"
  #define MAIN_MENU_GCODE_13 "M300 S1396 P166\nM300 S1396 P166\nM300 S1396 P166\nM300 S1108 P1332\nM300 S0 P166\nM300 S1244 P166\nM300 S1244 P166\nM300 S1244 P166\nM300 S1046 P1332\nM300 S0 P166\nM300 S1396 P166\nM300 S1396 P166\nM300 S1396 P166\nM300 S1108 P166\nM300 S1479 P166\nM300 S1479 P166\nM300 S1479 P166\nM300 S1396 P166\nM300 S2217 P166\nM300 S2217 P166\nM300 S2217 P166\nM300 S932 P666\nM300 S0 P166\nM300 S1396 P166\nM300 S1396 P166\nM300 S1396 P166\nM300 S1046 P166\nM300 S1479 P166\nM300 S1479 P166\nM300 S1479 P166\nM300 S1396 P166\nM300 S2489 P166\nM300 S2489 P166\nM300 S2489 P166\nM300 S2093 P1332\nM300 S2793 P166\nM300 S2793 P166\nM300 S2489 P166\nM300 S2217 P166\nM300 S1108 P166\nM300 S1108 P166\nM300 S1244 P166\nM300 S1396 P166\nM300 S2793 P166\nM300 S2793 P166\nM300 S2489 P166\nM300 S2217 P166\nM300 S1108 P166\nM300 S1108 P166\nM300 S1244 P166"

  #define MAIN_MENU_DESC_14 "Boil Kettle"
  #define MAIN_MENU_GCODE_14 "M118 //action:coffee"

  #define MAIN_MENU_DESC_15 "Kill power test"
  #define MAIN_MENU_GCODE_15 "M118 //action:turnofffully"

  #define MAIN_MENU_DESC_17 "Test Smoke / Temp Sense"
  #define MAIN_MENU_GCODE_17 "M118 //action:testtempsmoke"
