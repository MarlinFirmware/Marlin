 ...
 */
  ...
  #define INTERPOLATE      false
    ...
    #define X_HOLD_MULTIPLIER HOLD_MULTIPLIER    // Enable to override 'HOLD_MULTIPLIER' for the X axis
  #endif
    ...
    #define Z3_CURRENT_HOME Z3_CURRENT_HOME
    ...
    #define Z4_CURRENT_HOME Z4_CURRENT_HOME
...
//#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_USE_PWM true               // Enable if your controller supports setting the speed/power
