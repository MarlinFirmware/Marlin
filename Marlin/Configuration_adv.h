 ...
 */
#define HOTEND_IDLE_TIMEOUT // chng mf 6-14-21
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 80*60, 80*60, 12*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_SET_PROGRESS_MANUALLY //chd femike 6-12-21
  ...
  //#define SHOW_REMAINING_TIME       // Display estimated time to completion mf
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.63   // Unit: mm compression per 1mm/s extruder speed FEMIKE WAS.63
 ...
 */
  ...
  //#define STEALTHCHOP_E mf commented out 6-24-21
   ...
   */
  #define TMC_DEBUG // mf uncommented
