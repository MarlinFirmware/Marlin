 ...
 */
 ...
 // #define ADAPTIVE_FAN_SLOWING              // Slow part cooling fan if temperature drops - 20/06/26 tiral with on // 20/07/09 off
 ...
 */
#define E0_AUTO_FAN_PIN P2_04 // BASE
...
#define X_HOME_BUMP_MM 0 // BASE
#define Y_HOME_BUMP_MM 0 // BASE
...
#define HOMING_BACKOFF_MM { 2, 2, 2}  // (mm) Move away from the endstops after homing // BASE
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define LONG_FILENAME_HOST_SUPPORT // BASE
 ...
 */
  ...
  // #define MENU_HOLLOW_FRAME  // MAKES LCD HIGHLIGHT MORE VISIBLE // BASE
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  1      // Babysteps are very small. Increase for faster motion. // BASE was CHANGED TO 10 NOW 1 AGAIN
  #define BABYSTEP_MULTIPLICATOR_XY 1

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 500   // Maximum interval between clicks, in milliseconds. // 20/08/23 was 1250
                                            // Note: Extra time may be added to mitigate controller latency.
    //#define BABYSTEP_ALWAYS_AVAILABLE     // Allow babystepping at all times (not just during movement).
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle. // BASE
    #if ENABLED(MOVE_Z_WHEN_IDLE)
      #define MOVE_Z_IDLE_MULTIPLICATOR 10   // Multiply 1mm by this factor for the move step size. // 20/08/23 was 1
    #endif
  #endif

  //#define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // BASE
...
#if ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 32 // SD,LCD,Buttons take more memory, block buffer needs to be smaller // BASE was 16
#else
...
#define TX_BUFFER_SIZE 32 // BASE was 0
 ...
 */
#define ADVANCED_PAUSE_FEATURE // BASE
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS // BASE
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only // BASE

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  85 // 20/06/26
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  78 // 20/08/20
    //#define Z_STALL_SENSITIVITY  8
    //#define SPI_ENDSTOPS              // TMC2130 only
    //#define IMPROVE_HOMING_RELIABILITY //commented out to make more robust // 20/06/26 not enabled - problems found
  #endif
...
#define CUSTOM_USER_MENUS // UBL
  ...
  #define USER_DESC_4 "UBL Z Offset Step 2" // UBL
  #define USER_GCODE_4 "M211 S1\nM500" // sotware endstops on save eprom // UBL

  #define USER_DESC_5 "Print Mesh Validation" // UBL
  #define USER_GCODE_5 "M109 S210\nM190 S60\nG28\nG26\nG28" // heat up, home, print, home // UBL
  ...
  //#define USER_DESC_3 "Probe mesh 1 & view "
  //#define USER_GCODE_3 "M502\nM500\nM501\nM140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) "\G28\ng29 P1\nG29 T" // eprom, heat up, probe, disply in terminal // UBL

  //#define USER_DESC_4 "Save Mesh 1 "
  //#define USER_GCODE_4 "G29 S1\G29 F10.0\G29 A\nM500" // save mesh, fade height, activate UBL, save to eprom // UBL

  //#define USER_DESC_5 "Set Z offset stage 1 "
  //#define USER_GCODE_5 "G28\M X117 Y117\nM211 S0" // home, centre bed, software endstops off // UBL

  //#define USER_DESC_6 "Set Z offset after M851 Z- " // UBL
  //#define USER_GCODE_6 "M211 S1\nM503\nM500" // software endstops on, save to eprom, show eprom // UBL
#endif
