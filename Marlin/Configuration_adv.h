 ...
 */
  ...
  // TODO: Disable this to save 3.26K PROGMEM
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   120  // (mm/s) Load filament feedrate. This can be pretty fast.
