...
//#define INPUT_SHAPING_Y
    ...
    #if ANY(COREXY, COREYX, MARKFORGED_XY, MARKFORGED_YX)
      #define SHAPING_FREQ_Y  SHAPING_FREQ_X          // (Hz) The default dominant resonant frequency on the Y axis.
      #define SHAPING_ZETA_Y  SHAPING_ZETA_X       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
    #else
