...
//#define NO_TIMEOUTS 15000 // Milliseconds
...
#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define RETRACT_RECOVER_FEEDRATE_SWAP 25 // Default feedrate for recovering from swap retraction (mm/s)
#endif
 ...
 *    Filament runout multi sensors ENABLED
...
//Move settings
  #define PAUSE_PARK_X_POS                    X_MAX_POS     // Not defined = Current X position = Only Y move
//#define PAUSE_PARK_Y_POS                    3             // Not defined = Current Y position = Only X move
  #define PAUSE_PARK_Z_ADD                    2             // Z addition of hotend (lift)
  #define PAUSE_PARK_XY_FEEDRATE            150             // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define PAUSE_PARK_Z_FEEDRATE              12             // Z axis feedrate in mm/s (not used for delta printers)
//Extrusion settings
  #define PAUSE_PARK_RETRACT_FEEDRATE        RETRACT_FEEDRATE // Initial retract feedrate in mm/s
  #define PAUSE_PARK_RETRACT_LENGTH           2  // Initial retract in mm
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       70 // 0  for manual unloading
  ...
  #define ADVANCED_PAUSE_EXTRUDE_FEEDRATE   6.6  // Extrude filament feedrate in mm/s - must be slower than load feedrate
  #define ADVANCED_PAUSE_EXTRUDE_LENGTH      20  // Purge/load - 0 to disable for manual extrusion
//Blowing 
...
// Spool_Swap
  #define ADVANCED_PAUSE_SPOOL_SWAP              //Run next tool after filament runout
    ...
    #define ADVANCED_PAUSE_SPOOL_SWAP_UNLOAD   RETRACT_LENGTH_SWAP // Don't eject filament because print continue
    #define ADVANCED_PAUSE_SPOOL_SWAP_LOAD     RETRACT_LENGTH_SWAP // Same as FWRETRACT if enabled
...
//Miscillaneous 
  ...
  #define PAUSE_BEEPS                     0 // Number of alert beeps before printer goes quiet
  ...
  #define HOME_BEFORE_FILAMENT_CHANGE       // Ensure homing has been completed prior to parking for filament change
    ...
    #undef  ADVANCED_PAUSE_SPOOL_SWAP_EXTRUDE
	#undef  ADVANCED_PAUSE_SPOOL_SWAP_COPY_FLOW
	...
	#define ADVANCED_PAUSE_SPOOL_SWAP_EXTRUDE  100 //Purge length
    #define ADVANCED_PAUSE_SPOOL_SWAP_COPY_FLOW
  #endif  
#endif
...
//
  #define USER_DESC_1 "Test G29"
  #define USER_GCODE_1 "G1 X300 Y300 F 5000\n G1 X0 Y0"
//
  #define USER_DESC_2 "Preheat for PLA"
  #define USER_GCODE_2 "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
//
  #define USER_DESC_3 "Tool change T0"
  #define USER_GCODE_3 "T0"

  #define USER_DESC_4 "Tool change T1"
  #define USER_GCODE_4 "T1" 
//
  #define USER_DESC_5 "M600"
  #define USER_GCODE_5 "M600"
