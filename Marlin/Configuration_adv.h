...
#define USER_DESC_8 "Preheat for " PREHEAT_7_LABEL
#define USER_GCODE_8 "M140 S" STRINGIFY(PREHEAT_7_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_7_TEMP_HOTEND)

#define USER_DESC_9 "Preheat for " PREHEAT_8_LABEL
#define USER_GCODE_9 "M140 S" STRINGIFY(PREHEAT_8_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_8_TEMP_HOTEND)

#define USER_DESC_10 "Heat Bed/Home/Level"
#define USER_GCODE_10 "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nG28\nG29"
