 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS // activer pour reduire le courant si il y a un soucis
  ...
  #define Z_HYBRID_THRESHOLD     140 // Olivier plus de bruit
  #define Z2_HYBRID_THRESHOLD      3
  #define Z3_HYBRID_THRESHOLD      3
  #define Z4_HYBRID_THRESHOLD      3
  #define E0_HYBRID_THRESHOLD     140
