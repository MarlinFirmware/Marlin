...
#define MSG_UBL_LEVEL_BED                   _UxGT("Niveau lit unifié (UBL)")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Maillage manuel")
#define MSG_UBL_BC_INSERT                   _UxGT("Placer câle et mésurer")
#define MSG_UBL_BC_INSERT2                  _UxGT("Mesure")
#define MSG_UBL_BC_REMOVE                   _UxGT("Enlever et mesurer lit")
...
#define MSG_UBL_FILLIN_MESH                 _UxGT("Maille de remplissage")
...
#define MSG_INIT_EEPROM                     _UxGT("Initialisation EEPROM")
...
#define MSG_UBL_LEVELING                    _UxGT("Niveau lit unifié (UBL)")
