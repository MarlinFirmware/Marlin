...
#define CONDITIONALS_LCD_H
  ...
  #if ENABLED(REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER) || ENABLED(SILVER_GATE_CONTROLLER)
    #define DOGLCD
  ...
  // Set encoder detents for well-known controllers
   ...
   || ENABLED(BQ_LCD_SMART_CONTROLLER) || ENABLED(LCD_I2C_PANELOLU2) || ENABLED(REPRAP_DISCOUNT_SMART_CONTROLLER) || ENABLED(SILVER_GATE_CONTROLLER)
    #ifndef ENCODER_PULSES_PER_STEP
