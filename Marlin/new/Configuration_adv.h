...
//
  ...
  #define BOARD_MAXTEMP          70  // (°C)
    ...
    #define TEMP_BOARD_PIN 15      // Board temp sensor pin, if not set in pins file.
  #endif
#endif
...
//#define MICROSTEP_MODES { 8, 8, 8, 8, 8, 8 } // [1,2,4,8,16]
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 4*60,  2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
