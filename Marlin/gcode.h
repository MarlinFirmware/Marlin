...
public:
  ...
  FORCE_INLINE static bool     boolval_f(const char c, const bool dval=false) { return seen(c)    ? value_bool()         : dval; }
  FORCE_INLINE static bool     boolval_t(const char c, const bool dval=true)  { return seen(c)    ? value_bool()         : dval; }
