...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klikni za poДЌetak")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("SljedeД‡a toДЌka")
...
#define MSG_SET_ORIGIN                      _UxGT("Postavi ishodiЕЎte")
...
#define MSG_COOLDOWN                        _UxGT("HlaД‘enje")
#define MSG_SWITCH_PS_ON                    _UxGT("UkljuДЌi napajanje")
#define MSG_SWITCH_PS_OFF                   _UxGT("IskljuДЌi napajanje")
#define MSG_EXTRUDE                         _UxGT("Extrude")
#define MSG_RETRACT                         _UxGT("Retract")
#define MSG_MOVE_AXIS                       _UxGT("MiДЌi os")
#define MSG_BED_LEVELING                    _UxGT("Niveliraj bed")
#define MSG_LEVEL_BED                       _UxGT("Niveliraj bed")
#define MSG_MOVE_X                          _UxGT("MiДЌi X")
#define MSG_MOVE_Y                          _UxGT("MiДЌi Y")
#define MSG_MOVE_Z                          _UxGT("MiДЌi Z")
#define MSG_MOVE_E                          _UxGT("Extruder")
#define MSG_MOVE_01MM                       _UxGT("MiДЌi 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("MiДЌi 1mm")
#define MSG_MOVE_10MM                       _UxGT("MiДЌi 10mm")
...
#define MSG_LOAD_EEPROM                     _UxGT("UДЌitaj memoriju")
#define MSG_RESTORE_FAILSAFE                _UxGT("UДЌitaj failsafe")
#define MSG_REFRESH                         _UxGT("OsvjeЕѕi")
...
#define MSG_USERWAIT                        _UxGT("ДЊekaj korisnika...")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Grijanje neuspjeЕЎno")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibriraj SrediЕЎte")
...
#define MSG_CASE_LIGHT                      _UxGT("Osvjetljenje")
  ...
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("ZavrЕЎeni")
  #define MSG_INFO_PRINT_TIME               _UxGT("Ukupno printanja")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("NajduЕѕi print")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("NajduЕѕi")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Nastavi print")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("ДЊekaj poДЌetak")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("filamenta")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("promijeni")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("ДЊekaj")
  ...
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("PriДЌekaj")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament load")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Wait for print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("to resume")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("PriДЌekaj...")
