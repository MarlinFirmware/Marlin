...
#define MSG_SET_HOME_OFFSETS                _UxGT("Setze Homeoffsets")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Offsets aktiv")
...
#define MSG_ENDSTOP_ABORT                   _UxGT("Endstop-Abbr. ein")
...
#define MSG_HEATING                         _UxGT("Extr. Aufheizen...")
#define MSG_HEATING_COMPLETE                _UxGT("Extr. aufgeheizt")
#define MSG_BED_HEATING                     _UxGT("Bett aufheizen")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Drucke weiter")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Extruden...")
