...
//#define MSG_MAIN                            "Hauptmenü"
  ...
  #define MSG_PREPARE                         "Vorbereitung"
    #define MSG_AUTOSTART                     "Autostart von SD"
    #define MSG_DISABLE_STEPPERS              "Motoren Aus"// M84
    #define MSG_AUTO_HOME                     "Auto Home" //G28
    #define MSG_SET_HOME_OFFSETS              "Home ist hier"
    #define MSG_SET_ORIGIN                    "Null ist hier" //"G92 X0 Y0 Z0"
  //#define MSG_PREHEAT_PLA                   "Vorheizen PLA"   
  //  #define MSG_PREHEAT_PLA_N               "Vorheizen PLA " //space on purpose   
      #define MSG_PREHEAT_PLA_ALL             "Vorh. PLA Alle"
      #define MSG_PREHEAT_PLA_BEDONLY         "Vorh. PLA Bett"
  //#define MSG_PREHEAT_ABS                   "Vorheizen ABS"    
  //  #define MSG_PREHEAT_ABS_N               "Vorheizen ABS " //space on purpose
      #define MSG_PREHEAT_ABS_ALL             "Vorh. ABS Alle"
  ...
  //#define MSG_DELTA_CALIBRATE               "Delta Kalib." 
  //  ..
  ...
  #define MSG_CONTROL                         "Einstellungen"
    ...
    //#define MSG_FAN_SPEED                   "Luftmenge"       
      ...
      #define MSG_MIN                         "\002 Min." // \002 is thermometer
    ...
    #define MSG_MOTION                        "Bewegung"
      ...
      #define MSG_VMAX                        "Vmax " //space on purpose
      #define MSG_X                           "x"
      #define MSG_Y                           "y"
      #define MSG_Z                           "z"
      #define MSG_E                           "e"
      ...
      #define MSG_AMAX                        "Amax " //space on purpose
    ...
    #define MSG_VOLUMETRIC                    "Filament"
      #define MSG_VOLUMETRIC_ENABLED		      "E in mm3 Ein"
    ...
    #define MSG_RETRACT                       "Retract"
      #define MSG_AUTORETRACT                 "AutoRetr. Ein"
      #define MSG_CONTROL_RETRACT             "Retract mm"
      #define MSG_CONTROL_RETRACT_SWAP        "Fil.W. Retract mm"
      #define MSG_CONTROL_RETRACTF            "Retract V"
      #define MSG_CONTROL_RETRACT_ZLIFT       "Hop mm"
      #define MSG_CONTROL_RETRACT_RECOVER     "UnRetract +mm"
      #define MSG_CONTROL_RETRACT_RECOVER_SWAP "Fil.W. UnRet. +mm"
      #define MSG_CONTROL_RETRACT_RECOVERF    "UnRetract V"
    #define MSG_STORE_EPROM                   "EPROM speichern"
    #define MSG_LOAD_EPROM                    "EPROM laden"
    #define MSG_RESTORE_FAILSAFE              "Standardkonfig."

  #define MSG_NO_CARD                         "Keine SDKarte"
  #define MSG_PAUSE_PRINT                     "SDDruck Pause"
  #define MSG_RESUME_PRINT                    "SDDruck Weiter"
  #define MSG_STOP_PRINT                      "SDDruck Abbruch"
//#define MSG_CARD_MENU                       "SDKarte"       
