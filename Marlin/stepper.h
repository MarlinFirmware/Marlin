  ...
  public:
    ...
    static block_t* current_block;  // A pointer to the block currently being traced
      ...
      static bool performing_homing;
        ...
        #define ADVANCE_STEPPERS MIXING_STEPPERS
      #else
        #define ADVANCE_STEPPERS EXTRUDERS
      #endif
    #endif
  ...
  private:
    ...
    static volatile unsigned long step_events_completed; // The number of step events executed in the current block
      ...
      static volatile unsigned char eISR_Rate;
        ...
        static volatile int e_steps[ADVANCE_STEPPERS];
        static int extruder_advance_k;
        static int final_estep_rate;
        static int current_estep_rate[ADVANCE_STEPPERS]; // Actual extruder speed [steps/s]
        static int current_adv_steps[ADVANCE_STEPPERS];  // The amount of current added esteps due to advance.
                                                  // i.e., the current amount of pressure applied
                                                  // to the spring (=filament).
      #else
        static long e_steps[ADVANCE_STEPPERS];
