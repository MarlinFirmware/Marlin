...
static_assert(1 >= 0
  ...
  #elif  DIRECTION_CHANGE && !PIN_EXISTS(SPINDLE_DIR)
    #error "SPINDLE_DIR_PIN not defined."
  #elif ENABLED(SPINDLE_SPEED_LASER_POWER) && PIN_EXISTS(SPINDLE_SPEED_LASER_POWER)
    #if !((SPINDLE_SPEED_LASER_POWER_PIN >=2 && SPINDLE_SPEED_LASER_POWER_PIN <= 13) || (SPINDLE_SPEED_LASER_POWER_PIN >=44 && SPINDLE_SPEED_LASER_POWER_PIN <= 46))
      #error "SPINDLE_SPEED_LASER_POWER_PIN not assigned to a PWM pin."
    #elif SPINDLE_LASER_POWER_UP_DELAY < 1
      #error "SPINDLE_LASER_POWER_UP_DELAY must be greater than 0"
    #elif SPINDLE_LASER_POWER_DOWN_DELAY < 1
      #error "SPINDLE_LASER_POWER_DOWN_DELAY must be greater than 0"
    #elif !defined(SPINDLE_SPEED_LASER_POWER_INVERT)
      #error "SPINDLE_SPEED_LASER_POWER_INVERT missing."
    #elif !defined(SPINDLE_SPEED_LASER_POWER_INVERT) || !(SPINDLE_SPEED_LASER_POWER_INVERT == true || SPINDLE_SPEED_LASER_POWER_INVERT == false)
      #error "SPINDLE_SPEED_LASER_POWER_INVERT missing or incorrectly defined."
    #elif !defined(SPEED_POWER_SLOPE) || !defined(SPEED_POWER_INTERCEPT) || !defined(SPEED_POWER_MIN) || !defined(SPEED_POWER_MAX)
      #error "SPINDLE_SPEED_LASER_POWER equation constant(s) missing."
    #elif SPINDLE_SPEED_LASER_POWER_PIN == 4 || SPINDLE_SPEED_LASER_POWER_PIN == 11 || SPINDLE_SPEED_LASER_POWER_PIN == 12 || SPINDLE_SPEED_LASER_POWER_PIN == 13
      #error "Counter/Timer for SPINDLE_SPEED_LASER_POWER PWM pin is used by a system interrupt."
    #elif PIN_EXISTS(X_MAX) && X_MAX_PIN == SPINDLE_SPEED_LASER_POWER_PIN
      #error "SPINDLE_SPEED_LASER_POWER pin is in use by X_MAX endstop."
    #elif PIN_EXISTS(X_MIN) && X_MIN_PIN == SPINDLE_SPEED_LASER_POWER_PIN
      #error "SPINDLE_SPEED_LASER_POWER pin is in use by X_MIN endstop."
    #elif PIN_EXISTS(Z_STEP) && Z_STEP_PIN == SPINDLE_SPEED_LASER_POWER_PIN
      #error "SPINDLE_SPEED_LASER_POWER pin in use by Z_STEP."
    #elif defined(NUM_SERVOS) && (NUM_SERVOS > 0) && (SPINDLE_SPEED_LASER_POWER_PIN == 2 || SPINDLE_SPEED_LASER_POWER_PIN == 3 || SPINDLE_SPEED_LASER_POWER_PIN == 5)
      #error "Counter/Timer for SPINDLE_SPEED_LASER_POWER PWM pin is used by the servo system."
    #elif PIN_EXISTS(CASE_LIGHT) && SPINDLE_SPEED_LASER_POWER_PIN == CASE_LIGHT_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by CASE_LIGHT_PIN."
    #elif PIN_EXISTS(E0_AUTO_FAN) && SPINDLE_SPEED_LASER_POWER_PIN == E0_AUTO_FAN_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by E0_AUTO_FAN_PIN."
    #elif PIN_EXISTS(E1_AUTO_FAN) && SPINDLE_SPEED_LASER_POWER_PIN == E1_AUTO_FAN_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by E1_AUTO_FAN_PIN."
    #elif PIN_EXISTS(E2_AUTO_FAN) && SPINDLE_SPEED_LASER_POWER_PIN == E2_AUTO_FAN_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by E2_AUTO_FAN_PIN."
    #elif PIN_EXISTS(E3_AUTO_FAN) && SPINDLE_SPEED_LASER_POWER_PIN == E3_AUTO_FAN_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by E3_AUTO_FAN_PIN."
    #elif PIN_EXISTS(FAN) && SPINDLE_SPEED_LASER_POWER_PIN == FAN_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used FAN_PIN."
    #elif PIN_EXISTS(FAN1) && SPINDLE_SPEED_LASER_POWER_PIN == FAN1_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used FAN1_PIN."
    #elif PIN_EXISTS(FAN2) && SPINDLE_SPEED_LASER_POWER_PIN == FAN2_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used FAN2_PIN."
    #elif PIN_EXISTS(CONTROLLERFAN) && SPINDLE_SPEED_LASER_POWER_PIN == CONTROLLERFAN_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by CONTROLLERFAN_PIN."
    #elif PIN_EXISTS(MOTOR_CURRENT_PWM_XY) && SPINDLE_SPEED_LASER_POWER_PIN == MOTOR_CURRENT_PWM_XY_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by MOTOR_CURRENT_PWM_XY."
    #elif PIN_EXISTS(MOTOR_CURRENT_PWM_Z) && SPINDLE_SPEED_LASER_POWER_PIN == MOTOR_CURRENT_PWM_Z_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by MOTOR_CURRENT_PWM_Z."
    #elif PIN_EXISTS(MOTOR_CURRENT_PWM_E) && SPINDLE_SPEED_LASER_POWER_PIN == MOTOR_CURRENT_PWM_E_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by MOTOR_CURRENT_PWM_E."
    #elif PIN_EXISTS(CASE_LIGHT) && SPINDLE_SPEED_LASER_POWER_PIN == CASE_LIGHT_PIN
      #error "SPINDLE_SPEED_LASER_POWER PWM pin is used by CASE_LIGHT."
    #endif
  #endif
