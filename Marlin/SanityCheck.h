...
//APA102_LED EDITED
  ...
  if !(PIN_EXISTS(APA102) && APA102_LED_PIXELS > 0)
    #error "APA102_LED requires APA102_LED_PIN and APA102_LED."
  #endif
  //APA102_LED EDITED
#elif ENABLED(PRINTER_EVENT_LEDS) && DISABLED(BLINKM) && DISABLED(PCA9632) && DISABLED(NEOPIXEL_LED) && DISABLED(APA102_LED)
  #error "PRINTER_EVENT_LEDS requires BLINKM, PCA9632, RGB_LED, RGBW_LED, NEOPIXEL_LED or APA102_LED."
#endif
