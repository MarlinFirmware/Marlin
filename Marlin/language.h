...
// LCD Menu Messages
	#define WELCOME_MSG MACHINE_NAME " Prete!"  // " Ready."
	#define MSG_SD_INSERTED "Carte inseree"  // "Card inserted"
	#define MSG_SD_REMOVED "Carte retiree"  // "Card removed"
	#define MSG_MAIN "Menu Principal"  // "Main"
	#define MSG_AUTOSTART "Demarrage Auto."  // "Autostart"
	#define MSG_DISABLE_STEPPERS "Desact. Moteurs"  // "Disable Steppers"
	#define MSG_AUTO_HOME "Aller a l'Origine"  // "Auto Home"
	#define MSG_SET_ORIGIN "Regler Origine"  // "Set Origin"
	#define MSG_PREHEAT_PLA "Prechauffer PLA"  // "Preheat PLA"
	#define MSG_PREHEAT_PLA_SETTINGS "Prechauffage PLA"  // "Preheat PLA Conf"
	#define MSG_PREHEAT_ABS "Prechauffer ABS"  // "Preheat ABS"
	#define MSG_PREHEAT_ABS_SETTINGS "Prechauffage ABS"  // "Preheat ABS Conf"
	#define MSG_COOLDOWN "Refroidissement"  // "Cooldown"
	#define MSG_EXTRUDE "Extruder"  // "Extrude"
	#define MSG_RETRACT "Retracter"  // "Retract"
	#define MSG_MOVE_AXIS "Deplacer Axes"  // "Move Axis"
	#define MSG_SPEED "Vitesse"  // "Speed"
	#define MSG_NOZZLE "Buse"  // "Nozzle"
	#define MSG_NOZZLE1 "Buse2"  // "Nozzle2"
	#define MSG_NOZZLE2 "Buse3"  // "Nozzle3"
	#define MSG_BED "Lit"  // "Bed"
	#define MSG_FAN_SPEED "Ventilateur"  // "Fan speed"
	#define MSG_FLOW "Flux"  // "Flow"
	#define MSG_CONTROL "Controle"  // "Control"
	#define MSG_MIN " \002 Min"  // " \002 Min"
	#define MSG_MAX " \002 Max"  // " \002 Max"
	#define MSG_FACTOR " \002 Facteur"  // " \002 Fact"
	#define MSG_AUTOTEMP "Autotemp"  // "Autotemp"
	#define MSG_ON "Marche"  // "On "
	#define MSG_OFF "Arret "  // "Off"
	#define MSG_PID_P "PID-P"  // "PID-P"
	#define MSG_PID_I "PID-I"  // "PID-I"
	#define MSG_PID_D "PID-D"  // "PID-D"
	#define MSG_PID_C "PID-C"  // "PID-C"
	#define MSG_ACC  "Accel"  // "Accel"
	#define MSG_VXY_JERK "Vxy-jerk"  // "Vxy-jerk"
	...
	#define MSG_RECTRACT "Rectract"  // "Rectract"
	#define MSG_TEMPERATURE "Temperature"  // "Temperature"
	#define MSG_MOTION "Mouvement"  // "Motion"
	#define MSG_STORE_EPROM "Sauver memoire"  // "Store memory"
	#define MSG_LOAD_EPROM "Charger memoire"  // "Load memory"
	#define MSG_RESTORE_FAILSAFE "Restaure securite"  // "Restore Failsafe"
	#define MSG_REFRESH "Actualiser"  // "Refresh"
	#define MSG_WATCH "Information"  // "Info screen"
	#define MSG_PREPARE "Preparer"  // "Prepare"
	#define MSG_TUNE "Reglage"  // "Tune"
	#define MSG_PAUSE_PRINT "Pause Impression"  // "Pause Print"
	#define MSG_RESUME_PRINT "Reprendre Imp."  // "Resume Print"
	#define MSG_STOP_PRINT "Arrete Impression"  // "Stop Print"
	#define MSG_CARD_MENU "Imprimer Carte SD"  // "Print from SD"
	#define MSG_NO_CARD "Pas de Carte"  // "No Card"
	#define MSG_DWELL "Veille..."  // "Sleep..."
	#define MSG_USERWAIT "Attente utilisateur?"  // "Wait for user..."
	#define MSG_RESUMING "Reprise impression."  // "Resuming print"
	#define MSG_NO_MOVE "Aucun deplacement."  // "No move."
	#define MSG_KILLED "IMP. INTERROMPUE! "  // "KILLED. "
	#define MSG_STOPPED "IMPRESSION ARRETEE. "  // "STOPPED. "
	#define MSG_CONTROL_RETRACT  "Retract mm"  // "Retract mm"
	#define MSG_CONTROL_RETRACTF "Retract  F"  // "Retract  F"
	#define MSG_CONTROL_RETRACT_ZLIFT "Hop mm"  // "Hop mm"
	#define MSG_CONTROL_RETRACT_RECOVER "UnRet +mm"  // "UnRet +mm"
	#define MSG_CONTROL_RETRACT_RECOVERF "UnRet  F"  // "UnRet  F"
	...
	#define MSG_EXTRUDER "Extrudeur" // "Extruder"
...
// Serial Console Messages
	...
	#define MSG_Enqueing "mise en tampon \""  // "enqueing \""
	#define MSG_POWERUP "Allumage"  // "PowerUp"
	#define MSG_EXTERNAL_RESET " RAZ Externe"  // " External Reset"
	#define MSG_BROWNOUT_RESET " RAZ defaut alim."  // " Brown out Reset"
	#define MSG_WATCHDOG_RESET " RAZ Watchdog"  // " Watchdog Reset"
	#define MSG_SOFTWARE_RESET " RAZ logicielle"  // " Software Reset"
	#define MSG_MARLIN "Marlin "  // "Marlin "
	#define MSG_AUTHOR " | Auteur(e): "  // " | Author: "
	#define MSG_CONFIGURATION_VER " Derniere Maj:: "  // " Last Updated: "
	#define MSG_FREE_MEMORY " Memoire libre: "  // " Free Memory: "
	#define MSG_PLANNER_BUFFER_BYTES "  PlannerBufferBytes: "  // "  PlannerBufferBytes: "
	#define MSG_OK "ok"  // "ok"
	#define MSG_FILE_SAVED "Fichier enregistre."  // "Done saving file."
	#define MSG_ERR_LINE_NO "Le numero de ligne n'est pas la derniere ligne + 1, derniere ligne: "  // "Line Number is not Last Line Number+1, Last Line: "
	#define MSG_ERR_CHECKSUM_MISMATCH "erreur checksum, derniere ligne: "  // "checksum mismatch, Last Line: "
	#define MSG_ERR_NO_CHECKSUM "Pas de checksum avec le numero de ligne, derniere ligne: "  // "No Checksum with line number, Last Line: "
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM "Pas de numero de ligne avec checksum, derniere ligne: "  // "No Line Number with checksum, Last Line: "
	#define MSG_FILE_PRINTED "Impression terminee!"  // "Done printing file"
	#define MSG_BEGIN_FILE_LIST "Debut de la liste de fichiers"  // "Begin file list"
	#define MSG_END_FILE_LIST "Fin de la liste de fichiers"  // "End file list"
	#define MSG_M104_INVALID_EXTRUDER "M104 Extrudeur invalide "  // "M104 Invalid extruder "
	#define MSG_M105_INVALID_EXTRUDER "M105 Extrudeur invalide "  // "M105 Invalid extruder "
	#define MSG_M218_INVALID_EXTRUDER "M218 Extrudeur invalide "  // "M218 Invalid extruder "
	#define MSG_ERR_NO_THERMISTORS "Pas de thermistor - pas de temperature"  // "No thermistors - no temperature"
	#define MSG_M109_INVALID_EXTRUDER "M109 Extrudeur invalide "  // "M109 Invalid extruder "
	#define MSG_HEATING "Chauffage buse..."  // "Heating..."
	#define MSG_HEATING_COMPLETE "Chauffage complete!"  // "Heating done."
	#define MSG_BED_HEATING "Chauffage lit..."  // "Bed Heating."
	#define MSG_BED_DONE "Lit chaud & pret!"  // "Bed done."
	#define MSG_M115_REPORT "FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) "\n"  // "FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) "\n"
	#define MSG_COUNT_X " Compteur X: "  // " Count X: "
	#define MSG_ERR_KILLED "Impression arretee. kill() appelee!"  // "Printer halted. kill() called!"
	#define MSG_ERR_STOPPED "Impression arretee a cause d'erreurs. Corriger les erreurs et utiliser M999 pour la reprise. (Temperature remise a zero. Reactivez la apres redemarrage.)"  // "Printer stopped due to errors. Fix the error and use M999 to restart. (Temperature is reset. Set it after restarting)"
	#define MSG_RESEND "Renvoie: "  // "Resend: "
	#define MSG_UNKNOWN_COMMAND "Commande inconnue: \""  // "Unknown command: \""
	#define MSG_ACTIVE_EXTRUDER "Extrudeur actif: "  // "Active Extruder: "
	#define MSG_INVALID_EXTRUDER "Extrudeur invalide"  // "Invalid extruder"
	#define MSG_X_MIN "x_min: "  // "x_min: "
	#define MSG_X_MAX "x_max: "  // "x_max: "
	#define MSG_Y_MIN "y_min: "  // "y_min: "
	...
	#define MSG_SD_CANT_OPEN_SUBDIR "Impossible d'ouvrir le sous-repertoire"  // "Cannot open subdir"
	#define MSG_SD_INIT_FAIL "Echec de l'initialisation de la carte SD"  // "SD init fail"
	#define MSG_SD_VOL_INIT_FAIL "Echec de volume.init"  // "volume.init failed"
	#define MSG_SD_OPENROOT_FAIL "Echec openRoot"  // "openRoot failed"
	#define MSG_SD_CARD_OK "Carte SD Ok"  // "SD card ok"
	#define MSG_SD_WORKDIR_FAIL "Echec d'ouverture workDir"  // "workDir open failed"
	#define MSG_SD_OPEN_FILE_FAIL "Echec d'ouverture, Fichier: "  // "open failed, File: "
	#define MSG_SD_FILE_OPENED "Fichier ouvert: "  // "File opened: "
	#define MSG_SD_SIZE " Taille: "  // " Size: "
	#define MSG_SD_FILE_SELECTED "Fichier selectionne"  // "File selected"
	#define MSG_SD_WRITE_TO_FILE "Ecriture dans le fichier: "  // "Writing to file: "
	#define MSG_SD_PRINTING_BYTE "Octet impression SD "  // "SD printing byte "
	#define MSG_SD_NOT_PRINTING "Pas d'impression SD"  // "Not SD printing"
	#define MSG_SD_ERR_WRITE_TO_FILE "erreur d'ecriture dans le fichier"  // "error writing to file"
