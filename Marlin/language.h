...
// Serial Console Messages
	...
	#define MSG_PREHEAT_PLA0 " Преднагрев PLA 1 "
	#define MSG_PREHEAT_PLA1 " Преднагрев PLA 2 "
	...
	#define MSG_PREHEAT_ABS0 " Преднагрев ABS 1 "
	#define MSG_PREHEAT_ABS1 " Преднагрев ABS 2 "
