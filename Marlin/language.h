...
// LCD Menu Messages
	...
	#define MSG_SWITCH_PS_ON "Encender Fuente"
	#define MSG_SWITCH_PS_OFF "Apagar Fuente"
  ...
  #define MSG_ZPROBE_OUT "ZProbe Fuera de la base"
  #define MSG_POSITION_UNKNOWN "Home X/Y antes que Z"
  #define MSG_ZPROBE_ZOFFSET "Desplazamiento Z"
	#define MSG_BABYSTEP_X "Babystep X"
	#define MSG_BABYSTEP_Y "Babystep Y"
	#define MSG_BABYSTEP_Z "Babystep Z"
	#define MSG_ENDSTOP_ABORT "Endstop abort"
...
// LCD Menu Messages
	...
	#define MSG_SD_INSERTED "Tarcheta SD mesa"
	#define MSG_SD_REMOVED "Tarcheta SD sacada"
	...
	#define MSG_PART_RELEASE "Desacople parcial"
	#define MSG_STEPPER_RELEASED "Desacoplada."
  #define MSG_ZPROBE_OUT "ZProbe difuera d'a base"
  #define MSG_POSITION_UNKNOWN "Home X/Y en antes que Z"
  #define MSG_ZPROBE_ZOFFSET "Desplazamiento Z"
	#define MSG_BABYSTEP_X "Babystep X"
	#define MSG_BABYSTEP_Y "Babystep Y"
	#define MSG_BABYSTEP_Z "Babystep Z"
...
// Serial Console Messages
	...
	#define MSG_POWERUP "PowerUp"
	#define MSG_EXTERNAL_RESET " Reset externo"
	#define MSG_BROWNOUT_RESET " Reset por voltache incorrecto"
	#define MSG_WATCHDOG_RESET " Reset por bloqueo"
	#define MSG_SOFTWARE_RESET " Reset por software"
	#define MSG_MARLIN "Marlin "
	#define MSG_AUTHOR " | Autor: "
	...
	#define MSG_PLANNER_BUFFER_BYTES "  PlannerBufferBytes: "
	#define MSG_OK "ok"
	#define MSG_FILE_SAVED "Alzau."
	#define MSG_ERR_LINE_NO "O Numero de Linea no ye igual a o zaguer numero de linea+1, zaguera linea:"
	#define MSG_ERR_CHECKSUM_MISMATCH "o checksum no coincide, zaguera linea:"
	#define MSG_ERR_NO_CHECKSUM "No se podió trobar o Checksum con o numero de linea, zaguera linea:"
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM "No se trobo o numero de linea con o Checksum, zaguera linea:"
	...
	#define MSG_M109_INVALID_EXTRUDER "M109 Extrusor invalido "
	#define MSG_HEATING "Calentando..."
	#define MSG_HEATING_COMPLETE "Calentada feita."
	#define MSG_BED_HEATING "Calentando la base."
	#define MSG_BED_DONE "Base calient"
	#define MSG_M115_REPORT "FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X " Cuenta X:"
	#define MSG_ERR_KILLED "Impresora Aturada con kill()!!"
	#define MSG_ERR_STOPPED "Impresora aturada por errors. Apanye a error y use M999 ta reiniciar!. (a temperatura se reestablice. Achuste-la en antes de continar)"
	...
	#define MSG_ENDSTOP_HIT "PRETO"
	#define MSG_ENDSTOP_OPEN "ubierto"
	#define MSG_HOTEND_OFFSET "Desplazamientos d'o hotend:"
	...
	#define MSG_STEPPER_TOO_HIGH "Tasa de pasos masiau alta : "
