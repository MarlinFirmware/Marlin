...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 470,  20 }, { 470, 480 }, { 20, 480 }, { 250, 20 }, { 470, 250 }, { 250, 480 },{ 20, 250 }, { 250, 250 } }

  // Define position names for probe points.
  #define TRAMMING_POINT_NAME_1 "Front-Left"
  #define TRAMMING_POINT_NAME_1 "Front-Left-Unreasonably-Long-Name-Just-For-Testing"
  #define TRAMMING_POINT_NAME_2 "Front-Right"
  #define TRAMMING_POINT_NAME_3 "Back-Right"
  #define TRAMMING_POINT_NAME_4 "Back-Left"
  #define TRAMMING_POINT_NAME_5 "Front-Mid"
  #define TRAMMING_POINT_NAME_6 "Mid-Right"
  #define TRAMMING_POINT_NAME_7 "Back-Mid"
  #define TRAMMING_POINT_NAME_8 "Mid-Left"
  #define TRAMMING_POINT_NAME_9 "Center"

  #define RESTORE_LEVELING_AFTER_G35    // Enable to restore leveling setup after operation
  //#define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first     <-------- can be removed, milimeters are shown by default, screw turns are shown if user defines proper screw thread
  ...
  /** 
   * For tramming instructions shown also as number of screw turn, define your screw thread properties.
   * 
   ...
   *
   *   Comment out TRAMMING_SCREW_THREAD to disable instructions in "Screw Turn" units
   */
