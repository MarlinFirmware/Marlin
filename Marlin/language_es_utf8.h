...
#define MSG_AUTOSTART                       _UxGT("Inicio automГЎtico")
#define MSG_DISABLE_STEPPERS                _UxGT("Apagar motores")
#define MSG_DEBUG_MENU                      _UxGT("MenГє depurar")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("NivelaciГіn lista!")
...
#define MSG_ACC                             _UxGT("AceleraciГіn")
...
#define MSG_WATCH                           _UxGT("InformaciГіn")
#define MSG_PREPARE                         _UxGT("Preparar")
#define MSG_TUNE                            _UxGT("Ajustar")
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impresiГіn")
#define MSG_RESUME_PRINT                    _UxGT("Reanudar impresiГіn")
#define MSG_STOP_PRINT                      _UxGT("Detener impresiГіn")
#define MSG_CARD_MENU                       _UxGT("MenГє de SD")
#define MSG_NO_CARD                         _UxGT("No hay tarjeta SD")
#define MSG_DWELL                           _UxGT("Reposo...")
#define MSG_USERWAIT                        _UxGT("Esperando Гіrdenes")
#define MSG_PRINT_ABORTED                   _UxGT("ImpresiГіn cancelada")
...
#define MSG_AUTORETRACT                     _UxGT("RetracciГіn Auto.")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Error: Temp MГЎxima")
#define MSG_ERR_MINTEMP                     _UxGT("Error: Temp MГ­nima")
...
#define MSG_INFO_STATS_MENU                 _UxGT("EstadГ­sticas Imp.")
...
#if LCD_WIDTH > 19
  #define MSG_INFO_PRINT_COUNT              _UxGT("Conteo de impresiГіn")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Completadas")
  #define MSG_INFO_PRINT_TIME               _UxGT("Tiempo total de imp.")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("ImpresiГіn mГЎs larga")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("Total de ExtrusiГіn")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Impresiones")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Completadas")
  #define MSG_INFO_PRINT_TIME               _UxGT("Total")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("MГЎs larga")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("ExtrusiГіn")
#endif

#define MSG_INFO_MIN_TEMP                   _UxGT("Temperatura mГ­nima")
#define MSG_INFO_MAX_TEMP                   _UxGT("Temperatura mГЎxima")
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Extruir mГЎs")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Resumir imp.")

#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp MГ­nima es ")
...
#define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("y presione el botГіn")
...
#define MSG_FILAMENT_CHANGE_HEAT_1          _UxGT("Oprima botГіn para")
