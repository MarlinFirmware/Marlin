...
// added 26 DEC 2016
#define SPINDLE_LASER_ENABLE_PIN 20     // should have a pull up/down on it
#define SPINDLE_SPEED_LASER_POWER_PIN  16     // MUST BE A HARDWARE PWM
#define SPINDLE_DIR_PIN    21

#define CASE_LIGHT_PIN   15    // MUST BE A HARDWARE PWM
