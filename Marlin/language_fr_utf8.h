...
#define WELCOME_MSG                         MACHINE_NAME _UxGT(" prГЄte.")
#define MSG_BACK                            _UxGT("Retour")
#define MSG_SD_INSERTED                     _UxGT("Carte insГ©rГ©e")
#define MSG_SD_REMOVED                      _UxGT("Carte retirГ©e")
#define MSG_LCD_ENDSTOPS                    _UxGT("ButГ©es") // Max length 8 characters
#define MSG_MAIN                            _UxGT("Menu principal")
#define MSG_AUTOSTART                       _UxGT("DГ©marrage auto")
#define MSG_DISABLE_STEPPERS                _UxGT("ArrГЄter moteurs")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("Mise Г  niveau OK!")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Hauteur lissГ©e")
#define MSG_SET_HOME_OFFSETS                _UxGT("RГ©gl. dГ©cal. origine")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("DГ©calages appliquГ©s")
#define MSG_SET_ORIGIN                      _UxGT("RГ©gler origine")
#define MSG_PREHEAT_1                       _UxGT("PrГ©chauffage PLA")
#define MSG_PREHEAT_1_N                     _UxGT("PrГ©chauff. PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("PrГ©ch. PLA Tout")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1 _UxGT(" buse")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("PrГ©ch. PLA lit")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("RГ©gl. prech. PLA")
#define MSG_PREHEAT_2                       _UxGT("PrГ©chauffage ABS")
#define MSG_PREHEAT_2_N                     _UxGT("PrГ©chauff. ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("PrГ©ch. ABS Tout")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2 _UxGT(" buse")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("PrГ©ch. ABS lit")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("RГ©gl. prech. ABS")
#define MSG_COOLDOWN                        _UxGT("Refroidir")
#define MSG_SWITCH_PS_ON                    _UxGT("Allumer alim.")
#define MSG_SWITCH_PS_OFF                   _UxGT("Г‰teindre alim.")
#define MSG_EXTRUDE                         _UxGT("Extrusion")
#define MSG_RETRACT                         _UxGT("Retrait")
#define MSG_MOVE_AXIS                       _UxGT("DГ©placer un axe")
#define MSG_BED_LEVELING                    _UxGT("RГ©gl. Niv. lit")
#define MSG_LEVEL_BED                       _UxGT("RГ©gl. Niv. lit")
#define MSG_LEVEL_CORNERS                   _UxGT("Niveau coins")
#define MSG_NEXT_CORNER                     _UxGT("Coin suivant")
#define MSG_EDITING_STOPPED                 _UxGT("ArrГЄt Г©dit. maillage")
...
#define MSG_UBL_LEVEL_BED                   _UxGT("Niveau lit unifiГ©")
...
#define MSG_UBL_BC_REMOVE                   _UxGT("Г”ter et mesurer lit")
#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Aller au suivant")
#define MSG_UBL_ACTIVATE_MESH               _UxGT("Activer l'UBL")
#define MSG_UBL_DEACTIVATE_MESH             _UxGT("DГ©sactiver l'UBL")
#define MSG_UBL_SET_BED_TEMP                _UxGT("TempГ©rature lit")
#define MSG_UBL_CUSTOM_BED_TEMP             MSG_UBL_SET_BED_TEMP
#define MSG_UBL_SET_HOTEND_TEMP             _UxGT("TempГ©rature buse")
#define MSG_UBL_CUSTOM_HOTEND_TEMP          MSG_UBL_SET_HOTEND_TEMP
#define MSG_UBL_MESH_EDIT                   _UxGT("Г‰diter maille")
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Г‰diter maille perso")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("RГ©glage fin maille")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Terminer maille")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("CrГ©er maille perso")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("CrГ©er maille")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("CrГ©er maille PLA")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("CrГ©er maille ABS")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("CrГ©er maille froide")
...
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Annuler le plus prГЁs")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("RГ©glage fin (tous)")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("RГ©glage fin (proche)")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Stockage maille")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot mГ©moire")
...
#define MSG_NO_STORAGE                      _UxGT("Pas de mГ©moire")
#define MSG_UBL_SAVE_ERROR                  _UxGT("Err: Enreg. UBL")
#define MSG_UBL_RESTORE_ERROR               _UxGT("Err: Ouvrir UBL")
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("DГ©cal. Z arrГЄtГ©")
#define MSG_UBL_STEP_BY_STEP_MENU           _UxGT("UBL Pas Г  pas")

#define MSG_LED_CONTROL                     _UxGT("ContrГґle LED")
#define MSG_LEDS                            _UxGT("LumiГЁre")
#define MSG_LED_PRESETS                     _UxGT("PrГ©regl. LED")
...
#define MSG_SET_LEDS_DEFAULT                _UxGT("DГ©faut")
#define MSG_CUSTOM_LEDS                     _UxGT("Lum. perso.")
#define MSG_INTENSITY_R                     _UxGT("IntensitГ© rouge")
#define MSG_INTENSITY_G                     _UxGT("IntensitГ© vert")
#define MSG_INTENSITY_B                     _UxGT("IntensitГ© bleu")
#define MSG_INTENSITY_W                     _UxGT("IntensitГ© blanc")
#define MSG_LED_BRIGHTNESS                  _UxGT("LuminositГ©")

#define MSG_MOVING                          _UxGT("DГ©placement...")
#define MSG_FREE_XY                         _UxGT("DГ©bloquer XY")
#define MSG_MOVE_X                          _UxGT("DГ©pl. X")
#define MSG_MOVE_Y                          _UxGT("DГ©pl. Y")
#define MSG_MOVE_Z                          _UxGT("DГ©pl. Z")
#define MSG_MOVE_E                          _UxGT("Extrudeur")
#define MSG_MOVE_01MM                       _UxGT("DГ©pl. 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("DГ©pl. 1mm")
#define MSG_MOVE_10MM                       _UxGT("DГ©pl. 10mm")
...
#define MSG_CONTROL                         _UxGT("ContrГґler")
...
#define MSG_OFF                             _UxGT("ArrГЄt")
#define MSG_PID_P                           _UxGT("PID-P")
#define MSG_PID_I                           _UxGT("PID-I")
#define MSG_PID_D                           _UxGT("PID-D")
#define MSG_PID_C                           _UxGT("PID-C")
#define MSG_SELECT                          _UxGT("SГ©lectionner")
#define MSG_ACC                             _UxGT("AccГ©lГ©ration")
...
#define MSG_VELOCITY                        _UxGT("VГ©locitГ©")
#define MSG_VMAX                            _UxGT("Vmax ")
#define MSG_VMIN                            _UxGT("Vmin ")
#define MSG_VTRAV_MIN                       _UxGT("V dГ©pl. min")
#define MSG_ACCELERATION                    _UxGT("AccГ©lГ©ration")
#define MSG_AMAX                            _UxGT("Amax ")
#define MSG_A_RETRACT                       _UxGT("A retrait")
#define MSG_A_TRAVEL                        _UxGT("A dГ©pl.")
...
#define MSG_PRINT_ABORTED                   _UxGT("Impr. AnnulГ©e")
#define MSG_NO_MOVE                         _UxGT("Moteurs bloquГ©s.")
#define MSG_KILLED                          _UxGT("MORT.")
#define MSG_STOPPED                         _UxGT("STOPPГ‰.")
...
#define MSG_FILAMENTUNLOAD                  _UxGT("DГ©charger fil.")
#define MSG_FILAMENTUNLOAD_ALL              _UxGT("DГ©charger tout")
#define MSG_INIT_SDCARD                     _UxGT("Init. la carte SD")
#define MSG_CNG_SDCARD                      _UxGT("Changer de carte")
#define MSG_ZPROBE_OUT                      _UxGT("Z sonde hors lit")
#define MSG_SKEW_FACTOR                     _UxGT("Facteur Г©cart")
#define MSG_BLTOUCH                         _UxGT("BLTouch")
#define MSG_BLTOUCH_SELFTEST                _UxGT("Autotest BLTouch")
#define MSG_BLTOUCH_RESET                   _UxGT("RaZ BLTouch")
#define MSG_BLTOUCH_DEPLOY                  _UxGT("DГ©ployer BLTouch")
...
#define MSG_ZPROBE_ZOFFSET                  _UxGT("DГ©calage Z")
#define MSG_BABYSTEP_X                      _UxGT("Babystep X")
#define MSG_BABYSTEP_Y                      _UxGT("Babystep Y")
#define MSG_BABYSTEP_Z                      _UxGT("Babystep Z")
#define MSG_ENDSTOP_ABORT                   _UxGT("ButГ©e abandon")
...
#define MSG_HALTED                          _UxGT("IMPR. STOPPГ‰E")
#define MSG_PLEASE_RESET                    _UxGT("RГ Z. SVP")
...
#define MSG_DELTA_SETTINGS                  _UxGT("RГ©glages Delta")
...
#define MSG_3POINT_LEVELING                 _UxGT("Niveau Г  3 points")
#define MSG_LINEAR_LEVELING                 _UxGT("Niveau linГ©aire")
#define MSG_BILINEAR_LEVELING               _UxGT("Niveau bilinГ©aire")
#define MSG_UBL_LEVELING                    _UxGT("Niveau lit unifiГ©")
...
#define MSG_CASE_LIGHT                      _UxGT("LumiГЁre caisson")
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("LuminositГ©")

#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Nbre impressions")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("TerminГ©es")
...
#define MSG_M600_TOO_COLD                   _UxGT("M600: Trop froid")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1        _UxGT("Attente DГ©marrage")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("dГ©charger filament")
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("InsГ©rer filament")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("InsГ©rer et clic")
