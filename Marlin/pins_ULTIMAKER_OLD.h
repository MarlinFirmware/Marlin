...
//
  ...
  #define CASE_LIGHT_PIN        7  // use PWM -  must be a hardware PWM
#endif
...
//
    ...
    #define SPINDLE_SPEED_LASER_POWER_PIN   9  // SW5  must be a hardware PWM
    #define SPINDLE_LASER_ENABLE_PIN  8  // SW6  should have a pull up
    ...
    #define SPINDLE_SPEED_LASER_POWER_PIN   9  // EXP3-7 (silkscreen says 9) must be a hardware PWM
    #define SPINDLE_LASER_ENABLE_PIN  8  // EXP3-8 (silkscreen says 8) should have a pull up
 ...
 *      E0_DIR_PIN     45
 *
 *   If one of the heaters is used then special precautions will usually be needed.  They
 *   have an LED & resistor pullup to +24V which could damage 3.3V-5V ICs.
 */

    #if EXTRUDERS == 1    // move E0 stepper module to the spare and get signals from E0
      #undef  E0_STEP_PIN
      #undef  E0_DIR_PIN             // free up E0 socket
      #undef  E0_ENABLE_PIN
      #define E0_STEP_PIN        49  // move function to spare socket
      #define E0_DIR_PIN         47
      #define E0_ENABLE_PIN      48
      #define SPINDLE_DIR_PIN    43  //
      #define SPINDLE_SPEED_LASER_POWER_PIN  45  //  must be a hardware PWM
      #define SPINDLE_LASER_ENABLE_PIN 41  //  should have a pull up
      ...
      #define SPINDLE_SPEED_LASER_POWER_PIN   4  //  must be a hardware PWM - special precautions usually needed
      #define SPINDLE_LASER_ENABLE_PIN 40  //  should have a pull up - probably pin 6 on 10 pin connector
                                     //  closest to the E0 socket
    #endif
  #endif
#endif
 ...
 *      SPINDLE_SPEED_LASER_POWER_PIN   DIR      O|     |O  GND
 *                                    -------
