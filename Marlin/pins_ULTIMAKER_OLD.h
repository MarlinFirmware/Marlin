...
//
    ...
    #define SPINDLE_SPEED_PIN   9  // SW5  must be a hardware PWM
    #define SPINDLE_ENABLE_PIN  8  // SW6  should have a pull up
    ...
    #define SPINDLE_SPEED_PIN   9  // EXP3-7 (silkscreen says 9) must be a hardware PWM
    #define SPINDLE_ENABLE_PIN  8  // EXP3-8 (silkscreen says 8) should have a pull up
 ...
 */
      ...
      #define SPINDLE_ENABLE_PIN 41  //  should have a pull up
      ...
      #define SPINDLE_SPEED_PIN   4  //  must be a hardware PWM - special precautions usually needed
      #define SPINDLE_ENABLE_PIN 40  //  should have a pull up - probably pin 6 on 10 pin connector
 ...
 *                                    -------
 *     SPINDLE_ENABLE_PIN   /ENABLE  *|     |O  VMOT
 *                          MS1      O|     |O  GND
 *                          MS2      O|     |O  2B
 *                          MS3      O|     |O  2A
 *                          /RESET   O|     |O  1A
