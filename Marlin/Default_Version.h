...
#if true
#define SHORT_BUILD_VERSION "1.1.0-RC3-cmsj-hotbed"
#define DETAILED_BUILD_VERSION "1.1.0-RC3-cmsj-hotbed Official Hotbed Mod"
#define STRING_DISTRIBUTION_DATE "2021-01-12 12:00"
// It might also be appropriate to define a location where additional information can be found
#define SOURCE_CODE_URL  "https://github.com/cmsj/Marlin/tree/1.1.0-RC3-Labists-X1-cmsj"
#endif
