...
- [2. Delta preparation](#2-SETTINGS-THE-PRINTER)
  ...
  - [2.5. Perform a PID](#25-PID_[Proportional-Integral-Derivative](https://reprap.org/wiki/PID_Tuning))
...
## 2.3. Bed Levelling
  ...
  **Perform or correct by calculation (worksheet) the adjustment of your dimensions:**
  ...
  ## 2.5. PID_[Proportional-Integral-Derivative](https://reprap.org/wiki/PID_Tuning)
