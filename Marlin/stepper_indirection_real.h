...
/**
  stepper_indirection_real.h - stepper motor driver indirection macros
...
#ifndef STEPPER_INDIRECTION_REAL_H
#define STEPPER_INDIRECTION_REAL_H
...
#endif // STEPPER_INDIRECTION_REAL_H
