...
#include "math.h"
  ...
  #define UNIFIED_BED_LEVELING_H
    ...
    void UBL_line_to_destination(float, float, float, float, float, unsigned char);
    ...
    #define MESH_X_DIST ((float) ((((float) UBL_MESH_MAX_X)-((float) UBL_MESH_MIN_X)) / (((float) UBL_MESH_NUM_X_POINTS)-1.0)))
    #define MESH_Y_DIST ((float) ((((float) UBL_MESH_MAX_Y)-((float) UBL_MESH_MIN_Y)) / (((float) UBL_MESH_NUM_Y_POINTS)-1.0)))
    ...
    class bed_leveling {
      ...
      struct ubl_state {
        ...
        int  n_x = UBL_MESH_NUM_X_POINTS;
        int  n_y = UBL_MESH_NUM_Y_POINTS;
        float mesh_x_min = UBL_MESH_MIN_X;
        float mesh_y_min = UBL_MESH_MIN_Y;
        float mesh_x_max = UBL_MESH_MAX_X;
        float mesh_y_max = UBL_MESH_MAX_Y;
