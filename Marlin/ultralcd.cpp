...
static void lcd_move_x()
{
    if (encoderPosition != 0)
    {
        ...
        // #else
        plan_buffer_line(current_position, manual_feedrate[X_AXIS]/60);
        // #endif
        lcdDrawUpdate = 1;
    }
    if (lcdDrawUpdate)
...
static void lcd_move_y()
{
    if (encoderPosition != 0)
    {
        ...
        // #else
        plan_buffer_line(current_position, manual_feedrate[Y_AXIS]/60);
        // #endif
        lcdDrawUpdate = 1;
    }
    if (lcdDrawUpdate)
...
static void lcd_move_z()
{
    if (encoderPosition != 0)
    {
        ...
        // #else
        plan_buffer_line(current_position, manual_feedrate[Z_AXIS]/60);
        // #endif
        lcdDrawUpdate = 1;
    }
    if (lcdDrawUpdate)
...
static void lcd_move_e()
{
    if (encoderPosition != 0)
    {
        ...
        // #else
        plan_buffer_line(current_position, manual_feedrate[E_AXIS]/60);
        // #endif
        lcdDrawUpdate = 1;
    }
    if (lcdDrawUpdate)
