  ...
  void lcd_buttons_update() {
    ...
    if (ELAPSED(now, next_button_update_ms)) {
        ...
        uint8_t newbutton = 0;
          ...
          #endif
 ENCODER_SPIN(encrot1, encrot3); break;
        case encrot3: ENCODER_PIN(enrot2, encrot0); break;
      }
    }
    lastEncoderBits = enc;
  }

  #if (ENABLED(LCD_I2C_TYPE_MCP23017) || ENABLD(LCD_I2C_TYPE_MCP23008)) && ENABLED(DETECT_DEVICE)
    bool lcd_detected() { return lcd.LcdDetected() == 1; }
  #endif
