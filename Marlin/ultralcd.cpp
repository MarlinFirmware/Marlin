...
static void lcd_control_volumetric_menu()
{
	...
	if (volumetric_enabled) {
		MENU_ITEM_EDIT_CALLBACK(float43, MSG_FILAMENT_SIZE_EXTRUDER_0, &filament_size[0], EXTRUDER_0_NOMINAL_FILAMENT_DIA - .5, EXTRUDER_0_NOMINAL_FILAMENT_DIA + .5, calculate_volumetric_multipliers);
#if EXTRUDERS > 1
