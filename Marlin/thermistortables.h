...
#if (THERMISTORHEATER_0 == 65) || (THERMISTORHEATER_1 == 65) || (THERMISTORHEATER_2 == 65) || (THERMISTORBED == 65) // 100k Epcos thermistor
//una que he encontrado en nuestra config
const short temptable_65[][2] PROGMEM = {
       {     555,       300     }, // r=   165 adc=34.72
    {     599,       295     }, // r=   179 adc=37.45
    {     647,       290     }, // r=   193 adc=40.42
    {     699,       285     }, // r=   210 adc=43.66
    {     755,       280     }, // r=   227 adc=47.19
    {     817,       275     }, // r=   247 adc=51.04
    {     884,       270     }, // r=   268 adc=55.24
    {     957,       265     }, // r=   292 adc=59.81
    {    1037,       260     }, // r=   318 adc=64.81
    {    1124,       255     }, // r=   347 adc=70.26
    {    1219,       250     }, // r=   378 adc=76.20
    {    1323,       245     }, // r=   413 adc=82.69
    {    1436,       240     }, // r=   452 adc=89.76
    {    1560,       235     }, // r=   495 adc=97.48
    {    1694,       230     }, // r=   543 adc=105.89
    {    1841,       225     }, // r=   596 adc=115.05
    {    2000,       220     }, // r=   654 adc=125.02
    {    2174,       215     }, // r=   720 adc=135.88
    {    2363,       210     }, // r=   793 adc=147.67
    {    2567,       205     }, // r=   874 adc=160.46
    {    2789,       200     }, // r=   965 adc=174.33
    {    3029,       195     }, // r=  1067 adc=189.32
    {    3288,       190     }, // r=  1182 adc=205.51
    {    3567,       185     }, // r=  1310 adc=222.94
    {    3867,       180     }, // r=  1454 adc=241.66
    {    4187,       175     }, // r=  1616 adc=261.70
    {    4530,       170     }, // r=  1798 adc=283.09
    {    4893,       165     }, // r=  2004 adc=305.84
    {    5279,       160     }, // r=  2237 adc=329.92
    {    5685,       155     }, // r=  2501 adc=355.30
    {    6111,       150     }, // r=  2800 adc=381.92
    {    6555,       145     }, // r=  3140 adc=409.69
    {    7016,       140     }, // r=  3526 adc=438.50
    {    7491,       135     }, // r=  3966 adc=468.19
    {    7978,       130     }, // r=  4469 adc=498.60
    {    8473,       125     }, // r=  5044 adc=529.54
    {    8972,       120     }, // r=  5702 adc=560.78
    {    9473,       115     }, // r=  6458 adc=592.09
    {    9972,       110     }, // r=  7327 adc=623.23
    {   10463,       105     }, // r=  8329 adc=653.96
    {   10945,       100     }, // r=  9485 adc=684.05
    {   11412,        95     }, // r= 10823 adc=713.26
    {   11862,        90     }, // r= 12375 adc=741.41
    {   12293,        85     }, // r= 14177 adc=768.30
    {   12701,        80     }, // r= 16277 adc=793.79
    {   13084,        75     }, // r= 18727 adc=817.76
    {   13442,        70     }, // r= 21595 adc=840.14
    {   13774,        65     }, // r= 24958 adc=860.88
    {   14079,        60     }, // r= 28912 adc=879.95
    {   14358,        55     }, // r= 33575 adc=897.38
    {   14611,        50     }, // r= 39086 adc=913.19
    {   14839,        45     }, // r= 45619 adc=927.45
    {   15044,        40     }, // r= 53385 adc=940.22
    {   15226,        35     }, // r= 62644 adc=951.60
    {   15387,        30     }, // r= 73717 adc=961.69
    {   15529,        25     }, // r= 87000 adc=970.57
    {   15654,        20     }, // r=102988 adc=978.35
    {   15762,        15     }, // r=122295 adc=985.14
    {   15856,        10     }, // r=145694 adc=991.03
    {   15938,         5     }, // r=174153 adc=996.12
    {   16008,         0     } // r=208899 adc=1000.49

 //safety
};
#endif
//el nuestro calculado con la tabla
#if (THERMISTORHEATER_0 == 66) || (THERMISTORHEATER_1 == 66) || (THERMISTORHEATER_2 == 66) || (THERMISTORBED == 66) // 100k epcos
const short temptable_66[][2] PROGMEM = {
{1007.6036*OVERSAMPLENR, 0},
{1003.6198*OVERSAMPLENR, 5},
{998.7430*OVERSAMPLENR, 10}, 
{992.8135*OVERSAMPLENR, 15},
{985.6551*OVERSAMPLENR,  20},
{977.0774*OVERSAMPLENR, 25}, 
{966.8796*OVERSAMPLENR, 30},
{954.8563*OVERSAMPLENR, 35}, 
{940.8055*OVERSAMPLENR, 40},
{924.5382*OVERSAMPLENR, 45}, 
{905.8910*OVERSAMPLENR, 50}, 
{884.7386*OVERSAMPLENR, 55},
{861.0084*OVERSAMPLENR, 60},
{834.6928*OVERSAMPLENR, 65},
{805.8604*OVERSAMPLENR, 70},
{774.6620*OVERSAMPLENR, 75},
{741.3323*OVERSAMPLENR, 80},
{706.1846*OVERSAMPLENR, 85},
{669.5995*OVERSAMPLENR, 90},
{632.0078*OVERSAMPLENR, 95},
{593.8690*OVERSAMPLENR, 100},
{555.6490*OVERSAMPLENR, 105},
{517.7970*OVERSAMPLENR, 110},
{480.7261*OVERSAMPLENR, 115},
{444.7979*OVERSAMPLENR, 120},
{410.3123*OVERSAMPLENR, 125},
{377.5025*OVERSAMPLENR, 130},
{346.5353*OVERSAMPLENR, 135},
{317.5149*OVERSAMPLENR, 140},
{290.4896*OVERSAMPLENR, 145},
{265.4603*OVERSAMPLENR, 150},
{242.3893*OVERSAMPLENR, 155},
{221.2090*OVERSAMPLENR, 160},
{201.8303*OVERSAMPLENR, 165},
{184.1493*OVERSAMPLENR, 170},
{168.0539*OVERSAMPLENR, 175},
{153.4280*OVERSAMPLENR, 180},
{140.1555*OVERSAMPLENR, 185},
{128.1229*OVERSAMPLENR, 190},
{117.2215*OVERSAMPLENR, 195},
{107.3486*OVERSAMPLENR, 200},
{98.4081*OVERSAMPLENR, 205}, 
{90.3111*OVERSAMPLENR, 210},
{82.9760*OVERSAMPLENR, 215},
{76.3280*OVERSAMPLENR, 220},
{70.2991*OVERSAMPLENR, 225},
{64.8280*OVERSAMPLENR, 230},
{59.8591*OVERSAMPLENR, 235},
{55.3421*OVERSAMPLENR, 240},
{51.2323*OVERSAMPLENR, 245},
{47.4890*OVERSAMPLENR, 250},
{44.0760*OVERSAMPLENR, 255},
{40.9608*OVERSAMPLENR, 260},
{38.1143*OVERSAMPLENR, 265},
{35.5104*OVERSAMPLENR, 270},
{33.1255*OVERSAMPLENR, 275},
{30.9389*OVERSAMPLENR, 280},
{28.9316*OVERSAMPLENR, 285},
{27.0868*OVERSAMPLENR, 290},
{25.3894*OVERSAMPLENR, 295},
{23.8259*OVERSAMPLENR, 300}
};
#endif	
