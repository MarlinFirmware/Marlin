	...
	#define OVERSAMPLENR 16
	...
	#if (THERMISTORHEATER_0 == 72) || (THERMISTORHEATER_1 == 72) || (THERMISTORHEATER_2 == 72) || (THERMISTORHEATER_3 == 72) || (THERMISTORBED == 72) // 100k MF58
		// R0 = 100000 Ohm
		// T0 = 25 °C
		// Beta = 3950
		// R1 = 0 Ohm
		...
		const short temptable_72[][2] PROGMEM = {
			{1, 1},
			{1023, 223} //to allow internal 0 degrees C
		};
		#endif
