...
#endif
#if (THERMISTORHEATER_0 == 111) || (THERMISTORHEATER_1 == 111) || (THERMISTORHEATER_2 == 111) || (THERMISTORBED == 111) // Epcos B57560G104F 100K on JHeadMKV
+const short temptable_11[][2] PROGMEM = {
...
+#endif
+
+#if (THERMISTORHEATER_0 == 112) || (THERMISTORHEATER_1 == 112) || (THERMISTORHEATER_2 == 112) || (THERMISTORBED == 112) // Epcos B57861S 104F 40 100K on Mendel90 bed, max temp 115
