...
//#ifndef TEENSY_TO_FAST
//  #define TEENSY_TO_FAST(c) (c)
//#endif
...
#if AVR_AT90USB1286_FAMILY  // the file fastio_AT90USB-Marlin.h explains why TEENSY_TO_FAST is used
  #define _READ_AT90USB(IO) _READ(IO)
  #define READ(IO) _READ_AT90USB(TEENSY_TO_FAST(IO))

  #define _WRITE_AT90USB(IO,V) _WRITE(IO,V)
  #define WRITE(IO,V) _WRITE_AT90USB(TEENSY_TO_FAST(IO),V)

  #define _TOGGLE_AT90USB(IO) _TOGGLE(IO)
  #define TOGGLE(IO) _TOGGLE_AT90USB(TEENSY_TO_FAST(IO))

  #define _SET_INPUT_AT90USB(IO) _SET_INPUT(IO)
  #define SET_INPUT(IO) _SET_INPUT_AT90USB(TEENSY_TO_FAST(IO))

  #define SET_INPUT_PULLUP(IO) do{ _SET_INPUT_AT90USB(TEENSY_TO_FAST(IO)); _WRITE_AT90USB(TEENSY_TO_FAST(IO), HIGH); }while(0)

  #define _SET_OUTPUT_AT90USB(IO) _SET_OUTPUT(IO)
  #define SET_OUTPUT(IO) _SET_OUTPUT_AT90USB(TEENSY_TO_FAST(IO))

  #define _GET_INPUT_AT90USB(IO) _GET_INPUT(IO)
  #define GET_INPUT(IO) _GET_INPUT_AT90USB(TEENSY_TO_FAST(IO))

  #define _GET_OUTPUT_AT90USB(IO) _GET_OUTPUT(IO)
  #define GET_OUTPUT(IO) _GET_OUTPUT_AT90USB(TEENSY_TO_FAST(IO))

  #define _GET_TIMER_AT90USB(IO) _GET_TIMER(IO)
  #define GET_TIMER(IO) _GET_TIMER_AT90USB(TEENSY_TO_FAST(IO))
