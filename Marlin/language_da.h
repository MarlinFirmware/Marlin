...
#define MSG_DISABLE_STEPPERS                _UxGT("SlГҐ alle steppere fra")
...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klik nГҐr du er klar")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("NГ¦ste punkt")
#define MSG_LEVEL_BED_DONE                  _UxGT("Bed level er fГ¦rdig!")
#define MSG_SET_HOME_OFFSETS                _UxGT("SГ¦t forsk. af home")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Forsk. er nu aktiv")
#define MSG_SET_ORIGIN                      _UxGT("SГ¦t origin")
...
#define MSG_COOLDOWN                        _UxGT("AfkГёl")
#define MSG_SWITCH_PS_ON                    _UxGT("SlГҐ strГёm til")
#define MSG_SWITCH_PS_OFF                   _UxGT("SlГҐ strГёm fra")
...
#define MSG_FAN_SPEED                       _UxGT("BlГ¦ser hastighed")
...
#define MSG_MOTION                          _UxGT("BevГ¦gelse")
...
#define MSG_USERWAIT                        _UxGT("Venter pГҐ bruger...")
#define MSG_PRINT_ABORTED                   _UxGT("Print annulleret")
#define MSG_NO_MOVE                         _UxGT("Ingen bevГ¦gelse.")
#define MSG_KILLED                          _UxGT("DRГ†BT. ")
#define MSG_STOPPED                         _UxGT("STOPPET. ")
#define MSG_CONTROL_RETRACT                 _UxGT("TilbagetrГ¦k mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Skift Re.mm")
#define MSG_CONTROL_RETRACTF                _UxGT("TilbagetrГ¦k V")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("Temp lГёber lГёbsk")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("ForsГ¦t print")

#if LCD_HEIGHT >= 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent pГҐ start")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("af filament")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("skift")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Vent pГҐ")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("filament udskyd.")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("IndsГ¦t filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("og tryk pГҐ knap")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("for at fortsГ¦tte...")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Vent pГҐ")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament indtag")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Vent pГҐ at print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("fortsГ¦tter")
#else // LCD_HEIGHT < 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent venligst...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Udskyder...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("IndsГ¦t og klik")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Indtager...")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("FortsГ¦tter...")
#endif // LCD_HEIGHT < 4
