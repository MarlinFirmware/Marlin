...
// added 1 DEC
  ...
  #define SPINDLE_SPEED_LASER_POWER_PIN     44
  #define SPINDLE_LASER_ENABLE_PIN    43  // should have a pullup resistor on this pin
  ...
  #define Y_DIR_PIN             60
  #define SPINDLE_SPEED_LASER_POWER_PIN      4
  #define SPINDLE_LASER_ENABLE_PIN    17  // should have a pullup resistor on this pin
  #define SPINDLE_DIR_PIN        5
#endif

#define CASE_LIGHT_PIN        45    // try to use the keypad connector
