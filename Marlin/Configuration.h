...
#define STRING_CONFIG_H_AUTHOR "MOYE.eu" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "beta 2.0"     // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "www.moye.eu"  // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Rumba-PS3Alu by MOUE.eu"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160.3204, 160.2304, 800, 837}  // calibrated steps per unit for PS3Alu - full 32 microstep for Z axis (recomended layer size are multiple of 0.0025mm) Extruder TITAN - theoreticaly 837
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 43       // Number of LEDs in the strip
