...
#if ENABLED(PIDTEMP)
  //#define PID_MENU              // Add items to manually edit PID values through the LCD "Temperature" menu (costs ~700 bytes of PROGMEM)
  //#define PID_AUTOTUNE_MENU     // Add PID Autotune to the LCD "Temperature" menu to run M303 and apply the result (costs another ~250 bytes of PROGMEM)
