...
#define STRING_CONFIG_H_AUTHOR "(Marlin, 2.1.3.0)" // Original author or contributor.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 5120, 832.6 }
...
// @section extruder
//ЗДЕСЬ МОЖНО ИНВЕРТИРОВАНТЬ ДВИДЕНИЕ ЭКСТРУДЕРА ПРИ НЕОБХОДИМОСТИ
