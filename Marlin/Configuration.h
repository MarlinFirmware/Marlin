...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 100.78             // (mm) Get this value from G33 auto calibrate
  #endif

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 293.05             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.40, -0.63, 0.0 } // Get these values from G33 auto calibrate
  //10:18:41.384 : echo:  M666 X-0.40 Y-0.63 Z0.00

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.16,-0.15, 0.31 } // Get these values from G33 auto calibrate
  //10:18:41.386 : echo:  M665 L217.00 R100.78 H293.05 S100.00 X-0.16 Y-0.15 Z0.31 A0.00 B0.00 C0.00
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.65 }  //Luj PROBE 1 es -19,00
#else
...
#define MIN_SOFTWARE_ENDSTOPS  //Luj 31/08/2018  evita mover el ENDHOT por debajo del 0 HEIGHT. Se puede anular por menu, ver README.md
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (60*60) }           //Lujhoming 
