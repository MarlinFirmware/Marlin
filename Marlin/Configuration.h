...
#define STRING_CONFIG_H_AUTHOR "(olemin)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "VasOk"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 480, 480, 1600, 578 } // { 160, 160, 1600, 194 }
...
#define HOMING_FEEDRATE_MM_M { (32*60), (32*60), (4*60) }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              17+18 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
