...
#define STRING_CONFIG_H_AUTHOR "Minims" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BEAR"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 174.80
  #define DEFAULT_bedKi 21.69
  #define DEFAULT_bedKd 938.98
...
#define Z_PROBE_FEEDRATE_FAST (5*60*10)
