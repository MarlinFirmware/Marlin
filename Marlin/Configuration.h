...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, Ender-3, Velo555)" // Who made the changes. // Changed by Velo555
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

#define SHORT_BUILD_VERSION "bugfix-2.1.x-Velo555" // Changed by Velo555

#define STRING_DISTRIBUTION_DATE "2023-12-2" // Changed by Velo555
 ...
 */
#define BAUDRATE 250000 // Changed by Velo555

#define BAUD_RATE_GCODE     // Enable G-code M575 to set the baud rate // Changed by Velo555
...
#define CUSTOM_MACHINE_NAME "John's Ender-3 is" // Changed by Velo555
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash) // Changed by Velo555
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash) // Changed by Velo555
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 25 } // Changed by Velo555
...
#define Z_PROBE_FEEDRATE_FAST (8*60) // Changed by Velo555
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM  // Enable/Disable software endstops from the LCD // Changed by Velo555
#endif
...
#define HOMING_FEEDRATE_MM_M { (80*60), (80*60), (8*60) } // Changed by Velo555
...
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255 // Changed by Velo555
