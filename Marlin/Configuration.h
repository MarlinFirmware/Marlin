...
#define CUSTOM_MACHINE_NAME "MEMES_V3.1"
...
#define TEMP_BED_RESIDENCY_TIME      1  // (seconds) Time to wait for bed to "settle" in M190 //changed to allow faster bed probing with heaters off
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 119.31
  #define DEFAULT_bedKi 21.57
  #define DEFAULT_bedKd 440.01
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2 //changed  //think this might be it
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 136.36 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -7, -0.90} //changed
...
#define XY_PROBE_FEEDRATE (220*60) // changed // prev 150*80
#define HOMING_FEEDRATE_Z  (6*60) // changed prev 6*60

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST HOMING_FEEDRATE_Z

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 2) //changed
...
#define Z_AFTER_PROBING             3 // Z position after probing is done // i think this one is for after it does m48/g29
...
#define X_BED_SIZE 230 //prev 230
#define Y_BED_SIZE 223 // lower because of microswiss direct drive

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -5
#define Y_MIN_POS -16 //prev 20
#define Z_MIN_POS 0
#define X_MAX_POS 260 // changed
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_USE_PROBE
    ...
    #define LEVEL_CORNERS_PROBE_TOLERANCE 0.001
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. // gives message at bootup if eeprom is different //changed
#endi
 ...
 */
//#define PRINTJOB_TIMER_AUTOSTART //disabled for custom menu
