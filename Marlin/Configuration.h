...
#define STRING_CONFIG_H_AUTHOR "(R1crd, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 80.24
  #define DEFAULT_bedKi 14.74
  #define DEFAULT_bedKd 291.30
 ...
 *   (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0 //32  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0 //-2  // Y offset: -front +behind [the nozzle]
...
#define Z_MIN_POS 0
#define X_MAX_POS 238.5
#define Y_MAX_POS 225.5
