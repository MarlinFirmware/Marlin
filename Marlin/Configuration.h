...
//
// 1 - Select your printer (NO MORE REQUIRED HERE),
#define LONGER3D
#ifdef Longer3D_LKx  // It is defined  in platformio.ini build parameters
 // #define LK1
  // #define LK1_PLUS
  //#define LK2
   #define LK4
...
/*LONGER is a manufacturer of LONGER_LKx and Alfawise Ux0 printers. 
**Thanks to Hobi and tpruvot for their contributions. 
**LONGER's code is written based on their code.
*/
#define STRING_CONFIG_H_AUTHOR "LONGER, Hobi, tpruvot"  // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_LONGER3D
#endif
 ...
 */
#if ENABLED(U20_PLUS) || ENABLED(LK1_PLUS)
#define PIDTEMPBED
#else
//#define PIDTEMPBED
#endif
...
#if ENABLED(U20_PLUS)|| ENABLED(LK1_PLUS) // The PID setting MUST be updated.
  //From M303 command 
  #define DEFAULT_bedKp 841.68
  #define DEFAULT_bedKi 152.12
  #define DEFAULT_bedKd 1164.25
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 92.6 }  //98
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25 }// { 200, 200, 100, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION       { 1000, 1000, 100, 3000 }// { 200, 200, 100, 3000 }
 ...
 */
#define DEFAULT_ACCELERATION          1000//200    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000//500    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000//200    // X, Y, Z acceleration for travel (non printing) moves
...
#define DEFAULT_FILAMENT_CHECK_DISABLE  false
#define DEFAULT_FILE_LIST_ORDER         false   /* FALSE: inverse direction TRUE: forward direction */   
...
#if ENABLED(LK2) || ENABLED(LK4) ||ENABLED(U30)
#define X_BED_SIZE 220
#define Y_BED_SIZE 220
#define Z_MACHINE_MAX 250
#endif

#if ENABLED(LK1) ||ENABLED(U20) 
#define X_BED_SIZE 300
#define Y_BED_SIZE 300
#define Z_MACHINE_MAX 400
#endif

#if ENABLED(LK1_PLUS) || ENABLED(U20_PLUS)
...
#define TOUCH_BUTTONS
  ...
  #if ENABLED(TS_V1)
  /*ILI9341 2.8 TP */
    #define XPT2046_X_CALIBRATION   12755
    #define XPT2046_Y_CALIBRATION  -8746
    #define XPT2046_X_OFFSET       -41
