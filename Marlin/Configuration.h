...
#define STRING_CONFIG_H_AUTHOR "(Admar, default config)" //21_06_2020 Who made the changes.
...
#define MAX_BED_POWER 110 // !! limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 30.39 //!!
  #define DEFAULT_bedKi 5.84 //!!
  #define DEFAULT_bedKd 105.35 //!!
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,  100, 1600, 558.5} //@@ 473 558.5 eSteps/mm: 95 100/100/400/580 //@@ Zchange for 1600 Lead screw lead 2mm peach 2mm
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 100} //@@ default Anet {400, 400, 5, 45/25} //@@SKR  400 400 10 120
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 700, 700, 25,  2000 }  //@@ z Z150 E2000
...
#define Z_SERVO_ANGLES { 5, 60 } //!! Z Servo Deploy and Stow angles
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, -10, -1.78 } //!!
...
#define DEBUG_LEVELING_FEATURE //!!
  ...
  #define G26_MESH_VALIDATION //!!
    ...
    #define MESH_TEST_HOTEND_TEMP  227    //!! (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
