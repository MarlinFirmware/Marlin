 ...
 */
#define BAUDRATE 115200 // Vertex Nano's board does not manage a baud rate 250000 or above well. Keeps dropping out. Could be a faulty power supply.
...
#define MACHINE_UUID "52d8478a-599d-47e8-a0d3-536ad3f97be7"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Vertex Nano - Old factory defaults from Velleman's Marlin 1.x code
  //#define DEFAULT_Kp 100
  //#define DEFAULT_Ki 6
  //#define DEFAULT_Kd 400
  // Vertex Nano - As reported by PID autotune with M303 E0 S200 C8
  #define DEFAULT_Kp 24.22
  #define DEFAULT_Ki 2.03
  #define DEFAULT_Kd 72.43
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 4571.4, 75 } // Z-steps calculated with M4 thread pitch (0.7mm) and 1/16th step configuration: 3200 steps per full rotation / 0.7 = ~4571.43
