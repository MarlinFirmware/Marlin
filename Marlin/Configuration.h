 ...
 * Devices to check for the presence of filament.
 *
 *   FRS_SWITCH  : A switch to detect filament presence
 *   FRS_ENCODER : A disc to detect filament motion
 *   FRS_PAT9125 : A PAT9125 motion sensor, as used in the Prusa MK3
 *
