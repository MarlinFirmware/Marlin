...
#define STRING_VERSION_CONFIG_H "16/10/2012" //Personal revision number for changes to THIS file.
...
// Setar AutoTune M303 S200
//Kp: 46.98
//Ki: 3.30
//Kd: 167.02
    #define  DEFAULT_Kp 46.98
    #define  DEFAULT_Ki 3.30
    #define  DEFAULT_Kd 167.02
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {77.58,62.8,200*16/1.25,850}// 604 // 579.5 // 720
#define DEFAULT_MAX_FEEDRATE          {300, 150, 5, 45}    // (mm/sec)    
