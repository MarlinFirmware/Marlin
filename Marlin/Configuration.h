...
#define STRING_CONFIG_H_AUTHOR "(reichel, markus)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 540.67 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -1.10 }
