...
#define STRING_CONFIG_H_AUTHOR "(Kazi, A10 config)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Have a great day!" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "___m_oO_m___"         // will be shown during bootup in line 2
