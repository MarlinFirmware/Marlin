...
#define STRING_CONFIG_H_AUTHOR "(Creality CR-10 SKRv1.3 TMC2209)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 SKRv1.3 TMC2209 3DTouch"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -8, -2.150 }
