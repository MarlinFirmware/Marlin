...
#elif ENABLED(TINYBOY_L10) || ENABLED(TINYBOY_L16)  || ENABLED(TINYBOY_MAGO)
#else
...
#elif ENABLED(TINYBOY_L16) || ENABLED(TINYBOY_E16) || ENABLED(TINYBOY_M16) || ENABLED(TINYBOY_MAGO)
...
// fred
#if ENABLED(TINYBOY_RE20) || ENABLED(TINYBOY_RA20) || ENABLED(TINYBOY_RA30)
#elif ENABLED(TINYBOY_L10) || ENABLED(TINYBOY_L16) || ENABLED(TINYBOY_A10) || ENABLED(TINYBOY_MAGO)
#else
