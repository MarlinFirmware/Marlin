...
#define STRING_CONFIG_H_AUTHOR "(Freddy, GTRM5 X5SA)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Freddy Printer"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki  1.724
    #define DEFAULT_Kd  62.7
    //Recv: #define DEFAULT_Kp 16.0354
    //Recv: #define DEFAULT_Ki 1.1389
    //Recv: #define DEFAULT_Kd 56.4445
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 153.4584
  #define DEFAULT_bedKi 30.2084
  #define DEFAULT_bedKd 519.7126
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 695.95 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 150.878 }
/**
 * Default Max Feed Rate (mm/s)
 * Override with M203
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20, 1400 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 40, 5000 }  // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  //#define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 1000, 40000 } // ...or, set your own edit limits not Test
  #define MAX_ACCEL_EDIT_VALUES       { 9000, 9000, 1500, 20000 } // ...or, set your own edit limits
#endif
...
#define DEFAULT_EJERK    5.0  // May be used by Linear Advance Default 5.0 
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.12 // (mm) Distance from real junction edge default 0.013  
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -13, -2 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 400, 400, 20 }
...
#if ENABLED(BTT_TFT)
  #define HAS_DISPLAY 1 // for Support
  //#define REPRAP_DISPLAY
  //#define CR10_DISPLAY
  #define EXTENSIBLE_UI
  

  //#define LCD_SERIAL_PORT 3
  #define BTT_TFT_SERIAL_Port 3
  #define BTT_TFT_BAUDRATE 57600

  #ifdef LCD_SERIAL_PORT
  #define LCD_BAUDRATE 57600
  #endif
