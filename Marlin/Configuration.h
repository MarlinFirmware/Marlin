 ...
 * TODO
 * 
 * Pomalsie nahrievanie nozzly (Hugo povedal ze netreba)
 * Probing
 * Problemy s osamy pozriet sa na to
 * Zhadzovanie vytlacku
 * 
*/
...
#define STRING_CONFIG_H_AUTHOR "Juro" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  6.78
    #define DEFAULT_Ki   0.47
    #define DEFAULT_Kd 24.68
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 400, 400, 689 }
 ...
 * NOZZLE_TO_PROBE_OFFSET  #define NOZZLE_TO_PROBE_OFFSET {-10,  5, -1 }   // Example "2"
...
#define Z_PROBE_LOW_POINT           0 // (mm) Farthest distance below the trigger-point to go before stopping
