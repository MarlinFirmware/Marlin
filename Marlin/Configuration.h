...
#define STRING_CONFIG_H_AUTHOR "RPGFabi" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rembrandt van Print"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "faa841ae-3949-4358-8874-d1ebef90d8ef"
 ...
 *   RPGFABI_MFU          : Multifilament Unity by RPGFabi for DIY
 *
 * Requires NOZZLE_PARK_FEATURE to park print head in case MMU unit fails.
 * See additional options in Configuration_adv.h.
 * :["PRUSA_MMU1", "PRUSA_MMU2", "PRUSA_MMU2S", "EXTENDABLE_EMU_MMU2", "EXTENDABLE_EMU_MMU2S", "RPGFABI_MFU"]
 */
#define MMU_MODEL RPGFABI_MFU
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 136.13
  #define DEFAULT_bedKi 26.59
  #define DEFAULT_bedKd 464.67
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 159.5, 159.81, 800.4, 833.00 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 150, 1500 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              120 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
  ...
  #define NEOPIXEL_BKGD_INDEX_FIRST   41 // Index of the first background LED
  #define NEOPIXEL_BKGD_INDEX_LAST    80 // Index of the last background LED
