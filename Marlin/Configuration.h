...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -62.2
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -20
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -8.95
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,1000}  // 
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0,7,95} // X,Y,Z Axis Extend and Retract angles
