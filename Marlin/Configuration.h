...
#define STRING_CONFIG_H_AUTHOR "(iTopia, Pandora)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Pandora
  #define  DEFAULT_Kp 43.91
  #define  DEFAULT_Ki 1.93
  #define  DEFAULT_Kd 250.33
...
#define Y_MIN_POS 0
#define Z_MIN_POS -4
#define X_MAX_POS 336
#define Y_MAX_POS 336
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define RIGHT_PROBE_BED_POSITION 336
    #define FRONT_PROBE_BED_POSITION 35
    #define BACK_PROBE_BED_POSITION 301
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {2*80,2*80,2*3200,274}
