...
#define STRING_CONFIG_H_AUTHOR "(@Esteban Ariel Risso | HE3D K280, SKR v1.3, TMC2209 Dual 2-2, TFT35 v3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HE3D K280 - @ARI"
...
#define PID_MAX   56      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  10.87,  10.87 }
    #define DEFAULT_Ki_LIST {   1.55,   1.55 }
    #define DEFAULT_Kd_LIST {  19.21,  19.21 }
  #else
  ...
  #endif
#else
  #define BANG_MAX  56    // Limit hotend current while in bang-bang mode; 255=full current
#endif
 ...
 */
  ...
  #define MPC_MAX 56                                  // (0..255) Current to nozzle while MPC is active.
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 62.00
  #define DEFAULT_bedKi 11.023
  #define DEFAULT_bedKd 234.4
...
#define DELTA
  ...
  #define DELTA_HEIGHT 601.95             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 179.80              // (mm) Get this value from G33 auto calibrate
...
//---------- COM: @ARI - Sobreescribo los pasos por milimetros para darle un ajuste perfecto ----------//
//#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define DEFAULT_XYZ_STEPS_PER_UNIT 79.76
//---------- FIN: @ARI - Sobreescribo los pasos por milimetros para darle un ajuste perfecto ----------//

#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 95.61, 95.21 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -9, 0, 0 }
