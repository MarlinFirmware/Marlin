...
#define STRING_CONFIG_H_AUTHOR "(Adam's Tornado SKR 1.3 2209)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Un3Dprinting"
...
//#define HOTEND_OFFSET_Y { 0.0 }  // (mm) relative Y-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 150, 50, 50 }
