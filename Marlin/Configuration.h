...
#define STRING_CONFIG_H_AUTHOR "Jason Theriault" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro (3/12/23)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -9, -2.875 }
...
#define HOMING_FEEDRATE_MM_M { (133*60), (133*60), (8*60) }
