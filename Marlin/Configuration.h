...
#define STRING_CONFIG_H_AUTHOR "iLMario" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Geeetech A20 E3Dv6" //free

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "e4a425fc-09f6-4e49-b83a-b38930d69a70" //free
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 183.88
  #define  DEFAULT_bedKi 36.2 
  #define  DEFAULT_bedKd 233.48
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 410 }  // a10m a20m: esteps 430 /a10 a20 esteps 97 CHECK YOUR STEPS
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 2) // Originale Vert: 30
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   15 // Z Clearance for Deploy/Stow (ALE: Specifiche BLTouch)
#define Z_CLEARANCE_BETWEEN_PROBES 10 // Z Clearance between probe points (ALE: Specifiche BLTouch)
#define Z_CLEARANCE_MULTI_PROBE    10 // Z Clearance between multiple probes (ALE: Specifiche BLTouch)
...
#define X_BED_SIZE 255  //a10+m:230 a20+m:255
#define Y_BED_SIZE 255  //a10+m:230 a20+m:255

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -8 // Era -10 prima di spostare l'endstop usando quello di Z al posto di quello di X
#define Y_MIN_POS -5
#define Z_MIN_POS 0
...
#define FILAMENT_RUNOUT_SENSOR //depends adv pause & nozzle park// works but the resulting print will have messed up layers from stop n start
  ...
  #define NUM_RUNOUT_SENSORS   1 //a10m a20m 2     // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
...
#define HOMING_FEEDRATE_Z  (4*60) // Originale Vert: 800
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //a20+m
