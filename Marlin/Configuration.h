...
//
// Button interface for EasyThreeD Nano, K7
#define EASYTHREED_UI   // Enable no-screen multi-button UI
#define EASYTHREED_ET4000PLUS // Mainboard model for Nano/more recent K7
