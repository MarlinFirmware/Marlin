...
#define STRING_CONFIG_H_AUTHOR "(Majkl <info@michalvondracek.cz>, default Decapede config)" // Who made the changes.
...
#define TEMP_SENSOR_2 72
#define TEMP_SENSOR_3 72
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,200.0*8/3,760*1.1, 760*1.1,760*1.1, 760*1.1}  // default steps per unit for Ultimaker
