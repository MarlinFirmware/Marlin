...
#define STRING_CONFIG_H_AUTHOR "Gary Kennedy" // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 120.30 // (mm)
  ...
  #define DELTA_HEIGHT 275.7              // (mm) Get this value from G33 auto calibrate
