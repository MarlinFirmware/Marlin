...
#define STRING_CONFIG_H_AUTHOR "(Pablo Clemente, bq Witbox FW v1.1)" // Who made the changes.
...
#define DEFAULT_MAX_FEEDRATE          {400, 400, 6, 45}    //  {100, 100, 6, 25} (mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {2000,2000,50,10000}    //   {2000,2000,50,10000}   {9000,9000,50,10000}  X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
...
/*
 ...
 #define EXTRUDER_OFFSET_Y {0,0.2}  // (in mm) for each extruder, offset of the hotend on the Y axis
 */
