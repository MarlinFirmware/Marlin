...
#define STRING_CONFIG_H_AUTHOR "(none, Ender3SKR1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ender3_skr_pro_1_2"
 ...
 */
#define Z_MIN_PROBE_PIN PA2 // Enable Z_MIN_PROBE_PIN
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -28, -8, 0 }
