...
#define BED_MAXTEMP      110 //**IMP-H2 for ABS
...
#if ENABLED(PIDTEMP)
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of PROGMEM)           **IMP-H2 Enabled
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of PROGMEM)       **IMP-H2 Enabled 
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)   **IMP-H2 Enabled
...
#define Z_DRIVER_TYPE  TMC2209_STANDALONE //**IMP-UART TMC CONNECTION ERROR in UART mode
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.026 // (mm) Distance from real junction edge **IMP-H2
...
#define NOZZLE_TO_PROBE_OFFSET { -42, -28, -0.827 } // **IMP-BLTouch Biqu H2
