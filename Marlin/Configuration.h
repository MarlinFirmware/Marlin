...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { X_MAX_POS, (Y_MAX_POS/2), 5 }
  #define NOZZLE_PARK_XY_FEEDRATE 2000  // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
