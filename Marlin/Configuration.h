...
#define STRING_CONFIG_H_AUTHOR "(Crashmatt)" //Who made the changes.
...
#define BANG_MAX 120 // For E3D on 15V
//#define PID_MAX 255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_MAX 150 // For E3D on 15V
#ifdef PIDTEMP
...
// Mendel Parts V9 on 12V - USED FOR K8200
...
#define NUM_SERVOS 1 // Servo index starts with 0 for M280 command
  ...
  #ifdef SDSUPPORT
    #if (NUM_SERVOS > 0)
      #error("SDSUPPORT AND SERVOS ERROR")
    #endif // NUM_SERVOS > 0
  #endif //SDSUPPORT
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 105,30} // X,Y,Z Axis Extend and Retract angles
