...
#define STRING_CONFIG_H_AUTHOR "Ramon Ciervo" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Joachim"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 85
  #define DEFAULT_bedKi 12
  #define DEFAULT_bedKd 420
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {  22.75, 5, -2.1 }
