...
#define STRING_CONFIG_H_AUTHOR "Josh@GZ, Artillery 3D" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Josh's Hornet"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, -23, 0 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                PA0 // LED driving pin (use the default Z-endstop pin for LED output pin)
