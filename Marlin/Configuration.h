 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 10000 }   //E16 { 2000, 2000, 100, 10000 }
...
//#define JUNCTION_DEVIATION
  ...
  #define JUNCTION_DEVIATION_MM 0.02  // (mm) Distance from real junction edge  //E16 0.08
#endif
 ...
 *   (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0   //E16 10 //10 X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 10  //E16 10 // Y offset: -front +behind [the nozzle]
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (100*60) //(50*60)   E16 (50*60)
