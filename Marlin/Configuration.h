 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 16.21f }           // (J/K) Heat block heat capacities.
...
#define PIDTEMPBED
  ...
  //GTR MK3s
#define DEFAULT_bedKp 31.00
#define DEFAULT_bedKi 1.54
#define DEFAULT_bedKd 415.01
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24, 5, -1.5 }
