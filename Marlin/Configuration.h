...
#define STRING_CONFIG_H_AUTHOR "(Marlin 2.0.6, Tonys Drawbot config)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 100, 400, 500 } //16 steps Y belt, x&Z lead screw 2mm pitch x2 for 32 steps
...
#define XY_PROBE_SPEED (20*60) //(133*60)
...
#define X_BED_SIZE 702
#define Y_BED_SIZE 602
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 Z20 F2000\nG1 X0 Y600\nG1 Z20\nM500"
