...
#define CUSTOM_MACHINE_NAME "ARA3DP"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {314.96,314.96,314.96,125.4}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500/60, 500/60, 1000/60, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {25,25,25,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
