...
#define CUSTOM_MACHINE_NAME "Custom Delta"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 360.32 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 354.12 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 177.68 //mm  Get this value from auto calibrate
...
// READ: .Height:338.95    Ex:-1.70  Ey:-1.25  Ez:+0.00    Radius:172.00
//READ: .Height:339.09    Ex:-1.71  Ey:-1.46  Ez:+0.00    Radius:172.01
//READ: .Tower angle :    Tx:-0.26  Ty:-0.17  Tz:+0.00
//READ: Save with M500 and/or copy to Configuration.h
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 400 }   // default steps per unit for PowerWasp
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.15     // Z probe to nozzle Z offset: -below (always!)
...
#define X_BED_SIZE ((DELTA_PRINTABLE_RADIUS)) //((DELTA_PRINTABLE_RADIUS) * 2)
#define Y_BED_SIZE ((DELTA_PRINTABLE_RADIUS)) //((DELTA_PRINTABLE_RADIUS) * 2)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_MESH_INSET 18          // Mesh inset margin on print area
