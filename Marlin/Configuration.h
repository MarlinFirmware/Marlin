...
// Predefined Mechanics for kits/pre-assembled printers.  Use a #include to include your
// machine's mechanical settings, or create custom settings below.  The files to be included
// should "#define PREDEFINED_MECHANICS" to avoid conflicts with the custom settings below
//
// Invent-A-Part RigidBot
//#define RIGIDBOT_SIZE 1            // 1 = 10x10 Regular    ; 2 = 12x16 Big
//#include "mechanics/rigidbot.h"

#ifndef PREDEFINED_MECHANICS
// Custom mechanical settings
