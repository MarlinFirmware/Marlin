...
#define STRING_CONFIG_H_AUTHOR "Kevin Stampe - Anet A8 Plus with BTT SKR v1.4 Turbo" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 295.11
  #define DEFAULT_bedKi 28.10
  #define DEFAULT_bedKd 999.26
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -24, 0, -1.55 }
