...
#define STRING_CONFIG_H_AUTHOR "(ibrahim cengiz, 06.06.2021, SKR 1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Cedit"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 32.69
  #define DEFAULT_bedKi 1.97
  #define DEFAULT_bedKd 361.53
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 442.5 }
 ...
 *     O-- FRONT --+
 */
0#define NOZZLE_TO_PROBE_OFFSET { 0, 56.5, -0.8 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     PI_24     // LED driving pin
