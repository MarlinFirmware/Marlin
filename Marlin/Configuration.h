...
#define STRING_CONFIG_H_AUTHOR "(Vulcany 3D, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD mks_tinybee
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 5000, 400 }
