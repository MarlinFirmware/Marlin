...
#define CUSTOM_MACHINE_NAME "Marlin Steff"
...
#define DEFAULT_MAX_FEEDRATE          {250, 250, 3.3, 100}    // (mm/sec)
...
#define SERVO_ENDSTOP_ANGLES {{0,0}, {0,0}, {73,24}} // X,Y,Z Axis Extend and Retract angles
