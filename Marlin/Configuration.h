...
// #define X_PROBE_OFFSET_FROM_EXTRUDER -44
// #define Y_PROBE_OFFSET_FROM_EXTRUDER -14
#define NOZZLE_TO_PROBE_OFFSET { -44.0, -14.0, -2.34 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 24, 34, 49, 34 } // (mm) Left, Front, Right, Back insets
  #define LEVEL_CORNERS_HEIGHT      0.0   // (mm) Z height of nozzle at leveling points
  #define LEVEL_CORNERS_Z_HOP       3.0   // (mm) Z height of nozzle between leveling points
  //#define LEVEL_CENTER_TOO              // Move to the center after the last corner
  #define LEVEL_CORNERS_USE_PROBE
  #if ENABLED(LEVEL_CORNERS_USE_PROBE)
    #define LEVEL_CORNERS_PROBE_TOLERANCE 0.06
...
// TODO: Enable and configure this
  ...
  #define XY_DIAG_AC 141.29
  #define XY_DIAG_BD 141.55
  #define XY_SIDE_AD 100.10
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 139.90
    #define XZ_DIAG_BD 140.39
