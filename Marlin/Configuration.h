...
#define STRING_CONFIG_H_AUTHOR "(MakerBricks config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MakerBricks Sirius Mini "
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160,40,800,180 }
