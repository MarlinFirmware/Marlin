...
#define STRING_CONFIG_H_AUTHOR "(John69, OEM Config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tronxy X5S-2E SKR-3"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // If there are fewer values, the last one applies to the remaining hotends. plated cooper v6 teflon 0,4 
...
#define PIDTEMPBED
  ...
  // 230V 750W silicone heater into 4mm borosilicate ssr reley 29.9 5.27 113.3
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  #define DEFAULT_bedKp 29.9
  #define DEFAULT_bedKi 5.27
  #define DEFAULT_bedKd 113.3
...
#define EXTRUDE_MAXLENGTH 800 //1000mm bowden tube
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 50, 100 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 100, 100, 10, 50 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, 35, 0.5 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 20, 50, 50, 20 } // (mm) Left, Front, Right, Back insets
...
//
#define PREHEAT_1_LABEL       "Standby ABS"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MIN_POS + 10), 10 }
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   2   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 100   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE    16   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define WIPE_SEQUENCE_COMMANDS "G1 X-10 Y35 Z10 F4000\nG1 Z1\nM114\nG1 X-10 Y25\nG1 X-10 Y95\nG1 X-10 Y25\nG1 X-10 Y95\nG1 X-10 Y25\nG1 X-10 Y95\nG1 X-10 Y25\nG1 X-10 Y95\nG1 X-10 Y25\nG1 X-10 Y95\nG1 X-10 Y25\nG1 X-10 Y95\nG1 Z15\nM400\nG0 X-10.0 Y-20.0"
