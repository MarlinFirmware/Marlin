...
#define STRING_CONFIG_H_AUTHOR "(Hebezo, Ender-3)" // Who made the changes.
...
#define PSU_NAME "Power Supply"
  ...
  #define PSU_ACTIVE_STATE HIGH     // Set 'false' for ATX, 'true' for X-Box
  #define POWER_TIMEOUT 30          // Set shutoff timeout
  #define POWER_OFF_TIMEOUT 30      // Set timeout before shutoff
