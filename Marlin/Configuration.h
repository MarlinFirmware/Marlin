 ...
 *
 * X and E steppers work together to create a differential drive system.
 * If simple: E stepper = X + E  and  X stepper = X  (E drives a loop, X stays the same)
 * If balanced: E stepper = X + E/2  and  X stepper = X - E/2  (a dual loop system)
 */
