...
#define POWER_SUPPLY_CONTROL_FEATURE
  ...
  // If you have a defect, always on, heater MOSFT, this will prevent 
  // from heating right after a reset.
  //#define PS_DEFAULT_OFF

  //#define AUTO_POWER_CONTROL        // Enable automatic control of the PS_ON pin. 
                                      // Warning: Autostart files may switch the power supply on automatically.
