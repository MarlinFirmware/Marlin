...
#define STRING_CONFIG_H_AUTHOR "(Daniel Hibbard)"       // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8 BLUE TITAN V6 "
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 209.02
  #define DEFAULT_bedKi 40.34
  #define DEFAULT_bedKd 721.95
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 70, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {  -43, 3, -2.5 }
...
// The size of the print bed x300 y290 nozzle can reach 
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 3) // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE) / 3) // Y point for Z homing
#endif
