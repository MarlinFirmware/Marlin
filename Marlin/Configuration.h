...
// See: https://github.com/MarlinFirmware/Marlin/blob/Development/Documentation/Hardware.md
#include "boards.h"
#ifndef MOTHERBOARD
...
//#define EXTRUDER_WATTS (12.0*12.0/6.7)  // Watt (P=U^2/R)
//#define BED_WATTS (12.0*12.0/1.1)       // Watt (P=U^2/R)
...
//#define ENABLE_AUTO_BED_LEVELING
  ...
  #define Z_RAISE_BEFORE_HOMING 4 // mm
  ...
  //#define Z_PROBE_SLED
  // The extra distance the X axis must travel to pickup the sled. 0 should be fine but you can push it further if you'd like.
  //#define SLED_DOCKING_OFFSET 5

  // If defined, the Probe servo will be turned on only during movement and then turned off to avoid jerk
  // The value is the delay to turn the servo off after powered on - depends on the servo speed;
  // 300ms is good value, but you can try lower it.
...
#define DEFAULT_MAX_ACCELERATION {9000, 9000, 100, 10000} // mm/s^2
// X, Y, Z and E max acceleration for printing moves
#define DEFAULT_ACCELERATION 3000 // mm/s^2
// X, Y, Z and E max acceleration for retracts
#define DEFAULT_RETRACT_ACCELERATION 3000 // mm/s^2
// Offset of the extruders (uncomment if using more than one and relying on firmware to position when changing).
// The offset has to be X=0, Y=0 for the extruder 0 hotend (default extruder).
// For the other hotends it is their distance from the extruder 0 hotend.
// For each extruder, offset of the hotend on the X axis
//#define EXTRUDER_OFFSET_X {0.0, 20.00} // mm
// For each extruder, offset of the hotend on the Y axis
//#define EXTRUDER_OFFSET_Y {0.0, 5.00} // mm
...
// FIXME: Add description. Whats that?
...
// FIXME: add url and descriptioons
// REMEMBER TO INSTALL LiquidCrystal_I2C.h in your ARDUINO library folder: https://github.com/kiyoshigawa/LiquidCrystal_I2C
...
//#define LCD_I2C_PANELOLU2
  ...
  // Comment out to disable buzzer on LCD
...
//#define LCD_I2C_VIKI
  ...
  // I2C Address of the port expander
  #define LCD_I2C_ADDRESS 0x20
  // Comment out to disable buzzer on LCD (requires LiquidTWI2 v1.2.3 or later)
  #define LCD_USE_I2C_BUZZER
  #define NEWPANEL
  #define ULTIPANEL
#endif // LCD_I2C_VIKI
...
// FIXME: Add URL and description
#ifdef ULTIPANEL
  // Enable this if you have a click-encoder panel
  //#define NEWPANEL
  #define SDSUPPORT
  #define ULTRA_LCD
  // Change number of lines to match the DOG graphic display
  #ifdef DOGLCD
    #define LCD_WIDTH 20
    #define LCD_HEIGHT 5
  #else
...
#else
  #ifdef ULTRA_LCD
    // Change number of lines to match the 128x64 graphics display
    #ifdef DOGLCD
      #define LCD_WIDTH 20
      #define LCD_HEIGHT 5
    #else
