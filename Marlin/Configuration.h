...
#define STRING_CONFIG_H_AUTHOR "(Chad, Ender 5 Plus)" // Who made the changes.
...
#define USE_XMAX_PLUG //cd
#define USE_YMAX_PLUG //cd
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 415 } //cd
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -26, 0 }
