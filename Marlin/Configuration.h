 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {202.6,201.8,800, 185.19}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          {300,300,20, 85}
...
//Use the following to pass a command after a G28 homing command
//useful for issuing 'Z0' command for probe offset.
#define G28_END_SCRIPT "G1 Z0 F50" 
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -.865   // Z offset: -below +above  [the nozzle]
