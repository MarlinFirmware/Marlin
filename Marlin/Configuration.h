...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,800,94.5}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {330, 330, 5, 60}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1500,1500,90,8000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
