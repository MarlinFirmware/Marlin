...
#define STRING_CONFIG_H_AUTHOR "Tom Brazier" // Who made the changes.
 ...
 * for PID_EXTRUSION_SCALING and PID_FAN_SCALING.
 */
...
-Z axis: 96 steps/rotation = 18 teeth. Second gear 54 teeth, reducing
 ...
 tooth.
-Extruder: 200 steps/rotation. Gripper is 22.5mm/rotation.
*/
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 5, 10 }
...
#define INVERT_E0_DIR DISABLED(GEARED_EXTRUDER)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (Y_MAX_POS - 5)    // Y point for Z homing when homing all axes (G28).
#endif
