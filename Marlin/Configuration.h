...
#define STRING_CONFIG_H_AUTHOR "(Erik Arnaud, narnoCube config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "narnoCube"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  9.95480   //21.8041
    #define DEFAULT_Ki  0.59250  //1.2412
    #define DEFAULT_Kd  41.8102  //95.7608
  #endif
#else
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 10.2166f }         // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1707f }        // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1187f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1230f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 44.0525
  #define DEFAULT_bedKi 7.9295
  #define DEFAULT_bedKd 133.1557
