 ...
 */
#define TEMP_SENSOR_0 1 // Era: 5 (come da termistore del clone E3D v6). Messo 1 perchè il termistore è stato sostituito con quello della Ender3
...
#define X_MIN_POS -5 // Era -10 prima di spostare l'endstop usando quello di Z al posto di quello di X
#define Y_MIN_POS -5
#define Z_MIN_POS 0
