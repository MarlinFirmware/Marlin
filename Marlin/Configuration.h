...
#define STRING_CONFIG_H_AUTHOR "(DrDitto, Tevo Flash SKR V1.3)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 100, 50 }
...
//Dr Ditto
/*
  See Configuration_adv.h all defines has setted automatic just adjust the color
  presets
 */
