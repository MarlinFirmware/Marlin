...
#define STRING_VERSION_CONFIG_H "2012-09-17 r01" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "nothinman" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.00, 80.00, 2143.00, 700.00}  // default steps per unit for ultimaker 
#define DEFAULT_MAX_FEEDRATE          {400, 400, 10, 50}    // (mm/sec)    
...
// Preheat Constants
  ...
  #define PLA_PREHEAT_FAN_SPEED 63		// Insert Value between 0 and 255

  #define ABS_PREHEAT_HOTEND_TEMP 235
  #define ABS_PREHEAT_HPB_TEMP 110
  #define ABS_PREHEAT_FAN_SPEED 63		// Insert Value between 0 and 255
