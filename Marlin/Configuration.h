...
#define STRING_CONFIG_H_AUTHOR "(KOR, 230309)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 8.08
  #define DEFAULT_bedKd 708.47
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 6, -1.17 }
...
#define X_BED_SIZE 322
#define Y_BED_SIZE 347
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 5, 40, 40, 5 } // (mm) Left, Front, Right, Back insets
