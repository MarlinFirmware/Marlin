...
#define STRING_CONFIG_H_AUTHOR "Ender 3 pro DExt FRO" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Ender 3 pro DExt FRO"
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600 X0 Y0 B5"
