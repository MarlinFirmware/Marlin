...
#define INVERT_X_DIR true    // for Mendel set to false, for Orca set to true - T800
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.97, 80.43, 4000.00, 1578.4}  // default steps per unit for ultimaker (T800)
