...
#define STRING_CONFIG_H_AUTHOR "(Albator_ssx, Alfawise U30pro Bltouch RGB)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "U30 Pro"
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  // for LK4 pro
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. // for LK4 pro
#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. // for LK4 pro
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.80, 82.39, 405.68, 98.58 }  // for LK4 pro
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.39// 282.8427124746
  #define XY_DIAG_BD 142.49 // 282.8427124746
  #define XY_SIDE_AD 100.99 // 200
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 143.39
    #define XZ_DIAG_BD 143.05
    #define YZ_DIAG_AC 142.92
    #define YZ_DIAG_BD 141.73
    #define YZ_SIDE_AD 99.83
