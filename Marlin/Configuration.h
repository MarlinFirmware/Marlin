...
#define STRING_CONFIG_H_AUTHOR "(justin, tevo config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Justin's Tevo"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -.62   // Z offset: -below +above  [the nozzle]
