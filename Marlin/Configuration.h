...
#define STRING_CONFIG_H_AUTHOR "(Guilherme, 2021-10-04)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Metamaquina"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  41.8
    #define DEFAULT_Ki   5.35
    #define DEFAULT_Kd  81.6
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200.902, 201.261, 5120, 850}
