...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb & codiac2600 & 3eL-Baker: BTT002 MK3S/TMC2209s - UBL)" // Who made the changes.
...
// X and Y axis travel speed (mm/min) between probes (3eL-edit)
 ...
 * A total of 3 or more adds more slow probes, taking the average. (3eL-edit)
 */
...
#define Z_AFTER_PROBING           5 // Z position after probing is done (3eL-edit)
 ...
 *   With an LCD controller the process is guided step-by-step. (3eL-edit)
 */
...
//#define DEBUG_LEVELING_FEATURE
  ...
  /**
   * Enable the G26 Mesh Validation Pattern tool. (3eL-edit)
   */
  ...
  #define MESH_INSET 36              // Set Mesh bounds as an inset region of the bed (3eL-edit)
