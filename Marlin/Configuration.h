 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 11.6f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.080f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.073f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.116f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81.04, 81.39, 802.44, 426.34 }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 200, 6000 } // ...or, set your own edit limits
#endif
