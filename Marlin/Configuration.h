...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
      // ISO Cube - CoreXY
#define DEFAULT_Kp 17.02  //MC
#define DEFAULT_Ki 1.20  //MC
#define DEFAULT_Kd 60.53  //MC
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 300 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 12000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29.88, 20.14, 0 }
