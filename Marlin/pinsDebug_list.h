...
// Pin list updated from 28 May 2017 RCBugfix branch   - max length of pin name is 30
...
#line 31 // set __LINE__ to a known value for both passes
  ...
  REPORT_NAME_TEENSY_DIGITAL(CASE_LIGHT_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(CONTROLLER_FAN)
  REPORT_NAME_TEENSY_DIGITAL(CONTROLLER_FAN_PIN, __LINE__ )  // hardware PWM
#endif
  ...
  #if ENABLED(FAST_PWM_FAN) && E0_AUTO_FAN_PIN == FAN1_PIN
    REPORT_NAME_TEENSY_DIGITAL(E0_AUTO_FAN_PIN, __LINE__ )  // hardware PWM
  #else
    REPORT_NAME_DIGITAL(E0_AUTO_FAN_PIN, __LINE__ )
  #endif
#endif
#if PIN_EXISTS(E1_AUTO_FAN)
  #if ENABLED(FAST_PWM_FAN) && E1_AUTO_FAN_PIN == FAN1_PIN
    REPORT_NAME_TEENSY_DIGITAL(E1_AUTO_FAN_PIN, __LINE__ )  // hardware PWM
  #else
    REPORT_NAME_DIGITAL(E1_AUTO_FAN_PIN, __LINE__ )
  #endif
#endif
#if PIN_EXISTS(E2_AUTO_FAN)
  #if ENABLED(FAST_PWM_FAN) && E2_AUTO_FAN_PIN == FAN1_PIN
    REPORT_NAME_TEENSY_DIGITAL(E2_AUTO_FAN_PIN, __LINE__ )  // hardware PWM
  #else
    REPORT_NAME_DIGITAL(E2_AUTO_FAN_PIN, __LINE__ )
  #endif
#endif
#if PIN_EXISTS(E3_AUTO_FAN)
  #if ENABLED(FAST_PWM_FAN) && E3_AUTO_FAN_PIN == FAN1_PIN
    REPORT_NAME_TEENSY_DIGITAL(E3_AUTO_FAN_PIN, __LINE__ )  // hardware PWM
  #else
    REPORT_NAME_DIGITAL(E3_AUTO_FAN_PIN, __LINE__ )
  #endif
#endif
#if PIN_EXISTS(E4_AUTO_FAN)
  #if ENABLED(FAST_PWM_FAN) && E4_AUTO_FAN_PIN == FAN1_PIN
    REPORT_NAME_TEENSY_DIGITAL(E4_AUTO_FAN_PIN, __LINE__ )  // hardware PWM
  #else
  ...
  REPORT_NAME_TEENSY_ANALOG(EXT_AUX_A0, __LINE__ )
#endif
#if defined(EXT_AUX_A0) && EXT_AUX_A0 >= 0 && EXT_AUX_A0 >= NUM_ANALOG_INPUTS
  ...
  REPORT_NAME_TEENSY_ANALOG(EXT_AUX_A1, __LINE__ )
#endif
#if defined(EXT_AUX_A1) && EXT_AUX_A1 >= 0 && EXT_AUX_A1 >= NUM_ANALOG_INPUTS
  ...
  REPORT_NAME_TEENSY_ANALOG(EXT_AUX_A2, __LINE__ )
#endif
#if defined(EXT_AUX_A2) && EXT_AUX_A2 >= 0 && EXT_AUX_A2 >= NUM_ANALOG_INPUTS
  ...
  REPORT_NAME_TEENSY_ANALOG(EXT_AUX_A3, __LINE__ )
#endif
#if defined(EXT_AUX_A3) && EXT_AUX_A3 >= 0 && EXT_AUX_A3 >= NUM_ANALOG_INPUTS
  ...
  REPORT_NAME_TEENSY_ANALOG(EXT_AUX_A4, __LINE__ )
#endif
#if defined(EXT_AUX_A4) && EXT_AUX_A4 >= 0 && EXT_AUX_A4 >= NUM_ANALOG_INPUTS
  ...
  REPORT_NAME_TEENSY_DIGITAL(EXT_AUX_PWM_D24, __LINE__ )  // hardware PWM
#endif
  ...
  #if PIN_EXISTS(FAN)
    REPORT_NAME_TEENSY_DIGITAL(FAN_PIN, __LINE__ )  // hardware PWM
  #endif
  #if PIN_EXISTS(FAN1)
    REPORT_NAME_TEENSY_DIGITAL(FAN1_PIN, __LINE__ )  // hardware PWM
  #endif
  #if PIN_EXISTS(FAN2)
    REPORT_NAME_TEENSY_DIGITAL(FAN2_PIN, __LINE__ )  // hardware PWM
  #endif
#else
  #if PIN_EXISTS(FAN)
  ...
  REPORT_NAME_TEENSY_ANALOG(FILWIDTH_PIN, __LINE__ )
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(LCD_SDSS, __LINE__ )  // uses Teensy pin numbers
#endif
#if PIN_EXISTS(LED)
  REPORT_NAME_TEENSY_DIGITAL(LED_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(MAIN_VOLTAGE_MEASURE) && MAIN_VOLTAGE_MEASURE_PIN < NUM_ANALOG_INPUTS
  REPORT_NAME_TEENSY_ANALOG(MAIN_VOLTAGE_MEASURE_PIN, __LINE__ )
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(MOTOR_CURRENT_PWM_E_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(MOTOR_CURRENT_PWM_XY)
  REPORT_NAME_TEENSY_DIGITAL(MOTOR_CURRENT_PWM_XY_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(MOTOR_CURRENT_PWM_Z)
  REPORT_NAME_TEENSY_DIGITAL(MOTOR_CURRENT_PWM_Z_PIN, __LINE__ )  // hardware PWM
#endif
...
#endif
#if PIN_EXISTS(PWM_1)
  REPORT_NAME_TEENSY_DIGITAL(PWM_1_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(PWM_2)
  REPORT_NAME_TEENSY_DIGITAL(PWM_2_PIN, __LINE__ )  // hardware PWM
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(RGB_LED_R_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(RGB_LED_G)
  REPORT_NAME_TEENSY_DIGITAL(RGB_LED_G_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(RGB_LED_B)
  REPORT_NAME_TEENSY_DIGITAL(RGB_LED_B_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(RGB_LED_W)
  REPORT_NAME_TEENSY_DIGITAL(RGB_LED_W_PIN, __LINE__ )  // hardware PWM
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(SDSS, __LINE__ )  // uses Teensy pin numbers
#endif
#if defined(LCD_SDSS) && LCD_SDSS >= 0
  REPORT_NAME_TEENSY_DIGITAL(LCD_SDSS, __LINE__ )  // uses Teensy pin numbers
#endif
#if PIN_EXISTS(SERVO0)
  REPORT_NAME_TEENSY_DIGITAL(SERVO0_PIN, __LINE__ )
#endif
#if PIN_EXISTS(SERVO1)
  REPORT_NAME_TEENSY_DIGITAL(SERVO1_PIN, __LINE__ )
#endif
#if PIN_EXISTS(SERVO2)
  REPORT_NAME_TEENSY_DIGITAL(SERVO2_PIN, __LINE__ )
#endif
#if PIN_EXISTS(SERVO3)
  REPORT_NAME_TEENSY_DIGITAL(SERVO3_PIN, __LINE__ )
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(SPINDLE_LASER_PWM_PIN, __LINE__ )  // hardware PWM
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(TOOL_0_PWM_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(TOOL_1)
  REPORT_NAME_DIGITAL(TOOL_1_PIN, __LINE__ )
#endif
#if PIN_EXISTS(TOOL_1_PWM)
  REPORT_NAME_TEENSY_DIGITAL(TOOL_1_PWM_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(TOOL_2)
  REPORT_NAME_DIGITAL(TOOL_2_PIN, __LINE__ )
#endif
#if PIN_EXISTS(TOOL_2_PWM)
  REPORT_NAME_TEENSY_DIGITAL(TOOL_2_PWM_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(TOOL_3)
  REPORT_NAME_DIGITAL(TOOL_3_PIN, __LINE__ )
#endif
#if PIN_EXISTS(TOOL_3_PWM)
  REPORT_NAME_TEENSY_DIGITAL(TOOL_3_PWM_PIN, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(TOOL_PWM)
  REPORT_NAME_TEENSY_DIGITAL(TOOL_PWM_PIN, __LINE__ )  // hardware PWM
#endif
  ...
  REPORT_NAME_TEENSY_DIGITAL(UNUSED_PWM, __LINE__ )  // hardware PWM
#endif
#if PIN_EXISTS(X_ATT)
