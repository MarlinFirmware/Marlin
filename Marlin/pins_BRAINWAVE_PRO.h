 ...
 *
 *    Installation:
 *       1. Go to the above URL, click on the "Clone or Download" button and then click on
 *          "Download ZIP" button.
 *       2. Unzip the file, find the "printrboard" directory and then copy it to the hardware
 *          directory in Arduino.  The Arduino hardware directory will probably be  located
 *          in a path similar to this: C:\Program Files (x86)\Arduino\hardware.
 *       3. Restart Arduino
...
/**
 *  To burn the bootloaded that comes with Printrboard and Marlin_AT90USB
 *   1. Connect your programmer to the board.
 *   2. In the Arduino IDE select "Printrboard" or "AT90USB1286_TEENSYPP" and then
 *      select the programmer.
 *   3. In the Arduino IDE click on "burn bootloader".  Don't worry about the "verify
