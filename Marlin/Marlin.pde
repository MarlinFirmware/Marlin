...
void process_commands()
{
  ...
  else if(code_seen('M'))
  {
    ...
    case 98: // M98
      {
        ...
        SERIAL_PROTOCOL(hysteresis_steps[X_AXIS]);
        SERIAL_PROTOCOLPGM(" Y");
        SERIAL_PROTOCOL(hysteresis_steps[Y_AXIS]);
        SERIAL_PROTOCOLPGM(" Z");
        SERIAL_PROTOCOL(hysteresis_steps[Z_AXIS]);
        SERIAL_PROTOCOLPGM(" E");      
        SERIAL_PROTOCOL(hysteresis_steps[E_AXIS]);
    ...
    case 99: // M99
      {
        if(code_seen('X')) hysteresis_steps[X_AXIS] = code_value() ;
        if(code_seen('Y')) hysteresis_steps[Y_AXIS] = code_value() ;
        if(code_seen('Z')) hysteresis_steps[Z_AXIS] = code_value() ;
        if(code_seen('E')) hysteresis_steps[E_AXIS] = code_value() ;
      }
      break;
    case 115: // M115
