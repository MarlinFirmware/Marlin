...
#define STRING_CONFIG_H_AUTHOR "ThingiBOX" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prusa i3 ION"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 16.89
  #define  DEFAULT_Ki 1.09
  #define  DEFAULT_Kd 65.36
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 350.18
  #define  DEFAULT_bedKi 24.43
  #define  DEFAULT_bedKd 1255.03
