 ...
 */
  ...
  #error "RL200 uses dual Z stepper motors. Adapt Configuration_adv.h or comment out this line to continue on your own risk."
#endif
...
#if !AXIS_DRIVER_TYPE(X, DRV8825) || !AXIS_DRIVER_TYPE(Y, DRV8825) || !AXIS_DRIVER_TYPE(Z, DRV8825) || !AXIS_DRIVER_TYPE(Z2, DRV8825) || !AXIS_DRIVER_TYPE(E0, DRV8825)
