...
//
...
#if MB(RAMPS_OLD)
  #include "ramps/pins_RAMPS_OLD.h"             // ATmega2560                             env:mega2560
#elif MB(RAMPS_13_EFB)
  #include "ramps/pins_RAMPS_13.h"              // ATmega2560                             env:mega2560
  ...
  #include "ramps/pins_RAMPS.h"                 // ATmega2560                             env:mega2560
  ...
  #include "ramps/pins_RAMPS_PLUS.h"            // ATmega2560                             env:mega2560
...
#elif MB(MKS_GEN_13)
  #include "ramps/pins_MKS_GEN_13.h"            // ATmega2560                             env:mega2560
#elif MB(MKS_GEN_L)
...
#elif MB(ULTIMAKER)
  #include "ramps/pins_ULTIMAKER.h"             // ATmega2560                             env:mega2560
#elif MB(ULTIMAKER_OLD)
  #include "ramps/pins_ULTIMAKER_OLD.h"         // ATmega2560                             env:mega2560
#elif MB(AZTEEG_X3)
...
//
  ...
  #include "mega/pins_GT2560_REV_A.h"           // ATmega2560                             env:mega2560
#elif MB(GT2560_REV_A_PLUS)
  #include "mega/pins_GT2560_REV_A_PLUS.h"      // ATmega2560                             env:mega2560
#elif MB(GT2560_V3)
...
//
  ...
  #include "sanguino/pins_SANGUINOLOLU_11.h"    // ATmega1284P                            env:sanguino1284p
#elif MB(SANGUINOLOLU_12)
  #include "sanguino/pins_SANGUINOLOLU_12.h"    // ATmega1284P                            env:sanguino1284p
#elif MB(MELZI)
  #include "sanguino/pins_MELZI.h"              // ATmega1284P                            env:sanguino1284p
#elif MB(MELZI_MAKR3D)
  #include "sanguino/pins_MELZI_MAKR3D.h"       // ATmega1284P                            env:sanguino1284p
#elif MB(MELZI_CREALITY)
  #include "sanguino/pins_MELZI_CREALITY.h"     // ATmega1284P                            env:sanguino1284p
#elif MB(MELZI_MALYAN)
  #include "sanguino/pins_MELZI_MALYAN.h"       // ATmega644P, ATmega1284P                env:sanguino644p env:sanguino1284p
#elif MB(MELZI_TRONXY)
  #include "sanguino/pins_MELZI_TRONXY.h"       // ATmega1284P                            env:sanguino1284p
#elif MB(STB_11)
