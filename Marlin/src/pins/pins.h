...
#elif MB(OPULO_REV3)
  #include "stm32f4/pins_OPULO_REV3.h"          // STM32F4                                env:Opulo_REV3
...
//
  ...
  #define BOARD_INDEX_REV03             99924
  ...
  #elif MB(INDEX_REV03)
      #error "BOARD_INDEX_REV03 is now BOARD_OPULO_REV3. Please update your configuration."
