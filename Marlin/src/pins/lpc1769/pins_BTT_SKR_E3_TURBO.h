...
#define EXPA1_10_PIN                       P2_08
  ...
  #if ANY(CR10_STOCKDISPLAY, REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER)
    ...
    #error "Only ZONESTAR_LCD, MKS_MINI_12864, ENDER2_STOCKDISPLAY, REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER, and CR10_STOCKDISPLAY are currently supported on the BTT_SKR_E3_TURBO."
