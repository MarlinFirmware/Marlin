...
//
  ...
  #define MISO_PIN                         P0_08  // EXP2 Pin 1 (PB3, MISO)
  #define SCK_PIN                          P0_07  // EXP2 Pin 2 (SCK)
  #define SS_PIN                           P0_28  // EXP2 Pin 4 (SD_CSEL, CS)
  #define MOSI_PIN                         P0_09  // EXP2 Pin 6 (PB2, MOSI)
