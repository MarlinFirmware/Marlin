...
#define Z_MIN_PIN          P1_28   // The original Mks SGen DIO19 has a 10k pullup to 3.3V or 5V, 1K series, so when using a Zprobe we must use DIO41 (J8 P1.22)
...
/**
 * The SGen can share the on-board SD card with a PC via USB the following
...
/**
 * There are a number of configurations available for the SGen SD card reader.
...
/**
 * Example for trinamic drivers using the J8 connector on MKs SGen.
