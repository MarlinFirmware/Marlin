 ...
 *              SKR Mini E3 V3.0.1
 *                  ------
 *  (BEEPER)  PB15 |10  9 | PB14 (BTN_ENC)
 *  (BTN_EN1) PA9  | 8  7 | RESET
 *  (BTN_EN2) PA10   6  5 | PB4  (LCD_D4)
 *  (LCD_RS)  PD2  | 4  3 | PC0  (LCD_EN)
 *             GND | 2  1 | 5V
 *                  ------
 *                   EXP1
 */
#define EXP1_09_PIN                         PB14
#define EXP1_03_PIN                         PC0
  ...
  #define BTN_ENC                           PB15
    ...
    #define LCD_PINS_RS                     PB4
    #define LCD_PINS_ENABLE          EXP1_09_PIN
    #define LCD_PINS_D4                     PD2
    ...
    #define DOGLCD_A0                       PB4
    #define DOGLCD_SCK                      PB15
    ...
    #define LCD_BACKLIGHT_PIN               -1
       ...
       *                 Board                               Display
       *                 ------                               ------
       * (BEEPER) PB6  |10  9 | PB15 (SD_DET)             5V |10  9 | GND
       *         RESET | 8  7 | PA9  (MOD_RESET)          -- | 8  7 | (SD_DET)
       *          PB4    6  5 | PA10 (SD_CS)         (MOSI)  | 6  5 | --
       *          PB7  | 4  3 | PD2  (LCD_CS)        (SD_CS) | 4  3 | (LCD_CS)
   ...
   *                   Board                             Display
   *                   ------                            ------
   * (SD_DET)    PB15 |10  9 | PB6 (BEEPER)          5V |10  9 | GND
   * (MOD_RESET) PA9  | 8  7 | RESET            (RESET) | 8  7 | (SD_DET)
   * (SD_CS)     PA10   6  5 | PB4 (FREE)       (MOSI)  | 6  5 | (LCD_CS)
   * (LCD_CS)    PD2  | 4  3 | PB7 (FREE)       (SD_CS) | 4  3 | (MOD_RESET)
