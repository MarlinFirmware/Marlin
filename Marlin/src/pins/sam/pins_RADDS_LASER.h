...
#define BOARD_INFO_NAME "RADDS_LASER"

//
// Servos
//

#define SERVO0_PIN        -1 // Used for laser PWM SPINDLE_LASER_PWM_PIN
#define SERVO1_PIN          6
...
#define HEATER_BED_PIN     -1   // Used for laser on/off SPINDLE_LASER_ENA_PIN
...
#define SPINDLE_LASER_ENA_PIN     7    // Pin should have a pullup/pulldown! (use HEATER_BED_PIN and mosfet)
