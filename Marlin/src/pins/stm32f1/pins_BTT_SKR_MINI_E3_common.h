...
#define TFT_03                              PA2
  ...
  // Migrated to pins/lcd
    ...
    #error "CAUTION! FYSETC_MINI_12864_2_1 and its clones require wiring modifications. See 'adapters.h' for details. (Define NO_CONTROLLER_CUSTOM_WIRING_WARNING to suppress this warning.)"
  #endif
  ...
  #else
    #error "The selected LCD / Controller is not currently supported for BIGTREE_SKR_MINI_E3."
  #endif
