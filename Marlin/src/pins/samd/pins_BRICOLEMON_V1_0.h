...
/*
* NOTE: of use if we decide to use the extra TMC2209 as an independent axis.
* We need to configure the new digital PIN, for this we could configure on the board the extra pin of this stepper, for example as a MIN_PIN/MAX_PIN. This pin its the D14.
*/
...
// This board have the option to use an extra TMC2209 stepper, one of the use could be as a second extruder.
  ...
  //TODO Corregir aquí que cuando tenemos dos extrusores o lo que sea, utiliza los endstop que le sobran, osea los max, no hay Z2_endstop
    ...
    // By default, min pin. But it could be changed.
    //#define Z2_MAX_PIN                             14
    #define Z2_MIN_PIN                             14 
...
* If you have configured in both files, configuration_adv.h and pins_BRICOLEMON_V1_0.h, you will receive a warning by the compiler.
...
// You could use one of the ADC for a temp chamber if you dont use the second extruder, for example.
...
// The board have a total of 4 FAN, use if and configure as desire.
#define FAN_PIN                                8
#define FAN1_PIN                               9
#define FAN2_PIN                               30
#define FAN3_PIN                               31
