...
#if ENABLED(BTT_MINI_12864_V1)                       // BTT Mini 12864 V2.0 connected via 18-pin FPC cable
...
#elif HAS_WIRED_LCD
  #error "Only BTT_MINI_12864_V1 (BTT Mini 12864 V2.0 with FPC cable) is currently supported on the BIGTREE_OCTOPUS_MAX_EZ."
#endif
