...
//
  ...
  #if X_HOME_TO_MIN
    #define X_MAX_PIN                E1_DIAG_PIN  // E0DET
  #else
    #define X_MIN_PIN                E1_DIAG_PIN  // E0DET
  #endif
#elif NEEDS_X_MINMAX
  #ifndef X_MIN_PIN
  ...
  #if Y_HOME_TO_MIN
    #define Y_MAX_PIN                E2_DIAG_PIN  // E1DET
  #else
    #define Y_MIN_PIN                E2_DIAG_PIN  // E1DET
  #endif
#elif NEEDS_Y_MINMAX
  #ifndef Y_MIN_PIN
  ...
  #else
    #define Z_MIN_PIN                E3_DIAG_PIN  // PWRDET
  #endif
#elif NEEDS_Z_MINMAX
  #ifndef Z_MIN_PIN
