...
#elif defined(BOARD_SDIO_D1)
  REPORT_NAME_DIGITAL(__LINE__, BOARD_SDIO_D1)
#endif
#if PIN_EXISTS(SDIO_D2)
  REPORT_NAME_DIGITAL(__LINE__, SDIO_D2_PIN)
#elif defined(BOARD_SDIO_D2)
  REPORT_NAME_DIGITAL(__LINE__, BOARD_SDIO_D2)
#endif
#if PIN_EXISTS(SDIO_D3)
  REPORT_NAME_DIGITAL(__LINE__, SDIO_D3_PIN)
#elif defined(BOARD_SDIO_D3)
  REPORT_NAME_DIGITAL(__LINE__, BOARD_SDIO_D3)
#endif
#if PIN_EXISTS(SDIO_CK)
  REPORT_NAME_DIGITAL(__LINE__, SDIO_CK_PIN)
#elif defined(BOARD_SDIO_CLK)
  REPORT_NAME_DIGITAL(__LINE__, BOARD_SDIO_CLK)
#endif
#if PIN_EXISTS(SDIO_CMD)
  REPORT_NAME_DIGITAL(__LINE__, SDIO_CMD_PIN)
#elif defined(BOARD_SDIO_CMD)
  REPORT_NAME_DIGITAL(__LINE__, BOARD_SDIO_CMD)
#endif
#if defined(BOARD_SDIO_DET)
  REPORT_NAME_DIGITAL(__LINE__, BOARD_SDIO_DET)
#endif
