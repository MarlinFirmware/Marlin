...
#endif
#if PIN_EXISTS(FAN10)
  REPORT_NAME_DIGITAL(__LINE__, FAN10_PIN)
#endif
#if PIN_EXISTS(FAN11)
  REPORT_NAME_DIGITAL(__LINE__, FAN11_PIN)
#endif

// Part Cooling Fan Pins (may be remapped from hardware FAN pins)
#if PIN_EXISTS(PART_COOLING_FAN0)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN0_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN1)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN1_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN2)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN2_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN3)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN3_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN4)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN4_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN5)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN5_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN6)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN6_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN7)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN7_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN8)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN8_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN9)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN9_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN10)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN10_PIN)
#endif
#if PIN_EXISTS(PART_COOLING_FAN11)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN11_PIN)
#endif
...
#endif
#if PIN_EXISTS(PART_COOLING_FAN)
  REPORT_NAME_DIGITAL(__LINE__, PART_COOLING_FAN_PIN)
#endif
