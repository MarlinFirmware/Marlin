...
#elif HOTENDS > 9 || E_STEPPERS > 9
  #error "STM32H7 supports up to 9 hotends / E-steppers."
#endif

#define DEFAULT_MACHINE_NAME "STM32H743ZI"
#ifndef BOARD_NAME
  #define BOARD_NAME         "NUCLEO_H743ZI"
#endif

//#define I2C_EEPROM

//#define E2END 0xFFF // EEPROM end address (4kB) //Is defined in stmduino framework
...
//
//#warning "Needs to be changed just to get something compiled!!"
