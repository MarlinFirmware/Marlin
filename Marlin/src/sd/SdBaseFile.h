...
class SdBaseFile {
 ...
 private:
  ...
  bool mkdir(SdBaseFile *parent, const uint8_t dname[11], const uint8_t dlname[LONG_FILENAME_LENGTH]);
  bool open(SdBaseFile *dirFile, const uint8_t dname[11], const uint8_t dlname[LONG_FILENAME_LENGTH], uint8_t oflag);
