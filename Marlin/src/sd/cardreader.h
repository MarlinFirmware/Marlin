...
public:
  ...
  static void ls(bool includeLongNames);
...
private:
  ...
  static void printListing(SdFile parent, bool includeLongNames, const char * const prepend=nullptr, const char * const prependLong=nullptr);
