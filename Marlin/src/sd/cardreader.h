...
public:
  ...
  static MarlinFile getroot() { return root; }
   ...
   *   inDirPtr: On exit your pointer points to the target MarlinFile.
   ...
   */
  static const char* diveToFile(const bool update_cwd, MarlinFile* &inDirPtr, const char * const path, const bool echo=false);
  ...
  static MarlinFile& getWorkDir()    { return workDir.isOpen() ? workDir : root; }
...
private:
  ...
  static int countItems(MarlinFile dir);
  static void selectByIndex(MarlinFile dir, const uint8_t index);
