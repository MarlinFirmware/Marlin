...
struct vector_3 {
  ...
  vector_3(const xy_float_t   &in) { IF_ENABLED(HAS_X_AXIS, x = in.x); IF_ENABLED(HAS_Y_AXIS, y = in.y); }
  vector_3(const xyz_float_t  &in) { IF_ENABLED(HAS_X_AXIS, x = in.x); IF_ENABLED(HAS_Y_AXIS, y = in.y); IF_ENABLED(HAS_Z_AXIS, z = in.z); }
  vector_3(const xyze_float_t &in) { IF_ENABLED(HAS_X_AXIS, x = in.x); IF_ENABLED(HAS_Y_AXIS, y = in.y); IF_ENABLED(HAS_Z_AXIS, z = in.z); }
  vector_3() { x = y = z = 0; }
  ...
  operator xy_float_t() { return xy_float_t({ IF_ENABLED(HAS_X_AXIS, x) OPTARG(HAS_Y_AXIS, y) }); }
  operator xyz_float_t() { return xyz_float_t({ IF_ENABLED(HAS_X_AXIS, x) OPTARG(HAS_Y_AXIS, y) OPTARG(HAS_Z_AXIS, z) }); }
