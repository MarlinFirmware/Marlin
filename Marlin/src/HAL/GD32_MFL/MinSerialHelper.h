...
// Register access styled after the MFL framework
...
inline constexpr uint32_t BIT_DEF(uint32_t start, uint32_t end) {
...
inline volatile uint32_t* reg_address(USART_Min_Regs reg) const {
