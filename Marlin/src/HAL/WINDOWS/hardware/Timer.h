...
public:
  ...
  static void handler(HWND Arg1, UINT Arg2, UINT_PTR Arg3, DWORD Arg4) {
    Timer* _this = (Timer*)Timer::_timers[Arg3];
    ...
    _this->cbfn();
    _this->overruns += 0; // even at 50Khz this doesn't stay zero, again demonstrating the limitations
  }
...
private:
  ...
  static std::map<uint32_t, Timer*> _timers;
};
