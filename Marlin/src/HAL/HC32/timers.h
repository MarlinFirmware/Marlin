 ...
 * assumption of a 200MHz clock, defining F_HCLK as 200000000, then configure PCLK1
 * as F_HCLK with a divider of 4 in 'sysclock.cpp::core_hook_sysclock_init'.
 *
 ...
 */
#define HAL_TIMER_RATE (F_HCLK / 4)
