...
// --------------------------------------------------------------------------
  ...
  void spiBegin() {  // setup SCK, MOSI & MISO pins for SSP0
    ...
    PinCfg.OpenDrain = 0;
    PinCfg.Pinmode = 0;
    PinCfg.Pinnum = LPC1768_PIN_PIN(BOARD_SPI1_SCK_PIN);
    PinCfg.Portnum = LPC1768_PIN_PORT(BOARD_SPI1_SCK_PIN);
    PINSEL_ConfigPin(&PinCfg);
    SET_OUTPUT(BOARD_SPI1_SCK_PIN);

    PinCfg.Pinnum = LPC1768_PIN_PIN(BOARD_SPI1_MISO_PIN);
    PinCfg.Portnum = LPC1768_PIN_PORT(BOARD_SPI1_MISO_PIN);
    PINSEL_ConfigPin(&PinCfg);
    SET_INPUT(BOARD_SPI1_MISO_PIN);

    PinCfg.Pinnum = LPC1768_PIN_PIN(BOARD_SPI1_MOSI_PIN);
    PinCfg.Portnum = LPC1768_PIN_PORT(BOARD_SPI1_MOSI_PIN);
    PINSEL_ConfigPin(&PinCfg);
