...
#define TEMP_BOARD_PIN ATEMP
    ...
    */
    #define TS_TYPICAL_V 2.5
    #define TS_TYPICAL_TEMP 25
    #define TS_TYPICAL_SLOPE 0.76
    ...
    */
    ...
    STM32F412xE/G                                       https://www.st.com/resource/en/datasheet/stm32f412ce.pdf
    STM32F410x8/B                                       https://www.st.com/resource/en/datasheet/stm32f410cb.pdf
    ...
    STM32F413xG/H                                       https://www.st.com/resource/en/datasheet/stm32f413cg.pdf
    ...
    */
    ...
    STM32H7A/B :
    #define TS_CAL1_TEMP 30
    #define TS_CAL1_REGOFFSET 0x08FFF814
    #define TS_CAL2_TEMP 130   
    #define TS_CAL2_REGOFFSET 0x08FFF818 
    */
    #define TS_CAL1_TEMP 30
    ...
    /*
    STM32L011x3/4               --> TS_CAL1 not defined in datasheet
    STM32L021x4                 --> TS_CAL1 not defined in datasheet
    STM32L010RB                 --> TS_CAL1/TS_CAL2 not defined in datasheet
    STM32L010F4/K4              --> TS_CAL1/TS_CAL2 not defined in datasheet
    STM32L010C6                 --> TS_CAL1/TS_CAL2 not defined in datasheet
    STM32L010K8 STM32L010R8     --> TS_CAL1/TS_CAL2 not defined in datasheet
    */
    #define TS_CAL1_TEMP 30
    ...
    /*
    STM32L100x6/8/B-A           --> TS_CAL1/TS_CAL2 not defined in datasheet
    STM32L100C6 STM32L100R8/RB  --> TS_CAL1/TS_CAL2 not defined in datasheet
    STM32L100RC                 --> TS_CAL1/TS_CAL2 not defined in datasheet
 ...
 */
    ...
    #define TEMP_INTERNAL_SENSOR(RAW) ( ((TS_CAL2_TEMP) - (TS_CAL1_TEMP)) / (READMEMORY(TS_CAL2_REGOFFSET)-READMEMORY(TS_CAL1_REGOFFSET)) * ((RAW) - READMEMORY(TS_CAL1_REGOFFSET)) + (TS_CAL1_TEMP))

#elif defined(TS_TYPICAL_V) && defined(TS_TYPICAL_SLOPE) && defined(TS_TYPICAL_TEMP)

    #define TEMP_INTERNAL_SENSOR(RAW) ( (TS_TYPICAL_V - (RAW) / float(OVERSAMPLENR) / float(HAL_ADC_RANGE) * float(ADC_VREF)) / (TS_TYPICAL_SLOPE/1000) + TS_TYPICAL_TEMP )
