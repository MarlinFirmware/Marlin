...
#include "../../core/serial_hook.h"
  ...
  typedef Serial1Type< MarlinSerial< MarlinSerialCfg<SERIAL_PORT> > > MSerialT;
  extern MSerialT customizedSerial1;

  #ifdef SERIAL_PORT_2
    typedef Serial1Type< MarlinSerial< MarlinSerialCfg<SERIAL_PORT_2> > > MSerialT2;
  ...
  typedef Serial1Type< MarlinSerial< MMU2SerialCfg<MMU2_SERIAL_PORT> > > MSerialT3;
  ...
  typedef Serial1Type< MarlinSerial< LCDSerialCfg<LCD_SERIAL_PORT> > > MSerialT4;
  extern MSerialT4 lcdSerial;
#endif

// Use the UART for Bluetooth in AT90USB configurations
#if defined(USBCON) && ENABLED(BLUETOOTH)
  typedef Serial1Type<HardwareSerial> MSerialT5;
