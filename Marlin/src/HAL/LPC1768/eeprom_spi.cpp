...
static void spi_eeprom_write_byte(uint8_t *pos, unsigned char value) {
...
static uint8_t spi_eeprom_read_byte(uint8_t *pos) {
...
bool PersistentStore::read_data(int &pos, uint8_t* value, size_t size, uint16_t *crc, const bool writing/*=true*/) {
  do {
    ...
    const uint8_t c = spi_eeprom_read_byte((uint8_t*)pos);
