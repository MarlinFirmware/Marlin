...
#define MSG_E0STEPS                         _UxGT(LCD_STR_E0 " стъпки/mm")
#define MSG_E1STEPS                         _UxGT(LCD_STR_E1 " стъпки/mm")
#define MSG_E2STEPS                         _UxGT(LCD_STR_E2 " стъпки/mm")
#define MSG_E3STEPS                         _UxGT(LCD_STR_E3 " стъпки/mm")
#define MSG_E4STEPS                         _UxGT(LCD_STR_E4 " стъпки/mm")
#define MSG_E5STEPS                         _UxGT(LCD_STR_E5 " стъпки/mm")
