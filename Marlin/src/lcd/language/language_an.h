...
namespace Language_an {
  ...
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("Establir orichen");
    ...
    PROGMEM Language_Str MSG_PREHEAT_3                       = _UxGT("Precalentar ") PREHEAT_3_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_3_H                     = _UxGT("Precalentar ") PREHEAT_3_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_3_END                   = _UxGT("Precal. ") PREHEAT_3_LABEL _UxGT(" Boquilla");
    PROGMEM Language_Str MSG_PREHEAT_3_END_E                 = _UxGT("Precal. ") PREHEAT_3_LABEL _UxGT(" Boquilla ~");
    PROGMEM Language_Str MSG_PREHEAT_3_ALL                   = _UxGT("Precalentar ") PREHEAT_3_LABEL _UxGT(" Tot");
    PROGMEM Language_Str MSG_PREHEAT_3_BEDONLY               = _UxGT("Precalentar ") PREHEAT_3_LABEL _UxGT(" Base");
    PROGMEM Language_Str MSG_PREHEAT_3_SETTINGS              = _UxGT("Precalentar ") PREHEAT_3_LABEL _UxGT(" Conf");
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_PREHEAT_4                       = _UxGT("Precalentar ") PREHEAT_4_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_4_H                     = _UxGT("Precalentar ") PREHEAT_4_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_4_END                   = _UxGT("Precal. ") PREHEAT_4_LABEL _UxGT(" Boquilla");
    PROGMEM Language_Str MSG_PREHEAT_4_END_E                 = _UxGT("Precal. ") PREHEAT_4_LABEL _UxGT(" Boquilla ~");
    PROGMEM Language_Str MSG_PREHEAT_4_ALL                   = _UxGT("Precalentar ") PREHEAT_4_LABEL _UxGT(" Tot");
    PROGMEM Language_Str MSG_PREHEAT_4_BEDONLY               = _UxGT("Precalentar ") PREHEAT_4_LABEL _UxGT(" Base");
    PROGMEM Language_Str MSG_PREHEAT_4_SETTINGS              = _UxGT("Precalentar ") PREHEAT_4_LABEL _UxGT(" Conf");
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_PREHEAT_5                       = _UxGT("Precalentar ") PREHEAT_5_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_5_H                     = _UxGT("Precalentar ") PREHEAT_5_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_5_END                   = _UxGT("Precal. ") PREHEAT_5_LABEL _UxGT(" Boquilla");
    PROGMEM Language_Str MSG_PREHEAT_5_END_E                 = _UxGT("Precal. ") PREHEAT_5_LABEL _UxGT(" Boquilla ~");
    PROGMEM Language_Str MSG_PREHEAT_5_ALL                   = _UxGT("Precalentar ") PREHEAT_5_LABEL _UxGT(" Tot");
    PROGMEM Language_Str MSG_PREHEAT_5_BEDONLY               = _UxGT("Precalentar ") PREHEAT_5_LABEL _UxGT(" Base");
    PROGMEM Language_Str MSG_PREHEAT_5_SETTINGS              = _UxGT("Precalentar ") PREHEAT_5_LABEL _UxGT(" Conf");
  #endif
