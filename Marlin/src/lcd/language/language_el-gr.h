...
#define MSG_E0STEPS                         _UxGT("Bήματα " LCD_STR_E0 " ανά μμ")
#define MSG_E1STEPS                         _UxGT("Bήματα " LCD_STR_E1 " ανά μμ")
#define MSG_E2STEPS                         _UxGT("Bήματα " LCD_STR_E2 " ανά μμ")
#define MSG_E3STEPS                         _UxGT("Bήματα " LCD_STR_E3 " ανά μμ")
#define MSG_E4STEPS                         _UxGT("Bήματα " LCD_STR_E4 " ανά μμ")
#define MSG_E5STEPS                         _UxGT("Bήματα " LCD_STR_E5 " ανά μμ")
