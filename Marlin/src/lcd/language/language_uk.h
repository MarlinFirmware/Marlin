...
namespace LanguageNarrow_uk {
  ...
  LSTR MSG_CONTROL_RECOVER                  = _UxGT("Поверн., мм");
  LSTR MSG_CONTROL_RECOVER_SWAP             = _UxGT("Повер.зміни,мм");
  ...
  LSTR MSG_CONTROL_RECOVERF                 = _UxGT("Повернення V");
  LSTR MSG_CONTROL_RECOVER_SWAPF            = _UxGT("Поверн.зміни V");
...
namespace LanguageWide_uk {
  using namespace LanguageNarrow_uk;
    ...
    LSTR MSG_CONTROL_RECOVER                = _UxGT("Повернення, мм");
    LSTR MSG_CONTROL_RECOVER_SWAP           = _UxGT("Поверн.зміни, мм");
