...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_SINGLENOZZLE_UNRETRACT_SPD      = _UxGT("Recover Speed");
  PROGMEM Language_Str MSG_SINGLENOZZLE_FAN_SPD            = _UxGT("Fan Speed");
  ...
  PROGMEM Language_Str MSG_TOOL_MIGRATION_SWAP2            = _UxGT("Migrate to ") LCD_STR_E2;
