...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_MANLEV_FC                       = _UxGT("Front Center");
  PROGMEM Language_Str MSG_MANLEV_FR                       = _UxGT("Front Right"); 
  PROGMEM Language_Str MSG_MANLEV_CL                       = _UxGT("Center Left");
  PROGMEM Language_Str MSG_MANLEV_C                        = _UxGT("Center");
  PROGMEM Language_Str MSG_MANLEV_CR                       = _UxGT("Center Right"); 
  PROGMEM Language_Str MSG_MANLEV_BL                       = _UxGT("Back Left");
  PROGMEM Language_Str MSG_MANLEV_BC                       = _UxGT("Back Center");
