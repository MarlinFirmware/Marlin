...
namespace Language_fr_na {
  ...
  LSTR MSG_AUTOSTART                       = _UxGT("Exec. auto.gcode");
  ...
  LSTR MSG_SET_ORIGIN                      = _UxGT("Regler origine");
  #if PREHEAT_COUNT
  ...
  LSTR MSG_LEVEL_CORNERS                   = _UxGT("Niveau des coins");
  ...
  LSTR MSG_PROBING_MESH                    = _UxGT("Mesure point");
  LSTR MSG_MESH_X                          = _UxGT("Index X");
  LSTR MSG_MESH_Y                          = _UxGT("Index Y");
  LSTR MSG_MESH_EDIT_Z                     = _UxGT("Valeur Z");
  LSTR MSG_USER_MENU                       = _UxGT("Commandes perso");
  ...
  LSTR MSG_MOVE_E                          = _UxGT("Extrudeur");
  LSTR MSG_MOVE_EN                         = _UxGT("Extrudeur *");
  LSTR MSG_HOTEND_TOO_COLD                 = _UxGT("Buse trop froide");
  LSTR MSG_MOVE_Z_DIST                     = _UxGT("Deplacer %smm");
  ...
  LSTR MSG_SELECT                          = _UxGT("Selectionner");
  ...
  LSTR MSG_VELOCITY                        = _UxGT("Velocite");
  ...
  LSTR MSG_VOLUMETRIC_ENABLED              = _UxGT("E en mm³");
  LSTR MSG_VOLUMETRIC_LIMIT                = _UxGT("Limite en mm³");
  ...
  LSTR MSG_CONTROL_RETRACTF                = _UxGT("Vit. retract°");
  ...
  LSTR MSG_SINGLENOZZLE_RETRACT_SPEED      = _UxGT("Vitesse retract°");
