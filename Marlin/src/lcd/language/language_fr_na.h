...
namespace Language_fr_na {
  ...
  PROGMEM Language_Str MSG_VA_JERK                         = _UxGT("V") STR_A _UxGT(" jerk");
  PROGMEM Language_Str MSG_VB_JERK                         = _UxGT("V") STR_B _UxGT(" jerk");
  PROGMEM Language_Str MSG_VC_JERK                         = _UxGT("V") STR_C _UxGT(" jerk");
  ...
  PROGMEM Language_Str MSG_A_STEPS                         = STR_A _UxGT(" pas/mm");
  PROGMEM Language_Str MSG_B_STEPS                         = STR_B _UxGT(" pas/mm");
  PROGMEM Language_Str MSG_C_STEPS                         = STR_C _UxGT(" pas/mm");
