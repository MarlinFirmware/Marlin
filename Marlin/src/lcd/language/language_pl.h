...
#define MSG_E0STEPS                         _UxGT("kroki" LCD_STR_E0 "/mm")
#define MSG_E1STEPS                         _UxGT("kroki" LCD_STR_E1 "/mm")
#define MSG_E2STEPS                         _UxGT("kroki" LCD_STR_E2 "/mm")
#define MSG_E3STEPS                         _UxGT("kroki" LCD_STR_E3 "/mm")
#define MSG_E4STEPS                         _UxGT("kroki" LCD_STR_E4 "/mm")
#define MSG_E5STEPS                         _UxGT("kroki" LCD_STR_E5 "/mm")
