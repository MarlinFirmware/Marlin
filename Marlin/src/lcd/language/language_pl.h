...
namespace Language_pl {
  ...
  PROGMEM Language_Str MSG_MMU2_LOAD_FILAMENT              = _UxGT("Włóż filament");
  PROGMEM Language_Str MSG_MMU2_LOAD_ALL                   = _UxGT("Włóż wszystko");
  PROGMEM Language_Str MSG_MMU2_LOAD_TO_NOZZLE             = _UxGT("Włóż do dyszy");
