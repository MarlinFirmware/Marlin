...
#define MSG_ADVANCED_SETTINGS               _UxGT("Configuración avanzada")
...
#define MSG_PROGRESS_BAR_TEST               _UxGT("Probar barra de progreso")
...
#define MSG_PREHEAT_CUSTOM                  _UxGT("Precalentamiento Personalizado")
...
#define MSG_SPINDLE_POWER                   _UxGT("Potencia del Mandrino")
#define MSG_SPINDLE_REVERSE                 _UxGT("Revertir giro del Mandrino")
...
#define MSG_USER_MENU                       _UxGT("Comandos Personalizados")
...
#define MSG_UBL_LEVEL_BED                   _UxGT("Nivelado de Cama Unificado (UBL)")
#define MSG_LCD_TILTING_MESH                _UxGT("Punto de inclinación")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Construir Mallado manualmente")
...
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Editar Mallado personalizado")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("Ajuste fino del Mallado")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Terminar la edición del Mallado")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Crear Mallado Personalizada")
...
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Crear Mallado en Frio")
#define MSG_UBL_MESH_HEIGHT_ADJUST          _UxGT("Ajustar altura del Mallado")
...
#define MSG_UBL_VALIDATE_CUSTOM_MESH        _UxGT("Validar Mallado personalizado")
...
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("Nivelando en 3 Puntos")
...
#define MSG_UBL_OUTPUT_MAP                  _UxGT("Salida Mapa de mallado")
...
#define MSG_UBL_INFO_UBL                    _UxGT("Salida Información de UBL")
...
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Ajustar Fino proximos")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Almacen de Mallado")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Huecos de memoria")
#define MSG_UBL_LOAD_MESH                   _UxGT("Cargar Mallado de cama")
#define MSG_UBL_SAVE_MESH                   _UxGT("Guardar Mallado de cama")
...
#define MSG_INTENSITY_W                     _UxGT("Intensidad del Blanco")
...
#define MSG_EXTRA_FAN_SPEED                 _UxGT("Vel. Extra del ventilador")
...
#define MSG_STORE_EEPROM                    _UxGT("Guardar configuración")
#define MSG_LOAD_EEPROM                     _UxGT("Cargar configuración")
#define MSG_RESTORE_FAILSAFE                _UxGT("Restaurar a prueba de fallos")
...
#define MSG_WATCH                           _UxGT("Pantalla de Información")
...
#define MSG_OUTAGE_RECOVERY                 _UxGT("Recuperación por interrupción")
#define MSG_MEDIA_MENU                      _UxGT("Imprimir desde SD/USB")
...
#define MSG_SINGLENOZZLE_RETRACT_SPD        _UxGT("Velocidad de retracción")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Calentamiento fallido")
...
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("Error: TEMP. REDUNDANTE")
...
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Error: TEMP. MÁX CAMA")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Error: TEMP. MIN CAMA")
#define MSG_ERR_MAXTEMP_CHAMBER             _UxGT("Error: TEMP. MÁX CÁMARA")
#define MSG_ERR_MINTEMP_CHAMBER             _UxGT("Error: TEMP. MIN CÁMARA")
...
#define MSG_INFO_MENU                       _UxGT("Acerca de la Impresora")
#define MSG_INFO_PRINTER_MENU               _UxGT("Info. Impresora")
#define MSG_3POINT_LEVELING                 _UxGT("Nivelando en 3 puntos")
#define MSG_LINEAR_LEVELING                 _UxGT("Nivelando en Lineal")
#define MSG_BILINEAR_LEVELING               _UxGT("Nivelando en Bilineal")
#define MSG_UBL_LEVELING                    _UxGT("Nivelando en Cama Unificado (UBL)")
...
#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Contador de impresión")
...
#define MSG_INFO_PSU                        _UxGT("Fuente de alimentación")
...
#define MSG_MMU2_WRONG_FIRMWARE             _UxGT("¡Actualiza el MMU Firmware!")
...
#define MSG_MMU2_LOAD_TO_NOZZLE             _UxGT("Cargar hasta la boquilla")
...
#define MSG_VTOOLS_RESET                    _UxGT("Herr. V fueron reiniciados")
...
#define MSG_MAZE                            _UxGT("Maze")
  ...
  #define MSG_ADVANCED_PAUSE_WAITING_2      _UxGT("para reanudar la impresión")
  ...
  #define MSG_FILAMENT_CHANGE_HEAT_2        _UxGT("para calentar la boquilla")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("descargar el filamento")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1      _UxGT("Espere para")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("expulsar el filamento")
  ...
  #define MSG_FILAMENT_CHANGE_CONT_PURGE_2  _UxGT("el purgado del filamento")
...
#define MSG_TMC_CURRENT                     _UxGT("Corriente Controlador")
...
#define MSG_TMC_STEALTH_ENABLED             _UxGT("StealthChop Habilitado")
