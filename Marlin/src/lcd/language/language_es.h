...
#define MSG_ADVANCED_SETTINGS               _UxGT("Configuración avanza|da")
...
#define MSG_PROGRESS_BAR_TEST               _UxGT("Probar barra de prog|reso")
...
#define MSG_PREHEAT_CUSTOM                  _UxGT("Precalentamiento Per|sonalizado")
#define MSG_COOLDOWN                        _UxGT("Enfriar")
#define MSG_LASER_MENU                      _UxGT("Control del Láser")
...
#define MSG_SPINDLE_MENU                    _UxGT("Control del Mandrino")
#define MSG_SPINDLE_OFF                     _UxGT("Mandrino Apagado")
#define MSG_SPINDLE_ON                      _UxGT("Mandrino Encendido")
#define MSG_SPINDLE_POWER                   _UxGT("Potencia del Mandrin|o")
#define MSG_SPINDLE_REVERSE                 _UxGT("Revertir giro del Ma|ndrino")
...
#define MSG_EDITING_STOPPED                 _UxGT("Edición del Mallado |parada")
...
#define MSG_USER_MENU                       _UxGT("Comandos Personaliza|dos")
...
#define MSG_UBL_LEVEL_BED                   _UxGT("Nivelado de Cama Uni|ficado (UBL)")
#define MSG_LCD_TILTING_MESH                _UxGT("Punto de inclinación")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Construir Mallado ma|nualmente")
...
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Editar Mallado perso|nalizado")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("Ajuste fino del Mall|ado")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Terminar la edición |del Mallado")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Crear Mallado Person|alizada")
...
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Crear Mallado en Fri|o")
#define MSG_UBL_MESH_HEIGHT_ADJUST          _UxGT("Ajustar altura del M|allado")
...
#define MSG_UBL_VALIDATE_CUSTOM_MESH        _UxGT("Validar Mallado pers|onalizado")
#define MSG_UBL_CONTINUE_MESH               _UxGT("Continuar el Mallado| de la cama")
#define MSG_UBL_MESH_LEVELING               _UxGT("Nivelando en Mallado")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("Nivelando en 3 Punto|s")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Nivelando en Mallado| en cuadricula")
...
#define MSG_UBL_OUTPUT_MAP                  _UxGT("Salida Mapa de malla|do")
...
#define MSG_UBL_INFO_UBL                    _UxGT("Salida Información d|e UBL")
...
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Ajustar Fino proximo|s")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Almacen de Mallado")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Huecos de memoria")
#define MSG_UBL_LOAD_MESH                   _UxGT("Cargar Mallado de ca|ma")
#define MSG_UBL_SAVE_MESH                   _UxGT("Guardar Mallado de c|ama")
...
#define MSG_INTENSITY_R                     _UxGT("Intensidad del Rojo")
#define MSG_INTENSITY_G                     _UxGT("Intensidad del Verde")
#define MSG_INTENSITY_B                     _UxGT("Intensidad del Azul")
#define MSG_INTENSITY_W                     _UxGT("Intensidad del Blanc|o")
...
#define MSG_EXTRA_FAN_SPEED                 _UxGT("Vel. Extra del venti|lador")
...
#define MSG_STORE_EEPROM                    _UxGT("Guardar configuració|n")
#define MSG_LOAD_EEPROM                     _UxGT("Cargar configuración")
#define MSG_RESTORE_FAILSAFE                _UxGT("Restaurar a prueba d|e fallos")
...
#define MSG_WATCH                           _UxGT("Pantalla de Informac|ión")
...
#define MSG_BUTTON_DONE                     _UxGT("Hecho")
...
#define MSG_OUTAGE_RECOVERY                 _UxGT("Recuperación por int|errupción")
#define MSG_MEDIA_MENU                      _UxGT("Imprimir desde SD/US|B")
...
#define MSG_SINGLENOZZLE_RETRACT_SPD        _UxGT("Velocidad de retracc|ión")
...
#define MSG_ZPROBE_OUT                      _UxGT("Sonda Z fuera de la |cama")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Calentamiento fallid|o")
#define MSG_HEATING_FAILED_LCD_BED          _UxGT("Calentamiento de la |cama fallido")
#define MSG_HEATING_FAILED_LCD_CHAMBER      _UxGT("Calentamiento de la |Cámara fallido")
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("Error: TEMP. REDUNDA|NTE")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Error: TEMP. MÁX")
#define MSG_ERR_MINTEMP                     _UxGT("Error: TEMP. MIN")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Error: TEMP. MÁX CAM|A")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Error: TEMP. MIN CAM|A")
#define MSG_ERR_MAXTEMP_CHAMBER             _UxGT("Error: TEMP. MÁX CÁM|ARA")
#define MSG_ERR_MINTEMP_CHAMBER             _UxGT("Error: TEMP. MIN CÁM|ARA")
...
#define MSG_INFO_MENU                       _UxGT("Acerca de la Impreso|ra")
#define MSG_INFO_PRINTER_MENU               _UxGT("Info. Impresora")
#define MSG_3POINT_LEVELING                 _UxGT("Nivelando en 3 punto|s")
#define MSG_LINEAR_LEVELING                 _UxGT("Nivelando en Lineal")
#define MSG_BILINEAR_LEVELING               _UxGT("Nivelando en Bilinea|l")
#define MSG_UBL_LEVELING                    _UxGT("Nivelando en Cama Un|ificado (UBL)")
...
#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Contador de impresió|n")
...
#define MSG_INFO_PSU                        _UxGT("Fuente de alimentaci|ón")
...
#define MSG_MMU2_WRONG_FIRMWARE             _UxGT("¡Actualiza el MMU Fi|rmware!")
...
#define MSG_MMU2_LOAD_TO_NOZZLE             _UxGT("Cargar hasta la boqu|illa")
...
#define MSG_COMMIT_VTOOL                    _UxGT("Cometer mezcla Herr.| V")
#define MSG_VTOOLS_RESET                    _UxGT("Herr. V fueron reini|ciados")
...
#define MSG_MAZE                            _UxGT("Maze")
...
#if LCD_HEIGHT >= 4
  #define MSG_ADVANCED_PAUSE_WAITING_1      _UxGT("Pulsar el botón")
  #define MSG_ADVANCED_PAUSE_WAITING_2      _UxGT("para reanudar la imp|resión")
  ...
  #define MSG_FILAMENT_CHANGE_HEAT_1        _UxGT("Pulse el botón")
  #define MSG_FILAMENT_CHANGE_HEAT_2        _UxGT("para calentar la boq|uilla")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("descargar el filamen|to")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1      _UxGT("Espere para")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("expulsar el filament|o")
  ...
  #define MSG_FILAMENT_CHANGE_CONT_PURGE_2  _UxGT("el purgado del filam|ento")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_1      _UxGT("Expulsando...")
...
#define MSG_TMC_CURRENT                     _UxGT("Corriente Controlado|r")
...
#define MSG_TMC_STEALTH_ENABLED             _UxGT("StealthChop Habilita|do")
