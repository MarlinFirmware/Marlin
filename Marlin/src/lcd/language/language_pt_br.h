...
namespace LanguageNarrow_pt_br {
  ...
  LSTR MSG_ATTACH_MEDIA                   = _UxGT("Iniciar mídia");                            // Attach (MEDIA_TYPE_EN)
  LSTR MSG_ATTACH_SD                      = _UxGT("Iniciar cartão SD");                        // Attach SD Card
  LSTR MSG_ATTACH_USB                     = _UxGT("Iniciar flash USB");                        // Attach USB Drive
  LSTR MSG_CHANGE_MEDIA                   = _UxGT("Trocar mídia");                             // Refresh (MEDIA_TYPE_EN)
  LSTR MSG_CHANGE_SD                      = _UxGT("Trocar cartão SD");
  LSTR MSG_CHANGE_USB                     = _UxGT("Trocar flash USB");
  LSTR MSG_RUN_AUTOFILES                  = _UxGT("Início automático");
  LSTR MSG_RELEASE_MEDIA                  = _UxGT("Ejetar mídia");
  LSTR MSG_RELEASE_SD                     = _UxGT("Ejetar cartão SD");
  LSTR MSG_RELEASE_USB                    = _UxGT("Ejetar flash USB");
