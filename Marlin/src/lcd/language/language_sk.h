...
namespace Language_sk {
  ...
  #endif
  #ifdef PREHEAT_2_LABEL
    PROGMEM Language_Str MSG_PREHEAT_3                       = _UxGT("Zahriať ") PREHEAT_3_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_3_H                     = _UxGT("Zahriať ") PREHEAT_3_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_3_END                   = _UxGT("Zahriať ") PREHEAT_3_LABEL _UxGT(" hotend");
    PROGMEM Language_Str MSG_PREHEAT_3_END_E                 = _UxGT("Zahriať ") PREHEAT_3_LABEL _UxGT(" hotend ~");
    PROGMEM Language_Str MSG_PREHEAT_3_ALL                   = _UxGT("Zahriať ") PREHEAT_3_LABEL _UxGT(" všetko");
    PROGMEM Language_Str MSG_PREHEAT_3_BEDONLY               = _UxGT("Zahriať ") PREHEAT_3_LABEL _UxGT(" podlož");
    PROGMEM Language_Str MSG_PREHEAT_3_SETTINGS              = _UxGT("Zahriať ") PREHEAT_3_LABEL _UxGT(" nast.");
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_PREHEAT_4                       = _UxGT("Zahriať ") PREHEAT_4_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_4_H                     = _UxGT("Zahriať ") PREHEAT_4_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_4_END                   = _UxGT("Zahriať ") PREHEAT_4_LABEL _UxGT(" hotend");
    PROGMEM Language_Str MSG_PREHEAT_4_END_E                 = _UxGT("Zahriať ") PREHEAT_4_LABEL _UxGT(" hotend ~");
    PROGMEM Language_Str MSG_PREHEAT_4_ALL                   = _UxGT("Zahriať ") PREHEAT_4_LABEL _UxGT(" všetko");
    PROGMEM Language_Str MSG_PREHEAT_4_BEDONLY               = _UxGT("Zahriať ") PREHEAT_4_LABEL _UxGT(" podlož");
    PROGMEM Language_Str MSG_PREHEAT_4_SETTINGS              = _UxGT("Zahriať ") PREHEAT_4_LABEL _UxGT(" nast.");
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_PREHEAT_5                       = _UxGT("Zahriať ") PREHEAT_5_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_5_H                     = _UxGT("Zahriať ") PREHEAT_5_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_5_END                   = _UxGT("Zahriať ") PREHEAT_5_LABEL _UxGT(" hotend");
    PROGMEM Language_Str MSG_PREHEAT_5_END_E                 = _UxGT("Zahriať ") PREHEAT_5_LABEL _UxGT(" hotend ~");
    PROGMEM Language_Str MSG_PREHEAT_5_ALL                   = _UxGT("Zahriať ") PREHEAT_5_LABEL _UxGT(" všetko");
    PROGMEM Language_Str MSG_PREHEAT_5_BEDONLY               = _UxGT("Zahriať ") PREHEAT_5_LABEL _UxGT(" podlož");
    PROGMEM Language_Str MSG_PREHEAT_5_SETTINGS              = _UxGT("Zahriať ") PREHEAT_5_LABEL _UxGT(" nast.");
  #endif
