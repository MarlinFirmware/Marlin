...
namespace Language_zh_CN {
  ...
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("设置原点");     //"Set origin"
    ...
    PROGMEM Language_Str MSG_PREHEAT_3                       = _UxGT("预热 ") PREHEAT_3_LABEL;     //"Preheat PREHEAT_3_LABEL"
    PROGMEM Language_Str MSG_PREHEAT_3_H                     = _UxGT("预热 ") PREHEAT_3_LABEL " ~";     //"Preheat PREHEAT_3_LABEL"
    PROGMEM Language_Str MSG_PREHEAT_3_END                   = _UxGT("预热 ") PREHEAT_3_LABEL _UxGT(" 喷嘴");     //MSG_PREHEAT_3 " "
    PROGMEM Language_Str MSG_PREHEAT_3_END_E                 = _UxGT("预热 ") PREHEAT_3_LABEL _UxGT(" 喷嘴 ~");     //MSG_PREHEAT_3 " "
    PROGMEM Language_Str MSG_PREHEAT_3_ALL                   = _UxGT("预热 ") PREHEAT_3_LABEL _UxGT(" 全部");     //MSG_PREHEAT_3 " All"
    PROGMEM Language_Str MSG_PREHEAT_3_BEDONLY               = _UxGT("预热 ") PREHEAT_3_LABEL _UxGT(" 热床");     //MSG_PREHEAT_3 " Bed"
    PROGMEM Language_Str MSG_PREHEAT_3_SETTINGS              = _UxGT("预热 ") PREHEAT_3_LABEL _UxGT(" 设置");     //MSG_PREHEAT_3 " conf"
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_PREHEAT_4                       = _UxGT("预热 ") PREHEAT_4_LABEL;     //"Preheat PREHEAT_4_LABEL"
    PROGMEM Language_Str MSG_PREHEAT_4_H                     = _UxGT("预热 ") PREHEAT_4_LABEL " ~";     //"Preheat PREHEAT_4_LABEL"
    PROGMEM Language_Str MSG_PREHEAT_4_END                   = _UxGT("预热 ") PREHEAT_4_LABEL _UxGT(" 喷嘴");     //MSG_PREHEAT_4 " "
    PROGMEM Language_Str MSG_PREHEAT_4_END_E                 = _UxGT("预热 ") PREHEAT_4_LABEL _UxGT(" 喷嘴 ~");     //MSG_PREHEAT_4 " "
    PROGMEM Language_Str MSG_PREHEAT_4_ALL                   = _UxGT("预热 ") PREHEAT_4_LABEL _UxGT(" 全部");     //MSG_PREHEAT_4 " All"
    PROGMEM Language_Str MSG_PREHEAT_4_BEDONLY               = _UxGT("预热 ") PREHEAT_4_LABEL _UxGT(" 热床");     //MSG_PREHEAT_4 " Bed"
    PROGMEM Language_Str MSG_PREHEAT_4_SETTINGS              = _UxGT("预热 ") PREHEAT_4_LABEL _UxGT(" 设置");     //MSG_PREHEAT_4 " conf"
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_PREHEAT_5                       = _UxGT("预热 ") PREHEAT_5_LABEL;     //"Preheat PREHEAT_5_LABEL"
    PROGMEM Language_Str MSG_PREHEAT_5_H                     = _UxGT("预热 ") PREHEAT_5_LABEL " ~";     //"Preheat PREHEAT_5_LABEL"
    PROGMEM Language_Str MSG_PREHEAT_5_END                   = _UxGT("预热 ") PREHEAT_5_LABEL _UxGT(" 喷嘴");     //MSG_PREHEAT_5 " "
    PROGMEM Language_Str MSG_PREHEAT_5_END_E                 = _UxGT("预热 ") PREHEAT_5_LABEL _UxGT(" 喷嘴 ~");     //MSG_PREHEAT_5 " "
    PROGMEM Language_Str MSG_PREHEAT_5_ALL                   = _UxGT("预热 ") PREHEAT_5_LABEL _UxGT(" 全部");     //MSG_PREHEAT_5 " All"
    PROGMEM Language_Str MSG_PREHEAT_5_BEDONLY               = _UxGT("预热 ") PREHEAT_5_LABEL _UxGT(" 热床");     //MSG_PREHEAT_5 " Bed"
    PROGMEM Language_Str MSG_PREHEAT_5_SETTINGS              = _UxGT("预热 ") PREHEAT_5_LABEL _UxGT(" 设置");     //MSG_PREHEAT_5 " conf"
  #endif
