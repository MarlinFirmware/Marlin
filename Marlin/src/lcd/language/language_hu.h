...
namespace Language_hu {
  ...
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("Eredeti Be");
    ...
    PROGMEM Language_Str MSG_PREHEAT_3                       = _UxGT("Fütés ") PREHEAT_3_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_3_H                     = _UxGT("Fütés ") PREHEAT_3_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_3_END                   = _UxGT("Fütés ") PREHEAT_3_LABEL _UxGT(" Fej");
    PROGMEM Language_Str MSG_PREHEAT_3_END_E                 = _UxGT("Fütés ") PREHEAT_3_LABEL _UxGT(" Fej ~");
    PROGMEM Language_Str MSG_PREHEAT_3_ALL                   = _UxGT("Fütés ") PREHEAT_3_LABEL _UxGT(" Mind");
    PROGMEM Language_Str MSG_PREHEAT_3_BEDONLY               = _UxGT("Fütés ") PREHEAT_3_LABEL _UxGT(" Ágy");
    PROGMEM Language_Str MSG_PREHEAT_3_SETTINGS              = _UxGT("Fütés ") PREHEAT_3_LABEL _UxGT(" Beáll");
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_PREHEAT_4                       = _UxGT("Fütés ") PREHEAT_4_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_4_H                     = _UxGT("Fütés ") PREHEAT_4_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_4_END                   = _UxGT("Fütés ") PREHEAT_4_LABEL _UxGT(" Fej");
    PROGMEM Language_Str MSG_PREHEAT_4_END_E                 = _UxGT("Fütés ") PREHEAT_4_LABEL _UxGT(" Fej ~");
    PROGMEM Language_Str MSG_PREHEAT_4_ALL                   = _UxGT("Fütés ") PREHEAT_4_LABEL _UxGT(" Mind");
    PROGMEM Language_Str MSG_PREHEAT_4_BEDONLY               = _UxGT("Fütés ") PREHEAT_4_LABEL _UxGT(" Ágy");
    PROGMEM Language_Str MSG_PREHEAT_4_SETTINGS              = _UxGT("Fütés ") PREHEAT_4_LABEL _UxGT(" Beáll");
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_PREHEAT_5                       = _UxGT("Fütés ") PREHEAT_5_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_5_H                     = _UxGT("Fütés ") PREHEAT_5_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_5_END                   = _UxGT("Fütés ") PREHEAT_5_LABEL _UxGT(" Fej");
    PROGMEM Language_Str MSG_PREHEAT_5_END_E                 = _UxGT("Fütés ") PREHEAT_5_LABEL _UxGT(" Fej ~");
    PROGMEM Language_Str MSG_PREHEAT_5_ALL                   = _UxGT("Fütés ") PREHEAT_5_LABEL _UxGT(" Mind");
    PROGMEM Language_Str MSG_PREHEAT_5_BEDONLY               = _UxGT("Fütés ") PREHEAT_5_LABEL _UxGT(" Ágy");
    PROGMEM Language_Str MSG_PREHEAT_5_SETTINGS              = _UxGT("Fütés ") PREHEAT_5_LABEL _UxGT(" Beáll");
  #endif
  ...
  #endif
  #ifdef PREHEAT_3_LABEL
    PROGMEM Language_Str MSG_UBL_BUILD_MESH_M3               = _UxGT("Háló Építés (") PREHEAT_3_LABEL _UxGT(")");
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_UBL_BUILD_MESH_M4               = _UxGT("Háló Építés (") PREHEAT_4_LABEL _UxGT(")");
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_UBL_BUILD_MESH_M5               = _UxGT("Háló Építés (") PREHEAT_5_LABEL _UxGT(")");
  #endif
  ...
  #endif
  #ifdef PREHEAT_3_LABEL
    PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_M3            = _UxGT("Háló Elfogadás (") PREHEAT_3_LABEL _UxGT(")");
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_M4            = _UxGT("Háló Elfogadás (") PREHEAT_4_LABEL _UxGT(")");
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_M5            = _UxGT("Háló Elfogadás (") PREHEAT_5_LABEL _UxGT(")");
  #endif
