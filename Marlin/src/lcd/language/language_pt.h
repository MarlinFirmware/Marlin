...
#define MSG_E0STEPS                         _UxGT(LCD_STR_E0 " passo/mm")
#define MSG_E1STEPS                         _UxGT(LCD_STR_E1 " passo/mm")
#define MSG_E2STEPS                         _UxGT(LCD_STR_E2 " passo/mm")
#define MSG_E3STEPS                         _UxGT(LCD_STR_E3 " passo/mm")
#define MSG_E4STEPS                         _UxGT(LCD_STR_E4 " passo/mm")
#define MSG_E5STEPS                         _UxGT(LCD_STR_E5 " passo/mm")
