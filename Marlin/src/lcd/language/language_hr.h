...
namespace Language_hr {
  ...
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("Postavi ishodište");
    ...
    PROGMEM Language_Str MSG_PREHEAT_3                       = _UxGT("Predgrij ") PREHEAT_3_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_3_H                     = _UxGT("Predgrij ") PREHEAT_3_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_3_END                   = _UxGT("Predgrij ") PREHEAT_3_LABEL _UxGT(" Dizna");
    PROGMEM Language_Str MSG_PREHEAT_3_END_E                 = _UxGT("Predgrij ") PREHEAT_3_LABEL _UxGT(" Dizna ~");
    PROGMEM Language_Str MSG_PREHEAT_3_ALL                   = _UxGT("Predgrij ") PREHEAT_3_LABEL _UxGT(" Sve");
    PROGMEM Language_Str MSG_PREHEAT_3_BEDONLY               = _UxGT("Predgrij ") PREHEAT_3_LABEL _UxGT(" Bed");
    PROGMEM Language_Str MSG_PREHEAT_3_SETTINGS              = _UxGT("Predgrij ") PREHEAT_3_LABEL _UxGT(" conf");
  #endif
  #ifdef PREHEAT_4_LABEL
    PROGMEM Language_Str MSG_PREHEAT_4                       = _UxGT("Predgrij ") PREHEAT_4_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_4_H                     = _UxGT("Predgrij ") PREHEAT_4_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_4_END                   = _UxGT("Predgrij ") PREHEAT_4_LABEL _UxGT(" Dizna");
    PROGMEM Language_Str MSG_PREHEAT_4_END_E                 = _UxGT("Predgrij ") PREHEAT_4_LABEL _UxGT(" Dizna ~");
    PROGMEM Language_Str MSG_PREHEAT_4_ALL                   = _UxGT("Predgrij ") PREHEAT_4_LABEL _UxGT(" Sve");
    PROGMEM Language_Str MSG_PREHEAT_4_BEDONLY               = _UxGT("Predgrij ") PREHEAT_4_LABEL _UxGT(" Bed");
    PROGMEM Language_Str MSG_PREHEAT_4_SETTINGS              = _UxGT("Predgrij ") PREHEAT_4_LABEL _UxGT(" conf");
  #endif
  #ifdef PREHEAT_5_LABEL
    PROGMEM Language_Str MSG_PREHEAT_5                       = _UxGT("Predgrij ") PREHEAT_5_LABEL;
    PROGMEM Language_Str MSG_PREHEAT_5_H                     = _UxGT("Predgrij ") PREHEAT_5_LABEL " ~";
    PROGMEM Language_Str MSG_PREHEAT_5_END                   = _UxGT("Predgrij ") PREHEAT_5_LABEL _UxGT(" Dizna");
    PROGMEM Language_Str MSG_PREHEAT_5_END_E                 = _UxGT("Predgrij ") PREHEAT_5_LABEL _UxGT(" Dizna ~");
    PROGMEM Language_Str MSG_PREHEAT_5_ALL                   = _UxGT("Predgrij ") PREHEAT_5_LABEL _UxGT(" Sve");
    PROGMEM Language_Str MSG_PREHEAT_5_BEDONLY               = _UxGT("Predgrij ") PREHEAT_5_LABEL _UxGT(" Bed");
    PROGMEM Language_Str MSG_PREHEAT_5_SETTINGS              = _UxGT("Predgrij ") PREHEAT_5_LABEL _UxGT(" conf");
  #endif
