  ...
  uint32_t getProgress_seconds_elapsed() {
    ...
    bool getLevelingIsValid() { return leveling_is_valid(); }
      ...
      void setMeshPoint(const xy_uint8_t &pos, const float zoff) {
        if (WITHIN(pos.x, 0, (TERN(VARIABLE_GRID_POINTS, GRID_USED_POINTS_X, GRID_MAX_POINTS_X)) - 1) && WITHIN(pos.y, 0, (TERN(VARIABLE_GRID_POINTS, GRID_USED_POINTS_Y, GRID_MAX_POINTS_Y)) - 1)) {
