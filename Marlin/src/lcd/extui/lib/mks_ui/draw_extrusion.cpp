...
void lv_draw_extrusion() {
  ...
  lv_obj_t *buttonAdd = lv_big_button_create(scr, "F:/bmp_in.bin", extrude_menu.in, BUTTON_X(0), BUTTON_Y(0), event_handler, ID_E_ADD);
  lv_obj_clear_protect(buttonAdd, LV_PROTECT_FOLLOW);
  lv_big_button_create(scr, "F:/bmp_out.bin", extrude_menu.out, BUTTON_X(3), BUTTON_Y(0), event_handler, ID_E_DEC);

  buttonType = lv_imgbtn_create(scr, nullptr, BUTTON_X(0), BUTTON_Y(1), event_handler, ID_E_TYPE);
  buttonStep = lv_imgbtn_create(scr, nullptr, BUTTON_X(1), BUTTON_Y(1), event_handler, ID_E_STEP);
  buttonSpeed = lv_imgbtn_create(scr, nullptr, BUTTON_X(2), BUTTON_Y(1), event_handler, ID_E_SPEED);
  ...
  lv_big_button_create(scr, "F:/bmp_return.bin", common_menu.text_back, BUTTON_X(3), BUTTON_Y(1), event_handler, ID_E_RETURN);
