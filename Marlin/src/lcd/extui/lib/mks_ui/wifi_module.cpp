      ...
      switch (cmd_value) {
        ...
        case 991:
          ...
          if (cmd_value == 105) {
            ...
            sprintf_P(tbuf, PSTR("%d /%d"), thermalManager.degHotend(0), thermalManager.degTargetHotend(0));
            ...
            outBuf += 3;
            #if HAS_HEATED_BED
              sprintf_P(outBuf, PSTR("%d /%d"), thermalManager.degBed(), thermalManager.degTargetBed());
            #else
            ...
            outBuf += 4;
            #if HAS_MULTI_HOTEND
              sprintf_P(outBuf, PSTR("%d /%d"), thermalManager.degHotend(1), thermalManager.degTargetHotend(1));
            #else
