...
#define HAS_CUSTOM_USER_MENU_ITEM(N) (ENABLED(CUSTOM_USER_MENUS) && defined(USER_DESC_##N) && defined(USER_GCODE_##N))

enum {
  ID_GCODE = 1,
  #if HAS_CUSTOM_USER_MENU_ITEM(1)
    ID_CUSTOM_1,
  #endif
  #if HAS_CUSTOM_USER_MENU_ITEM(2)
    ID_CUSTOM_2,
  #endif
  #if HAS_CUSTOM_USER_MENU_ITEM(3)
    ID_CUSTOM_3,
  #endif
  #if HAS_CUSTOM_USER_MENU_ITEM(4)
    ID_CUSTOM_4,
  #endif
  #if HAS_CUSTOM_USER_MENU_ITEM(5)
    ID_CUSTOM_5,
  #endif
  #if HAS_CUSTOM_USER_MENU_ITEM(6)
    ID_CUSTOM_6,
  #endif
  ID_M_RETURN,
};
