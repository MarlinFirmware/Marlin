...
static void event_handler(lv_obj_t * obj, lv_event_t event) {
  ...
  switch (obj->mks_obj_id) {
    ...
    case ID_CUSTOM_1: TERN_(HAS_CUSTOM_USER_MENU_ITEM_1, queue.inject_P(PSTR(USER_GCODE_1))); break;
    case ID_CUSTOM_2: TERN_(HAS_CUSTOM_USER_MENU_ITEM_2, queue.inject_P(PSTR(USER_GCODE_2))); break;
    case ID_CUSTOM_3: TERN_(HAS_CUSTOM_USER_MENU_ITEM_3, queue.inject_P(PSTR(USER_GCODE_3))); break;
    case ID_CUSTOM_4: TERN_(HAS_CUSTOM_USER_MENU_ITEM_4, queue.inject_P(PSTR(USER_GCODE_4))); break;
    case ID_CUSTOM_5: TERN_(HAS_CUSTOM_USER_MENU_ITEM_5, queue.inject_P(PSTR(USER_GCODE_5))); break;
    case ID_CUSTOM_6: TERN_(HAS_CUSTOM_USER_MENU_ITEM_6, queue.inject_P(PSTR(USER_GCODE_6))); break;
    case ID_M_RETURN:
      lv_clear_more();
      lv_draw_tool();
      break;
...
void lv_draw_more() {
  ...
  #if HAS_CUSTOM_USER_MENU_ITEM_1
  ...
  #if HAS_CUSTOM_USER_MENU_ITEM_2
  ...
  #if HAS_CUSTOM_USER_MENU_ITEM_3
  ...
  #if HAS_CUSTOM_USER_MENU_ITEM_4
  ...
  #if HAS_CUSTOM_USER_MENU_ITEM_5
  ...
  #if HAS_CUSTOM_USER_MENU_ITEM_6
