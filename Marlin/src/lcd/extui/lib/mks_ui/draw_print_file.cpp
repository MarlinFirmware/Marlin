...
void disp_gcode_icon(uint8_t file_num) {
  ...
  buttonPageUp   = lv_imgbtn_create(scr, "F:/bmp_pageUp.bin", OTHER_BUTTON_X(3), OTHER_BUTTON_Y(0), event_handler, ID_P_UP);
  buttonPageDown = lv_imgbtn_create(scr, "F:/bmp_pageDown.bin", OTHER_BUTTON_X(3), OTHER_BUTTON_Y(1), event_handler, ID_P_DOWN);
  buttonBack     = lv_imgbtn_create(scr, "F:/bmp_back.bin", OTHER_BUTTON_X(3), OTHER_BUTTON_Y(2), event_handler, ID_P_RETURN);
    ...
    */
    if (i >= file_num) break;
      ...
      if (list_file.IsFolder[i]) {
        ...
        if (i < 3)
          lv_obj_set_pos(buttonGcode[i], BUTTON_X(i), BUTTON_Y(0));
        else
          lv_obj_set_pos(buttonGcode[i], BUTTON_X(i - 3), BUTTON_Y(1));
        ...
        if (have_pre_pic((char *)list_file.file_name[i])) {
          ...
          if (i < 3) {
            lv_obj_set_pos(buttonGcode[i], BUTTON_X(i) + FILE_PRE_PIC_X_OFFSET, BUTTON_Y(0) + FILE_PRE_PIC_Y_OFFSET);
            ...
            lv_obj_set_pos(buttonText[i], BUTTON_X(i) + FILE_PRE_PIC_X_OFFSET, BUTTON_Y(0) + FILE_PRE_PIC_Y_OFFSET + 100);
            lv_obj_set_size(buttonText[i], 100, 40);
          }
          else {
            lv_obj_set_pos(buttonGcode[i], BUTTON_X(i - 3) + FILE_PRE_PIC_X_OFFSET, BUTTON_Y(1) + FILE_PRE_PIC_Y_OFFSET);
            buttonText[i] = lv_btn_create(scr, nullptr);
            //lv_obj_set_event_cb(buttonText[i], event_handler);
            ...
            lv_btn_set_layout(buttonText[i], LV_LAYOUT_OFF);
            //lv_obj_set_event_cb_mks(buttonText[i], event_handler,(i+10),"", 0);
            lv_obj_set_pos(buttonText[i], BUTTON_X(i - 3) + FILE_PRE_PIC_X_OFFSET, BUTTON_Y(1) + FILE_PRE_PIC_Y_OFFSET + 100);
            lv_obj_set_size(buttonText[i], 100, 40);
          }
