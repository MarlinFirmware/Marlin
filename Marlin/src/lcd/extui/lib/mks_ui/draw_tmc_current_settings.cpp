...
void lv_draw_tmc_current_settings(void)
{
	...
	if(uiCfg.para_ui_page != 1)
	{
		...
		lv_btn_set_style(buttonXText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
		lv_btn_set_style(buttonXText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
		...
		lv_btn_set_style(buttonYText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
		lv_btn_set_style(buttonYText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
		...
		lv_btn_set_style(buttonZText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
		lv_btn_set_style(buttonZText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
		...
		lv_btn_set_style(buttonE0Text, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
		lv_btn_set_style(buttonE0Text, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
		...
		lv_imgbtn_set_style(buttonTurnPage, LV_BTN_STATE_PR, &tft_style_lable_pre);
		lv_imgbtn_set_style(buttonTurnPage, LV_BTN_STATE_REL, &tft_style_lable_rel);
		#endif
	}
	else
	{
		...
		lv_btn_set_style(buttonE1Text, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
		lv_btn_set_style(buttonE1Text, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
