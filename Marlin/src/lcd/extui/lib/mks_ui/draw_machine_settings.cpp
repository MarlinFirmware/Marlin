...
void lv_draw_machine_settings(void)
{
	...
	lv_btn_set_style(buttonAcceleration, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonAcceleration, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonAccelerationNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonAccelerationNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonMaxFeedrate, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonMaxFeedrate, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonMaxFeedrateNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonMaxFeedrateNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonJerk, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonJerk, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonJerkNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonJerkNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
