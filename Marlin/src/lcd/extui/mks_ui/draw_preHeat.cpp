...
void disp_add_dec() {
  ...
  buttonAdd = lv_big_button_create(scr, "F:/bmp_Add.bin", preheat_menu.add, BUTTON_X(0), BUTTON_Y(0), event_handler, ID_P_ADD);
  buttonDec = lv_big_button_create(scr, "F:/bmp_Dec.bin", preheat_menu.dec, BUTTON_X(3), BUTTON_Y(0), event_handler, ID_P_DEC);
}
