...
void lv_draw_baby_stepping() {
  ...
  lv_big_button_create(scr, "F:/bmp_xAdd.bin", move_menu.x_add, BUTTON_X(0), BUTTON_Y(0), event_handler, ID_BABYSTEP_X_P);
  lv_big_button_create(scr, "F:/bmp_xDec.bin", move_menu.x_dec, BUTTON_X(0), BUTTON_Y(1), event_handler, ID_BABYSTEP_X_N);
  lv_big_button_create(scr, "F:/bmp_yAdd.bin", move_menu.y_add, BUTTON_X(1), BUTTON_Y(0), event_handler, ID_BABYSTEP_Y_P);
  lv_big_button_create(scr, "F:/bmp_yDec.bin", move_menu.y_dec, BUTTON_X(1), BUTTON_Y(1), event_handler, ID_BABYSTEP_Y_N);
  lv_big_button_create(scr, "F:/bmp_zAdd.bin", move_menu.z_add, BUTTON_X(2), BUTTON_Y(0), event_handler, ID_BABYSTEP_Z_P);
  lv_big_button_create(scr, "F:/bmp_zDec.bin", move_menu.z_dec, BUTTON_X(2), BUTTON_Y(1), event_handler, ID_BABYSTEP_Z_N);
  buttonV = lv_imgbtn_create(scr, nullptr, BUTTON_X(3), BUTTON_Y(0), event_handler, ID_BABYSTEP_DIST);
  ...
  lv_big_button_create(scr, "F:/bmp_return.bin", common_menu.text_back, BUTTON_X(3), BUTTON_Y(1), event_handler, ID_BABYSTEP_RETURN);
