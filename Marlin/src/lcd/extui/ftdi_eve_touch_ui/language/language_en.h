...
namespace Language_en {
  ...
  LSTR MSG_VMAX_X                   = u8"Vmax X";
  LSTR MSG_VMAX_Y                   = u8"Vmax Y";
  LSTR MSG_VMAX_Z                   = u8"Vmax Z";
  LSTR MSG_ACCEL_PRINTING           = u8"Printing";
  LSTR MSG_ACCEL_TRAVEL             = u8"Travel";
  LSTR MSG_ACCEL_RETRACT            = u8"Retraction";
  LSTR MSG_AMAX_X                   = u8"Amax X";
  LSTR MSG_AMAX_Y                   = u8"Amax Y";
  LSTR MSG_AMAX_Z                   = u8"Amax Z";
