...
const struct DGUS_ScreenAddrList screen_addr_list_map[] PROGMEM = {
  MAP_HELPER(DGUS_Screen::BOOT,                 LIST_BOOT),
  MAP_HELPER(DGUS_Screen::HOME,                 LIST_HOME),
  MAP_HELPER(DGUS_Screen::FILE1,                LIST_SDCARD),
  MAP_HELPER(DGUS_Screen::FILE2,                LIST_SDCARD),
  MAP_HELPER(DGUS_Screen::FILE3,                LIST_SDCARD),
  ...
  MAP_HELPER(DGUS_Screen::MOVEAXIS_01,          LIST_MOVEAXIS),
  MAP_HELPER(DGUS_Screen::MOVEAXIS_1,           LIST_MOVEAXIS),
  MAP_HELPER(DGUS_Screen::MOVEAXIS_10,          LIST_MOVEAXIS),
  MAP_HELPER(DGUS_Screen::FEEDRETURN,           LIST_IO),
  MAP_HELPER(DGUS_Screen::CONTROL,              LIST_CONTROL),
  MAP_HELPER(DGUS_Screen::TEMP,                 LIST_SETTINGS),
  MAP_HELPER(DGUS_Screen::PLA_TEMP,             LIST_TEMPERATURE_PRESETS),
  MAP_HELPER(DGUS_Screen::ABS_TEMP,             LIST_TEMPERATURE_PRESETS),
  MAP_HELPER(DGUS_Screen::AUTOHOME,             LIST_AUTOHOME),
  ...
  MAP_HELPER(DGUS_Screen::MOTION,               LIST_MOTION),
  MAP_HELPER(DGUS_Screen::MAX_FEEDRATE,         LIST_MAX_FEEDRATE),
  MAP_HELPER(DGUS_Screen::ACCELERATION,         LIST_ACCELERATION),
  MAP_HELPER(DGUS_Screen::JERK,                 LIST_JERK),
  MAP_HELPER(DGUS_Screen::STEPSMM,              LIST_STEPSMM),
  MAP_HELPER(DGUS_Screen::PIDCONTROL,           LIST_PIDCONTROL),
  MAP_HELPER(DGUS_Screen::FACTORYRESET_CONFIRM, LIST_RESET_CONFIRM),
  MAP_HELPER(DGUS_Screen::FILAMENTCHECK,        LIST_FILAMENTCHECK),
  MAP_HELPER(DGUS_Screen::SDCARDCHECK,          LIST_SDCARDCHECK),
  MAP_HELPER(DGUS_Screen::LASER_FDM,            LIST_PRINTMODE),
  MAP_HELPER(DGUS_Screen::SW_LASER_TIPS,        LIST_PRINTMODE_CONFIRM),
  MAP_HELPER(DGUS_Screen::SW_FDM_TIPS,          LIST_PRINTMODE_CONFIRM),
