...
#define LV_HOR_RES_MAX          TFT_WIDTH //(480)
#define LV_VER_RES_MAX          TFT_HEIGHT //(320)
...
#define LV_TICK_CUSTOM 1
    ...
    #define LV_TICK_CUSTOM_INCLUDE  "millis_linux.h"    // Header for the system time function
...
// 1: Enable the log module
  ...
  #define LV_USE_LOG 1
     ...
     */
    #ifdef LVGL_LOG_LEVEL
      #define LV_LOG_LEVEL    LVGL_LOG_LEVEL
    #else
...
/*
 * Documentation for object types: https://docs.lvgl.com/#Object-types
 */
