...
namespace ExtUI {
  ...
  #if HAS_PID_HEATING
    enum pidresult_t : uint8_t { PID_STARTED, PIDTEMPBED, PID_BED_STARTED, PIDTEMPCHAMBER, PID_CHAMBER_STARTED, PID_BAD_HEATER_ID, PID_TEMP_TOO_HIGH, PID_TUNING_TIMEOUT, PID_DONE };
  #endif
