...
u8g_uint_t lcd_put_u8str_ind_P(PGM_P const pstr, const uint8_t ind, const u8g_uint_t maxlen=20);
inline u8g_uint_t lcd_put_u8str_ind_P(const lcd_uint_t col, const lcd_uint_t row, PGM_P const pstr, const uint8_t ind, const u8g_uint_t maxlen=20) {
  lcd_moveto(col, row);
