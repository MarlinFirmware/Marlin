...
void MarlinUI::init() {
  ...
  millis_t MarlinUI::next_button_update_ms; // = 0
    ...
    // TODO: Remove _unused.
    const char * MarlinUI::scrolled_filename(CardReader &theCard, const uint8_t maxlen, uint8_t _unused, const bool doScroll) {
      ...
      if ((should_draw() || drawing_screen) && (!bbr2 || bbr2 > max_display_update_time)) {
        ...
        if (!drawing_screen) switch (lcdDrawUpdate) {
          ...
          case LCDVIEW_CLEAR_CALL_REDRAW:
            // TODO: Here, shouldn't we clear_lcd(), update lcdDrawUpdate and return?
