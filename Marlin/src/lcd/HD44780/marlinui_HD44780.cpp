...
void MarlinUI::draw_status_screen() {
  ...
  void MenuItem_confirm::draw_select_screen(FSTR_P const yes, FSTR_P const no, const bool yesno, FSTR_P const fpre, const char * const string/*=nullptr*/, FSTR_P const fsuf/*=nullptr*/) {
    ...
    void MarlinUI::ubl_plot(const uint8_t x_plot, const uint8_t y_plot) {
        ...
        const uint8_t y_plot_inv = GRID_PREF_POINTS_Y - 1 - y_plot;
        ...
        x_map_pixels = pixels_per_x_mesh_pnt * GRID_PREF_POINTS_X;         // Now we have the right number of pixels to make both
        y_map_pixels = pixels_per_y_mesh_pnt * GRID_PREF_POINTS_Y;         // Directions fit nicely

        right_edge   = pixels_per_x_mesh_pnt * GRID_PREF_POINTS_X + 1;     // Find location of right edge within the character cell
        bottom_line  = pixels_per_y_mesh_pnt * GRID_PREF_POINTS_Y + 1;     // Find location of bottom line within the character cell
        ...
        k = pixels_per_y_mesh_pnt * GRID_PREF_POINTS_Y + 2;
        ...
        clear_custom_char(&new_char);
        k = GRID_PREF_POINTS_Y * pixels_per_y_mesh_pnt + 1;                // Row of pixels for the bottom box line
        ...
        clear_custom_char(&new_char);
        m = GRID_PREF_POINTS_X * pixels_per_x_mesh_pnt + 1;                // Column of pixels for the right box line
