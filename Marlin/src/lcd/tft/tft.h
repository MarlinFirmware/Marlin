...
class TFT {
  ...
  public:
    ...
    static void drawSimpleBtn(const char *label, uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t bgColor, TouchControlType touchType = BUTTON, intptr_t data = 0);
};
