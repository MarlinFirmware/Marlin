...
class TFT {
  ...
  public:
    ...
    static void add_text(const uint16_t x, const uint16_t y, const uint16_t color, TFT_String tft_string, uint16_t maxWidth = 0) { queue.add_text(x, y, color, tft_string.string(), maxWidth); }
    static void add_text(const uint16_t x, const uint16_t y, const uint16_t color, const char *string, uint16_t maxWidth = 0) { queue.add_text(x, y, color, string, maxWidth); }
