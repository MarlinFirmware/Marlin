...
void MarlinUI::tft_idle() {
    ...
    if (draw_menu_navigation) {
      add_control(104, TFT_HEIGHT - FONT_LINE_HEIGHT, PAGE_UP, imgPageUp, encoderTopLine > 0);
      add_control(344, TFT_HEIGHT - FONT_LINE_HEIGHT, PAGE_DOWN, imgPageDown, encoderTopLine + LCD_HEIGHT < screen_items);
