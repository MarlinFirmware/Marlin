...
// G-code Preview Screen Layout (1024x600)
  ...
  #define GCODE_PREVIEW_TEXT_X        (GCODE_PREVIEW_THUMB_WIDTH + 20)
  #define GCODE_PREVIEW_TEXT_Y_START  40
#endif

#if !defined(GCODE_PREVIEW_BUTTON_Y) && !defined(GCODE_PREVIEW_BUTTON1_X) && !defined(GCODE_PREVIEW_BUTTON2_X)
  #define GCODE_PREVIEW_BUTTON_Y      (TFT_HEIGHT - 60)
  #define GCODE_PREVIEW_BUTTON1_X     (TFT_WIDTH / 4 - 40)
  #define GCODE_PREVIEW_BUTTON2_X     (3 * TFT_WIDTH / 4 - 40)
#endif
