...
namespace ExtUI {
  ...
  void onSettingsLoaded(const bool success) {
    ...
    void onPIDTuning(const pidresult_t rst) {
      ...
      switch (rst) {
        case PID_STARTED:         TERN_(PIDTEMP, dwinPIDTuning(PIDTEMP_START));     break;
        case PID_BED_STARTED:     TERN_(PIDTEMPBED, dwinPIDTuning(PIDTEMPBED_START)); break;
        case PID_CHAMBER_STARTED: TERN_(PIDTEMPCHAMBER, dwinPIDTuning(PIDTEMPCHAMBER_START)); break;
