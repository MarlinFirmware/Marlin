...
void MarlinUI::_goto_previous_screen(TERN_(TURBO_BACK_MENU_ITEM, const bool is_back/*=false*/)) {
  ...
  TERN_(HAS_XPT2046_BUTTONS, on_edit_screen = false);
...
void MenuEditItemBase::edit_screen(strfunc_t strfunc, loadfunc_t loadfunc) {
  TERN_(HAS_XPT2046_BUTTONS, ui.repeat_delay = BUTTON_DELAY_EDIT);
...
void MenuEditItemBase::goto_edit_screen(
  ...
  TERN_(HAS_XPT2046_BUTTONS, ui.on_edit_screen = true);
...
void MarlinUI::goto_screen(screenFunc_t screen, const uint16_t encoder/*=0*/, const uint8_t top/*=0*/, const uint8_t items/*=0*/) {
  if (currentScreen != screen) {
    ...
    TERN_(HAS_XPT2046_BUTTONS, repeat_delay = BUTTON_DELAY_MENU);
