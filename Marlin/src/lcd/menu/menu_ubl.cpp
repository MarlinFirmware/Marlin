...
void _menu_ubl_mesh_wizard() {
  ...
  #if HAS_HOTEND
    EDIT_ITEM(int3, MSG_UBL_HOTEND_TEMP_CUSTOM, &custom_hotend_temp, 100, thermalManager.hotend_max_target(0));
  #endif

  #if HAS_HEATED_BED
    EDIT_ITEM(int3, MSG_UBL_BED_TEMP_CUSTOM, &custom_bed_temp, 40, BED_MAX_TARGET);
  #endif
