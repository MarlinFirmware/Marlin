...
static void lcd_factory_settings() {
  ...
  void menu_tool_change() {
    ...
    MENU_BACK(MSG_CONFIGURATION);
      ...
      MENU_ITEM_EDIT(float3, MSG_FILAMENT_SWAP_LENGTH, &toolchange_settings.swap_length, 0, 500);
      MENU_ITEM_EDIT(float3, MSG_FILAMENT_PURGE_LENGTH, &toolchange_settings.extra_prime, 0, 500);
