...
void menu_advanced_settings();
  ...
  #define _NEEDS_SPACE(N) TERN0(HAS_##N##_MIN_STATE,1) || TERN0(HAS_##N##_MAX_STATE,1)
  #define NEEDS_SPACE _NEEDS_SPACE(X2) || _NEEDS_SPACE(Y2) || _NEEDS_SPACE(Z2)
  #define STOP_ITEM(A,I,M,L) TERN(HAS_##A##I##_##M##_STATE, _STOP_ITEM, _IF_1_ELSE)(STRINGIFY(A) TERN(I, TERN(NEEDS_SPACE, " ", ""), STRINGIFY(I)) " " STRINGIFY(L), A##I##_##M)
