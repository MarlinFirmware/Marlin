...
static void lcd_factory_settings() {
  ...
  void menu_bltouch() {
    ...
    #if ENABLED(BLTOUCH_V3_MENUS)
      MENU_ITEM(gcode, MSG_BLTOUCH_SWMODE, PSTR("M280 P" STRINGIFY(Z_PROBE_SERVO_NR) " S" STRINGIFY(BLTOUCH_SWMODE)));
      MENU_ITEM(gcode, MSG_BLTOUCH_5VMODE, PSTR("M280 P" STRINGIFY(Z_PROBE_SERVO_NR) " S" STRINGIFY(BLTOUCH_5VMODE)));
      MENU_ITEM(gcode, MSG_BLTOUCH_OPENMODE, PSTR("M280 P" STRINGIFY(Z_PROBE_SERVO_NR) " S" STRINGIFY(BLTOUCH_OPENMODE)));
    #endif
    END_MENU();
  }
