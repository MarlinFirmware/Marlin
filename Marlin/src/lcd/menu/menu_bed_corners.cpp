...
#include "../../module/planner.h"
  ...
  #endif  
  #ifndef LEVEL_CORNERS_USE_PROBE_TOLERANCE
...
static int8_t bed_corner;
#if DISABLED(LEVEL_CORNERS_USE_PROBE)
  ...
  static inline void _lcd_level_bed_corners_probing() {
    ...
    do_blocking_move_to_z(last_z - LEVEL_CORNERS_USE_PROBE_TOLERANCE, manual_feedrate_mm_s.z);// Move down until the probe is triggered
    ...
    if (probe_triggered) {
      ...
      if (!WITHIN(current_position.z, current_position.z - LEVEL_CORNERS_USE_PROBE_TOLERANCE, current_position.z + LEVEL_CORNERS_USE_PROBE_TOLERANCE)){
