...
void menu_info_thermistors() {
  ...
  START_SCREEN();
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_0_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_0_MAXTEMP), SS_LEFT);
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_1_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_1_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_2_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_2_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_3_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_3_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_4_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_4_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_5_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_5_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_6_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_6_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(HEATER_7_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(HEATER_7_MAXTEMP), SS_LEFT);
    STATIC_ITEM(TERN(WATCH_HOTENDS, MSG_INFO_RUNAWAY_ON, MSG_INFO_RUNAWAY_OFF), SS_LEFT);
  #endif
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(BED_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(BED_MAXTEMP), SS_LEFT);
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(CHAMBER_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(CHAMBER_MAXTEMP), SS_LEFT);
    ...
    PSTRING_ITEM(MSG_INFV_MIN_TEMP, STRINGIFY(COOLER_MINTEMP), SS_LEFT);
    PSTRING_ITEM(MSG_INFV_MAX_TEMP, STRINGIFY(COOLER_MAXTEMP), SS_LEFT);
