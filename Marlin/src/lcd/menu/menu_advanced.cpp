...
//
  ...
  void menu_advanced_steps_per_mm() {
    ...
    #define EDIT_QSTEPS(Q) MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float61, MSG_##Q##STEPS, &planner.settings.axis_steps_per_mm[_AXIS(Q)], 5, 9999, _planner_refresh_positioning)
    EDIT_QSTEPS(A);
    EDIT_QSTEPS(B);
    EDIT_QSTEPS(C);

    #if ENABLED(DISTINCT_E_FACTORS)
      #define EDIT_ESTEPS(N,E) MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float61, MSG_E##N##STEPS, &planner.settings.axis_steps_per_mm[E_AXIS_N(E)], 5, 9999, _planner_refresh_e##E##_positioning)
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float61, MSG_ESTEPS, &planner.settings.axis_steps_per_mm[E_AXIS_N(active_extruder)], 5, 9999, _planner_refresh_positioning);
      EDIT_ESTEPS(1,0);
      EDIT_ESTEPS(2,1);
      #if E_STEPPERS > 2
        EDIT_ESTEPS(3,2);
      ...
      #endif // E_STEPPERS > 2
    #elif E_STEPPERS
      MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(float61, MSG_ESTEPS, &planner.settings.axis_steps_per_mm[E_AXIS], 5, 9999, _planner_refresh_positioning);
    #endif
