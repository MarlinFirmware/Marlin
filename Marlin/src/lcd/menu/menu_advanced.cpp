    ...
    void menu_advanced_input_shaping() {
      ...
      // M593 F Frequency and D Damping ratio
        ...
        if (editable.decimal) {
          ...
          EDIT_ITEM_FAST_N(float3, X_AXIS, MSG_SHAPING_FREQ, &editable.decimal, min_frequency, 200.0f, []{ stepper.set_shaping_frequency(X_AXIS, editable.decimal); });
        ...
        if (editable.decimal) {
          ...
          EDIT_ITEM_FAST_N(float3, Y_AXIS, MSG_SHAPING_FREQ, &editable.decimal, min_frequency, 200.0f, []{ stepper.set_shaping_frequency(Y_AXIS, editable.decimal); });
