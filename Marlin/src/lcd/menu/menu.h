...
#define MENU_ITEM_N_S(TYPE, N, S, LABEL, V...)      _MENU_ITEM_N_S_P(TYPE, N, S, false, GET_TEXT(LABEL), ##V)
#define MENU_ITEM_S_P(TYPE, S, PLABEL, V...)        _MENU_ITEM_N_S_P(TYPE, 0, S, false, PLABEL, ##V)
...
#define ACTION_ITEM_N_S(N, S, LABEL, ACTION)         MENU_ITEM_N_S_P(function, N, S, GET_TEXT(LABEL), ACTION)
#define ACTION_ITEM_S_P(S, PLABEL, ACTION)             MENU_ITEM_S_P(function, S, PLABEL, ACTION)
#define ACTION_ITEM_S(S, LABEL, ACTION)                MENU_ITEM_S_P(function, S, GET_TEXT(LABEL), ACTION)
...
#define GCODES_ITEM_N_S(N, S, LABEL, GCODES)         MENU_ITEM_N_S_P(gcode, N, S, GET_TEXT(LABEL), GCODES)
...
#define SUBMENU_N_S(N, S, LABEL, DEST)               MENU_ITEM_N_S_P(submenu, N, S, GET_TEXT(LABEL), DEST)
...
#define EDIT_ITEM_N_S(TYPE, N, S, LABEL, V...)       MENU_ITEM_N_S_P(TYPE, N, S, GET_TEXT(LABEL), ##V)
...
#define EDIT_ITEM_FAST_N_S_P(TYPE, N, PLABEL, V...) _MENU_ITEM_N_S_P(TYPE, N, S, true, PLABEL, ##V)
#define EDIT_ITEM_FAST_N_S(TYPE, N, LABEL, V...)    _MENU_ITEM_N_S_P(TYPE, N, S, true, GET_TEXT(LABEL), ##V)
