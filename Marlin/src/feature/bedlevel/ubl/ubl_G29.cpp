...
void unified_bed_leveling::smart_fill_mesh() {
  ...
  void unified_bed_leveling::g29_what_command() {
    ...
    DEBUG_ECHOLNPGM("mesh_min ", mesh_min.x, ", ", mesh_min.y); serial_delay(50);
    DEBUG_ECHOLNPGM("mesh_max ", mesh_max.x, ", ", mesh_max.y); serial_delay(50);
    ...
    for (uint8_t i = 0; i < GRID_MAX_POINTS_Y; ++i) {
      DEBUG_ECHO(p_float_t(motion.logical_y(get_mesh_y(i)), 3), F("  "));
      DEBUG_DELAY(25);
    }
    DEBUG_EOL();
