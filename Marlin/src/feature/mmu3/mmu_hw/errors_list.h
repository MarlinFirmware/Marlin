...
extern FSTR_P MSG_TITLE_FINDA_DIDNT_TRIGGER;
extern FSTR_P MSG_TITLE_FINDA_FILAMENT_STUCK;
extern FSTR_P MSG_TITLE_FSENSOR_DIDNT_TRIGGER;
extern FSTR_P MSG_TITLE_FSENSOR_FILAMENT_STUCK;
extern FSTR_P MSG_TITLE_PULLEY_CANNOT_MOVE;
extern FSTR_P MSG_TITLE_FSENSOR_TOO_EARLY;
extern FSTR_P MSG_TITLE_INSPECT_FINDA;
extern FSTR_P MSG_TITLE_LOAD_TO_EXTRUDER_FAILED;
extern FSTR_P MSG_TITLE_SELECTOR_CANNOT_MOVE;
extern FSTR_P MSG_TITLE_SELECTOR_CANNOT_HOME;
extern FSTR_P MSG_TITLE_IDLER_CANNOT_MOVE;
extern FSTR_P MSG_TITLE_IDLER_CANNOT_HOME;
extern FSTR_P MSG_TITLE_TMC_WARNING_TMC_TOO_HOT;
extern FSTR_P MSG_TITLE_TMC_OVERHEAT_ERROR;
extern FSTR_P MSG_TITLE_TMC_DRIVER_ERROR;
extern FSTR_P MSG_TITLE_TMC_DRIVER_RESET;
extern FSTR_P MSG_TITLE_TMC_UNDERVOLTAGE_ERROR;
extern FSTR_P MSG_TITLE_TMC_DRIVER_SHORTED;
extern FSTR_P MSG_TITLE_SELFTEST_FAILED;
extern FSTR_P MSG_TITLE_MMU_MCU_ERROR;
extern FSTR_P MSG_TITLE_MMU_NOT_RESPONDING;
extern FSTR_P MSG_TITLE_COMMUNICATION_ERROR;
extern FSTR_P MSG_TITLE_FILAMENT_ALREADY_LOADED;
extern FSTR_P MSG_TITLE_INVALID_TOOL;
extern FSTR_P MSG_TITLE_QUEUE_FULL;
extern FSTR_P MSG_TITLE_FW_UPDATE_NEEDED;
extern FSTR_P MSG_TITLE_FW_RUNTIME_ERROR;
extern FSTR_P MSG_TITLE_UNLOAD_MANUALLY;
extern FSTR_P MSG_TITLE_FILAMENT_EJECTED;
extern FSTR_P MSG_TITLE_FILAMENT_CHANGE;
extern FSTR_P MSG_TITLE_UNKNOWN_ERROR;

FSTR_P const errorTitles[] PROGMEM = {
  MSG_TITLE_FINDA_DIDNT_TRIGGER,
  MSG_TITLE_FINDA_FILAMENT_STUCK,
  MSG_TITLE_FSENSOR_DIDNT_TRIGGER,
  MSG_TITLE_FSENSOR_FILAMENT_STUCK,
  MSG_TITLE_PULLEY_CANNOT_MOVE,
  MSG_TITLE_FSENSOR_TOO_EARLY,
  MSG_TITLE_INSPECT_FINDA,
  MSG_TITLE_LOAD_TO_EXTRUDER_FAILED,
  MSG_TITLE_SELECTOR_CANNOT_HOME,
  MSG_TITLE_SELECTOR_CANNOT_MOVE,
  MSG_TITLE_IDLER_CANNOT_HOME,
  MSG_TITLE_IDLER_CANNOT_MOVE,
  MSG_TITLE_TMC_WARNING_TMC_TOO_HOT,
  MSG_TITLE_TMC_WARNING_TMC_TOO_HOT,
  MSG_TITLE_TMC_WARNING_TMC_TOO_HOT,
  MSG_TITLE_TMC_OVERHEAT_ERROR,
  MSG_TITLE_TMC_OVERHEAT_ERROR,
  MSG_TITLE_TMC_OVERHEAT_ERROR,
  MSG_TITLE_TMC_DRIVER_ERROR,
  MSG_TITLE_TMC_DRIVER_ERROR,
  MSG_TITLE_TMC_DRIVER_ERROR,
  MSG_TITLE_TMC_DRIVER_RESET,
  MSG_TITLE_TMC_DRIVER_RESET,
  MSG_TITLE_TMC_DRIVER_RESET,
  MSG_TITLE_TMC_UNDERVOLTAGE_ERROR,
  MSG_TITLE_TMC_UNDERVOLTAGE_ERROR,
  MSG_TITLE_TMC_UNDERVOLTAGE_ERROR,
  MSG_TITLE_TMC_DRIVER_SHORTED,
  MSG_TITLE_TMC_DRIVER_SHORTED,
  MSG_TITLE_TMC_DRIVER_SHORTED,
  MSG_TITLE_SELFTEST_FAILED,
  MSG_TITLE_SELFTEST_FAILED,
  MSG_TITLE_SELFTEST_FAILED,
  MSG_TITLE_MMU_MCU_ERROR,
  MSG_TITLE_MMU_NOT_RESPONDING,
  MSG_TITLE_COMMUNICATION_ERROR,
  MSG_TITLE_FILAMENT_ALREADY_LOADED,
  MSG_TITLE_INVALID_TOOL,
  MSG_TITLE_QUEUE_FULL,
  MSG_TITLE_FW_UPDATE_NEEDED,
  MSG_TITLE_FW_RUNTIME_ERROR,
  MSG_TITLE_UNLOAD_MANUALLY,
  MSG_TITLE_FILAMENT_EJECTED,
  MSG_TITLE_FILAMENT_CHANGE,
  MSG_TITLE_UNKNOWN_ERROR
};
...
extern FSTR_P MSG_DESC_FINDA_DIDNT_TRIGGER;
extern FSTR_P MSG_DESC_FINDA_FILAMENT_STUCK;
extern FSTR_P MSG_DESC_FSENSOR_DIDNT_TRIGGER;
extern FSTR_P MSG_DESC_FSENSOR_FILAMENT_STUCK;
extern FSTR_P MSG_DESC_PULLEY_CANNOT_MOVE;
extern FSTR_P MSG_DESC_FSENSOR_TOO_EARLY;
extern FSTR_P MSG_DESC_INSPECT_FINDA;
extern FSTR_P MSG_DESC_LOAD_TO_EXTRUDER_FAILED;
extern FSTR_P MSG_DESC_SELECTOR_CANNOT_HOME;
extern FSTR_P MSG_DESC_CANNOT_MOVE;
extern FSTR_P MSG_DESC_IDLER_CANNOT_HOME;
extern FSTR_P MSG_DESC_TMC;
extern FSTR_P MSG_DESC_MMU_NOT_RESPONDING;
extern FSTR_P MSG_DESC_COMMUNICATION_ERROR;
extern FSTR_P MSG_DESC_FILAMENT_ALREADY_LOADED;
extern FSTR_P MSG_DESC_INVALID_TOOL;
extern FSTR_P MSG_DESC_QUEUE_FULL;
extern FSTR_P MSG_DESC_FW_UPDATE_NEEDED;
extern FSTR_P MSG_DESC_FW_RUNTIME_ERROR;
extern FSTR_P MSG_DESC_UNLOAD_MANUALLY;
extern FSTR_P MSG_DESC_FILAMENT_EJECTED;
extern FSTR_P MSG_DESC_FILAMENT_CHANGE;
extern FSTR_P MSG_DESC_UNKNOWN_ERROR;

FSTR_P const errorDescs[] PROGMEM = {
  MSG_DESC_FINDA_DIDNT_TRIGGER,
  MSG_DESC_FINDA_FILAMENT_STUCK,
  MSG_DESC_FSENSOR_DIDNT_TRIGGER,
  MSG_DESC_FSENSOR_FILAMENT_STUCK,
  MSG_DESC_PULLEY_CANNOT_MOVE,
  MSG_DESC_FSENSOR_TOO_EARLY,
  MSG_DESC_INSPECT_FINDA,
  MSG_DESC_LOAD_TO_EXTRUDER_FAILED,
  MSG_DESC_SELECTOR_CANNOT_HOME,
  MSG_DESC_CANNOT_MOVE,
  MSG_DESC_IDLER_CANNOT_HOME,
  MSG_DESC_CANNOT_MOVE,
  MSG_DESC_TMC, // WARNING_TMC_PULLEY_TOO_HOT
  MSG_DESC_TMC, // WARNING_TMC_SELECTOR_TOO_HOT
  MSG_DESC_TMC, // WARNING_TMC_IDLER_TOO_HOT
  MSG_DESC_TMC, // TMC_PULLEY_OVERHEAT_ERROR
  MSG_DESC_TMC, // TMC_SELECTOR_OVERHEAT_ERROR
  MSG_DESC_TMC, // TMC_IDLER_OVERHEAT_ERROR
  MSG_DESC_TMC, // TMC_PULLEY_DRIVER_ERROR
  MSG_DESC_TMC, // TMC_SELECTOR_DRIVER_ERROR
  MSG_DESC_TMC, // TMC_IDLER_DRIVER_ERROR
  MSG_DESC_TMC, // TMC_PULLEY_DRIVER_RESET
  MSG_DESC_TMC, // TMC_SELECTOR_DRIVER_RESET
  MSG_DESC_TMC, // TMC_IDLER_DRIVER_RESET
  MSG_DESC_TMC, // TMC_PULLEY_UNDERVOLTAGE_ERROR
  MSG_DESC_TMC, // TMC_SELECTOR_UNDERVOLTAGE_ERROR
  MSG_DESC_TMC, // TMC_IDLER_UNDERVOLTAGE_ERROR
  MSG_DESC_TMC, // TMC_PULLEY_DRIVER_SHORTED
  MSG_DESC_TMC, // TMC_SELECTOR_DRIVER_SHORTED
  MSG_DESC_TMC, // TMC_IDLER_DRIVER_SHORTED
  MSG_DESC_TMC, // MMU_PULLEY_SELFTEST_FAILED
  MSG_DESC_TMC, // MMU_SELECTOR_SELFTEST_FAILED
  MSG_DESC_TMC, // MMU_IDLER_SELFTEST_FAILED
  MSG_DESC_TMC, // MSG_DESC_MMU_MCU_ERROR
  ...
  MSG_DESC_FILAMENT_EJECTED,
  MSG_DESC_FILAMENT_CHANGE,
  MSG_DESC_UNKNOWN_ERROR
};
...
extern FSTR_P MSG_BTN_RETRY;
extern FSTR_P MSG_BTN_RESET_MMU;
extern FSTR_P MSG_BTN_UNLOAD;
extern FSTR_P MSG_BTN_LOAD;
extern FSTR_P MSG_BTN_EJECT;
extern FSTR_P MSG_BTN_STOP;
extern FSTR_P MSG_BTN_DISABLE_MMU;
extern FSTR_P MSG_BTN_MORE;
