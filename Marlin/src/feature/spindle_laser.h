...
public:
  ...
  static const uint8_t cpwr_to_pct(const cutter_cpower_t cpwr) {
  ...
  static const cutter_power_t cpwr_to_upwr(const cutter_cpower_t cpwr) { // STARTUP power to Unit power
