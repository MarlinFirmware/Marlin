...
typedef struct {
  ...
  feedRate_t retract_feedrate;              // M207 F - G10 Retract feedrate
       float swap_retract_length,           // M207 W - G10 Swap Retract length
             retract_zraise,                // M207 Z - G10 Retract hop size
             recover_extra;                 // M208 S - G11 Recover length
  feedRate_t recover_feedrate;              // M208 F - G11 Recover feedrate
       float swap_recover_extra;            // M208 W - G11 Swap Recover length
  feedRate_t swap_recover_feedrate;         // M208 R - G11 Swap Recover feedrate
