...
// Nominal time step of one generated point (s).
#define RESONANCE_TS 0.001f

// Use Q28 for the sweep time base to preserve precision.
#define FP_Q 28
...
#define C0101321184_FP F2FP(0.101321184f) // 1 / pi²
...
class ResonanceGenerator {
  ...
  private:
    ...
    static int32_t phase_fp;          // Fixed-point phase accumulator (Q16.16)
    static int32_t phase_inc_fp;      // Q28: phase advance per Hz per step
    static int32_t freq_mul_inc;      // Q28: frequency multiplier minus 1 per step
