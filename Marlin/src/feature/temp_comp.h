...
#define TEMP_COMP_PROBE_MEASUREMENTS        10    // Max. number of measurements to be stored (30 - 80°C)
...
#define TEMP_COMP_BED_MEASUREMENTS           9    // Max. number of measurements to be stored (65 - 110°C)
...
#define TEMP_COMP_EXT_MEASUREMENTS           5    // Max. number of measurements to be stored (200 - 110°C)
...
#define TEMP_COMP_PROBE_CALIB_BED_TEMP 100  // Bed temperature while calibrating probe
