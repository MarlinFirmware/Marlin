...
void GcodeSuite::G42() {
  ...
  if ((hasI && !WITHIN(ix, 0, TERN(VARIABLE_GRID_POINTS, GRID_USED_POINTS_X, GRID_MAX_POINTS_X) - 1)) || (hasJ && !WITHIN(iy, 0, TERN(VARIABLE_GRID_POINTS, GRID_USED_POINTS_Y, GRID_MAX_POINTS_Y) - 1))) {
