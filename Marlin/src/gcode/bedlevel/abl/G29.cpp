 ...
 *           Example: G29 V3
 *
 *   With AUTO_BED_LEVELING_LINEAR or BILINEAR + VARIABLE_GRID_POINTS:
    ...
    abl.reenable = planner.leveling_active;
      ...
      if (seen_w) {
        ...
        if (!isnan(rx) && !isnan(ry)) {
          ...
          LIMIT(i, 0, (TERN(VARIABLE_GRID_POINTS, bedlevel.nr_grid_points.x, (GRID_MAX_POINTS_X))) - 1);
          LIMIT(j, 0, (TERN(VARIABLE_GRID_POINTS, bedlevel.nr_grid_points.y, (GRID_MAX_POINTS_Y))) - 1);
        }

        #pragma GCC diagnostic pop

        if (WITHIN(i, 0, (TERN(VARIABLE_GRID_POINTS, bedlevel.nr_grid_points.x, (GRID_MAX_POINTS_X))) - 1) && WITHIN(j, 0, (TERN(VARIABLE_GRID_POINTS, bedlevel.nr_grid_points.y, (GRID_MAX_POINTS_Y))) - 1)) {
