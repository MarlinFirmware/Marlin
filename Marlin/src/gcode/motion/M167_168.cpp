...
void GcodeSuite::M167() {
  ...
  DEBUG_ECHOLNPGM("Entrou no M167");
    ...
    DEBUG_ECHOLNPGM("Calculou HomeDir5X: ", HomeDir5x);
    ...
    DEBUG_ECHOLNPGM("Fez o mix A");
    M167_Probe();

    //homeaxis(E_AXIS);

    DEBUG_ECHOLNPGM("Fez o Home ao A?");
    OA_5 = 0;
    DEBUG_ECHOLNPGM("Zerou o A");
    ...
    DEBUG_ECHOLNPGM("Fez o mix C");
    M167_Probe();
    //homeaxis(E_AXIS);
    DEBUG_ECHOLNPGM("Fez o Home ao C?");

    OC_5 = 0;
    DEBUG_ECHOLNPGM("Zerou o C");
    Home5x = 0;
...
void GcodeSuite::M168() {
  ...
  SERIAL_ECHOLNPGM("X", X_5, " Y", Y_5, " Z", Z_5, " A", OA_5, " B", OB_5, " C", OC_5);
