...
#include "../../core/debug_out.h"
  ...
  void end_slow_homing(const slow_homing_t &slow_homing) {
    ...
    TERN_(DELTA, planner.settings.max_acceleration_mm_per_s2[Z_AXIS] = slow_homing.acceleration.z);  //lujsensorless añadido tras declarar jerk_xyz
...
void GcodeSuite::G28() {
  ...
  #define HAS_CURRENT_HOME(N) (defined(N##_CURRENT_HOME) && N##_CURRENT_HOME != N##_CURRENT)
    ...
    #endif
    //Lujhoming  se incluye este if sobre Z para DELTA
  ...
  // Restore the active tool after homing
    ...
    #endif
        //Lujhoming se añade este if para DELTA
    #if HAS_CURRENT_HOME(Z) && ENABLED(DELTA)       
