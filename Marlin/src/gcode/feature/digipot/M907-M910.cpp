...
void GcodeSuite::M907() {
    ...
    LOOP_NUM_AXIS(i) if (parser.seenval(axis_codes[i])) stepper.set_digipot_current(i, parser.value_int());
    ...
    LOOP_NUM_AXIS(i) if (parser.seenval(axis_codes[i])) digipot_i2c.set_current(i, parser.value_float());
    ...
    LOOP_NUM_AXIS(i) if (parser.seenval(axis_codes[i])) stepper_dac.set_current_percent(i, parser.value_float());
  #endif
}
