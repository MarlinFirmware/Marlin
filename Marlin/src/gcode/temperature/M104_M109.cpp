...
void GcodeSuite::M104() {
  ...
  if (parser.seenval('S')) {
    ...
    thermalManager.setTargetHotend(temp, e);
      ...
      if ((dual_x_carriage_mode == DXC_DUPLICATION_MODE || dual_x_carriage_mode == DXC_SCALED_DUPLICATION_MODE) && e == 0)
...
void GcodeSuite::M109() {
  ...
  if (no_wait_for_cooling || parser.seenval('R')) {
    ...
    #if ENABLED(DUAL_X_CARRIAGE)
      if ((dual_x_carriage_mode == DXC_DUPLICATION_MODE || dual_x_carriage_mode == DXC_SCALED_DUPLICATION_MODE) && target_extruder == 0) 
        thermalManager.setTargetHotend(temp ? temp + duplicate_extruder_temp_offset : 0, 1);
    #endif
