...
extern bool wait_for_heatup;
  ...
  #define PSU_PIN_ON()  do{ OUT_WRITE(PS_ON_PIN,  PSU_ACTIVE_LEVEL); powersupply_on = true;  }while(0)
  #define PSU_PIN_OFF() do{ OUT_WRITE(PS_ON_PIN, !PSU_ACTIVE_LEVEL); powersupply_on = false; }while(0)
