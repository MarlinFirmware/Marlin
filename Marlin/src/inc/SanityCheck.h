 ...
 */
    ...
    #error "SET_REMAINING_TIME requires SET_PROGRESS_MANUALLY"
  #elif ENABLED(SET_INTERACTION_TIME)
    #error "SET_INTERACTION_TIME requires SET_PROGRESS_MANUALLY"
  #elif ENABLED(M73_REPORT)
    #error "M73_REPORT requires SET_PROGRESS_MANUALLY"
  #endif
#else
  #if NONE(SET_PROGRESS_PERCENT, SET_REMAINING_TIME, SET_INTERACTION_TIME)
