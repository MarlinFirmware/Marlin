...
#undef IS_LEGACY_TFT
  ...
  #error "Please select only one of TFT_RES_480x320, TFT_RES_480x320, TFT_RES_480x272 or TFT_RES_1024x600."
#endif
  ...
  #error "GRAPHICAL_TFT_UPSCALE must be set to 2, 3 or 4."
#endif
