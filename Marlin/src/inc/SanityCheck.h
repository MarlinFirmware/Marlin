 ...
 */
#if ENABLED(MIN_SOFTWARE_ENDSTOPS) && DISABLED(MIN_SOFTWARE_ENDSTOP_Z) && DISABLED(POLARGRAPH)
  #if IS_KINEMATIC
...
#if ENABLED(MAX_SOFTWARE_ENDSTOPS) && DISABLED(MAX_SOFTWARE_ENDSTOP_Z) && DISABLED(POLARGRAPH)
  #if IS_KINEMATIC
