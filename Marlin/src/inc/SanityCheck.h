 ...
 */
#if TMC_HAS_SW_SERIAL && !defined(TARGET_LPC1768) && ENABLED(ENDSTOP_INTERRUPTS_FEATURE)
 ...
 */
#if TMC_HAS_SW_SERIAL && !defined(__AVR__) && !defined(TARGET_LPC1768) && !defined(TARGET_STM32F1) && !defined(TARGET_STM32F4)
