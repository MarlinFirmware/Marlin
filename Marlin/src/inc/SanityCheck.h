 ...
 */
#if ENABLED(CHECK_ENCODER_ACTIVE_SIGNAL) && DISABLED(REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER)
  #error "CHECK_ENCODER_ACTIVE_SIGNAL requires enabling REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER."
#endif
#if ENABLED(CHECK_ENCODER_ACTIVE_SIGNAL) && !BUTTON_EXISTS(ENC_EN)
