...
#elif defined(EXTRUDER_RUNOUT_SPEED)
  #error "EXTRUDER_RUNOUT_SPEED is now EXTRUDER_RUNOUT_FEEDRATE."
#elif defined(MINIMUM_PLANNER_SPEED)
  #error "MINIMUM_PLANNER_SPEED is now MINIMUM_PLANNER_FEEDRATE."
#elif defined(TOOLCHANGE_FS_RETRACT_SPEED)
  #error "TOOLCHANGE_FS_RETRACT_SPEED is now TOOLCHANGE_FS_RETRACT_FEEDRATE."
#elif defined(TOOLCHANGE_FS_UNRETRACT_SPEED)
  #error "TOOLCHANGE_FS_UNRETRACT_SPEED is now TOOLCHANGE_FS_UNRETRACT_FEEDRATE."
#elif defined(TOOLCHANGE_FS_PRIME_SPEED)
  #error "TOOLCHANGE_FS_PRIME_SPEED is now TOOLCHANGE_FS_PRIME_FEEDRATE."
#elif defined(TOOLCHANGE_FS_WIPE_RETRACT)
  #error "TOOLCHANGE_FS_WIPE_RETRACT is now TOOLCHANGE_FS_WIPE_RETRACT_LENGTH."
#elif defined(DEFAULT_MINIMUMFEEDRATE)
  #error "DEFAULT_MINIMUMFEEDRATE is now DEFAULT_MINIMUM_FEEDRATE."
#elif defined(DEFAULT_MINTRAVELFEEDRATE)
  #error "DEFAULT_MINTRAVELFEEDRATE is now DEFAULT_MIN_TRAVEL_FEEDRATE."
#elif defined(DEFAULT_MINSEGMENTTIME)
  #error "DEFAULT_MINSEGMENTTIME is now DEFAULT_MIN_SEGMENT_TIME."
#endif
 ...
 */
  ...
  #undef MAX_EXTRUDERS
    ...
    #elif !defined(TOOLCHANGE_FS_RETRACT_FEEDRATE)
      #error "TOOLCHANGE_FILAMENT_SWAP requires TOOLCHANGE_FS_RETRACT_FEEDRATE."
    #elif !defined(TOOLCHANGE_FS_PRIME_FEEDRATE)
      #error "TOOLCHANGE_FILAMENT_SWAP requires TOOLCHANGE_FS_PRIME_FEEDRATE."
    #endif
  #endif
