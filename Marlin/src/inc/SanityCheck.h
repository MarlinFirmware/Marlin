...
#if ANY(SHOW_PROGRESS_PERCENT, SHOW_ELAPSED_TIME, SHOW_REMAINING_TIME, SHOW_INTERACTION_TIME) && HAS_LCDPRINT && LCD_HEIGHT < 4
  #error "Displays with less than 4 rows of text can't show progress values"
#endif
