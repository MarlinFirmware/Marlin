 ...
 */
  ...
  #elif !defined(FILAMENT_UNLOAD_PURGE_FEEDRATE) && HAS_EXTRUDERS
    #error "ADVANCED_PAUSE_FEATURE requires FILAMENT_UNLOAD_PURGE_FEEDRATE when extruders are present."
