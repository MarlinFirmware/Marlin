 ...
 */
  ...
  #error "LCD_FULL_PIXEL_HEIGHT is now TFT_HEIGHT. Please update your Configuration.h."
#elif defined(LCD_FULL_PIXEL_WIDTH)
  #error "LCD_FULL_PIXEL_WIDTH is now TFT_WIDTH. Please update your Configuration.h."
