 ...
 */
  ...
  /**
   * Disabled THERMAL_PROTECTION_HOTENDS and THERMAL_PROTECTION_BED with BABYSTEPPING
   */
  #if DISABLED(THERMAL_PROTECTION_HOTENDS) || DISABLED(THERMAL_PROTECTION_BED)
    #error "BABYSTEPPING requires THERMAL_PROTECTION_HOTENDS and THERMAL_PROTECTION_BED"
  #endif
#endif
