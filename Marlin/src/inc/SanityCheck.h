 ...
 */
  ...
  #endif
#elif ENABLED(LCD_SET_PROGRESS_MANUALLY) && !HAS_GRAPHICAL_LCD && !ENABLED(EXTENSIBLE_UI)
  #error "LCD_SET_PROGRESS_MANUALLY requires LCD_PROGRESS_BAR and Graphical LCD or EXTENSIBLE_UI."
#endif
