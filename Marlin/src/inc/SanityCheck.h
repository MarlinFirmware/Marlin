 ...
 */
    ...
    #error "BABYSTEP_ZPROBE_GFX_OVERLAY requires BABYSTEP_ZPROBE_OFFSET."
  #elif ENABLED(BABYSTEP_MESH_Z_GFX_OVERLAY) && DISABLED(BABYSTEP_MESH_Z_OFFSET)
    #error "BABYSTEP_MESH_Z_GFX_OVERLAY requires BABYSTEP_MESH_Z_OFFSET."
