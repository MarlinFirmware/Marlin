 ...
 */
   ...
   */
    ...
    // BLTouch can't run in 5V mode with a 3.3V probe pin
      ...
      #if USE_Z_MIN_PROBE
        #error "BLTOUCH on Z_MIN_PROBE_PIN requires ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMIN_PROBE, ENDSTOPPULLUPS, or BLTOUCH_SET_5V_MODE."
      #elif DISABLED(ONBOARD_ENDSTOPPULLUPS)
