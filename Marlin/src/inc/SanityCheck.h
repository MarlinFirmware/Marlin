...
#undef _TMC_MICROSTEP_IS_VALID
  ...
  #define Z_ENDSTOP_INVERTING !AXIS_DRIVER_TYPE(Z,TMC2209)
  ...
  #elif X_SENSORLESS && X_HOME_DIR < 0 && DISABLED(SPI_ENDSTOPS) && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_XMIN)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_XMIN (or ENDSTOPPULLUPS) when homing to X_MIN."
  #elif X_SENSORLESS && X_HOME_DIR > 0 && DISABLED(SPI_ENDSTOPS) && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_XMAX)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_XMAX (or ENDSTOPPULLUPS) when homing to X_MAX."
  #elif Y_SENSORLESS && Y_HOME_DIR < 0 && DISABLED(SPI_ENDSTOPS) && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_YMIN)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_YMIN (or ENDSTOPPULLUPS) when homing to Y_MIN."
  #elif Y_SENSORLESS && Y_HOME_DIR > 0 && DISABLED(SPI_ENDSTOPS) && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_YMAX)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_YMAX (or ENDSTOPPULLUPS) when homing to Y_MAX."
  #elif Z_SENSORLESS && Z_HOME_DIR < 0 && DISABLED(SPI_ENDSTOPS) && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMIN)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMIN (or ENDSTOPPULLUPS) when homing to Z_MIN."
  #elif Z_SENSORLESS && Z_HOME_DIR > 0 && DISABLED(SPI_ENDSTOPS) && NONE(ONBOARD_ENDSTOPPULLUPS, ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMAX)
    #error "SENSORLESS_HOMING requires ENDSTOPPULLUP_ZMAX (or ENDSTOPPULLUPS) when homing to Z_MAX."
  #elif X_SENSORLESS && X_HOME_DIR < 0 && DISABLED(SPI_ENDSTOPS) && X_MIN_ENDSTOP_INVERTING != X_ENDSTOP_INVERTING
    ...
    #endif
  #elif X_SENSORLESS && X_HOME_DIR > 0 && DISABLED(SPI_ENDSTOPS) && X_MAX_ENDSTOP_INVERTING != X_ENDSTOP_INVERTING
    #if X_ENDSTOP_INVERTING
    ...
    #endif
  #elif Y_SENSORLESS && Y_HOME_DIR < 0 && DISABLED(SPI_ENDSTOPS) && Y_MIN_ENDSTOP_INVERTING != Y_ENDSTOP_INVERTING
    ...
    #endif
  #elif Y_SENSORLESS && Y_HOME_DIR > 0 && DISABLED(SPI_ENDSTOPS) && Y_MAX_ENDSTOP_INVERTING != Y_ENDSTOP_INVERTING
    #if Y_ENDSTOP_INVERTING
    ...
    #endif
  #elif Z_SENSORLESS && Z_HOME_DIR < 0 && DISABLED(SPI_ENDSTOPS) && Z_MIN_ENDSTOP_INVERTING != Z_ENDSTOP_INVERTING
    ...
    #endif
  #elif Z_SENSORLESS && Z_HOME_DIR > 0 && DISABLED(SPI_ENDSTOPS) && Z_MAX_ENDSTOP_INVERTING != Z_ENDSTOP_INVERTING
    #if Z_ENDSTOP_INVERTING
  ...
  #if BOTH(SPI_ENDSTOPS, QUICK_HOME)
    #warning "SPI_ENDSTOPS may work unstable with QUICK_HOME"
  #endif
