 ...
 */
  ...
  #if ENABLED(BLTOUCH) && ANY(ENDSTOPPULLUPS, ENDSTOPPULLUP_ZMIN, ENDSTOPPULLUP_ZMIN_PROBE) && DISABLED(BLTOUCH_FORCE_5V_MODE)
    #error "BLTOUCH Without BLTOUCH_FORCE_5V_MODE requires ENDSTOPPULLUPS."
  #endif
