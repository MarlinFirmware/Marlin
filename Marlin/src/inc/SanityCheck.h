 ...
 */
  ...
  #if ENABLED(DUAL_X_CARRIAGE)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD and DUAL_X_CARRIAGE are incompatible."
  #elif ENABLED(PARKING_EXTRUDER)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD and PARKING_EXTRUDER are incompatible."
  #elif ENABLED(SINGLENOZZLE)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD and SINGLENOZZLE are incompatible."
  #elif ENABLED(EXT_SOLENOID)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD and EXT_SOLENOID are incompatible. (Pins are used twice.)"
  #elif ENABLED(MAGNETIC_PARKING_EXTRUDER)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD and MAGNETIC_PARKING_EXTRUDER are incompatible."
  #elif !PIN_EXISTS(SOL0)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD requires SOL0_PIN."
  #elif !defined(SWITCHING_TOOLHEAD_Y_POS)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD requires SWITCHING_TOOLHEAD_Y_POS"
  #elif !defined(SWITCHING_TOOLHEAD_X_POS)
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD requires SWITCHING_TOOLHEAD_X_POS"
    ...
    #error "ELECTROMAGNETIC_SWITCHING_TOOLHEAD requires SWITCHING_TOOLHEAD_Y_CLEAR."
  #endif
#endif
