 ...
 * System Power Sensor
 */
#if ENABLED(POWER_MONITOR_CURRENT) && (!defined(POWER_MONITOR_CURRENT_PIN) || POWER_MONITOR_CURRENT_PIN < 0)
  #error "POWER_MONITOR_CURRENT requires a valid POWER_MONITOR_CURRENT_PIN."
#elif ENABLED(POWER_MONITOR_VOLTAGE) && (!defined(POWER_MONITOR_VOLTAGE_PIN) || POWER_MONITOR_VOLTAGE_PIN < 0)
  ...
  #error "POWER_MONITOR_CURRENT_PIN and POWER_MONITOR_VOLTAGE_PIN cannot be the same pin."
#endif
