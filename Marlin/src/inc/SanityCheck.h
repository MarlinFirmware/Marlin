 ...
 */
  ...
  #error "POWER_MONITOR_CURRENT requires POWER_MONITOR_CURRENT_PIN to be defined."
...
#elif ENABLED(POWER_MONITOR_POWER) && !BOTH(POWER_MONITOR_CURRENT, POWER_MONITOR_VOLTAGE)
  #error "POWER_MONITOR_POWER requires both POWER_MONITOR_CURRENT and POWER_MONITOR_VOLTAGE."
#endif
