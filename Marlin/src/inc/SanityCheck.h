...
/**
 * Sanity check availability of at least one pattern
 */
#if ENABLED(NOZZLE_CLEAN_FEATURE)
	#if !ANY(NOZZLE_CLEAN_PATTERN_LINE, NOZZLE_CLEAN_PATTERN_ZIGZAG, NOZZLE_CLEAN_PATTERN_CIRCULAR)
		#error "NOZZLE_CLEAN_FEATURE requires at least one of NOZZLE_CLEAN_PATTERN_LINE, NOZZLE_CLEAN_PATTERN_ZIGZAG, NOZZLE_CLEAN_PATTERN_CIRCULAR"
  #endif
  #if (!ENABLED(NOZZLE_CLEAN_PATTERN_LINE) && NOZZLE_CLEAN_DEFAULT_PATTERN == 0) || (!ENABLED(NOZZLE_CLEAN_PATTERN_ZIGZAG) && NOZZLE_CLEAN_DEFAULT_PATTERN == 1) || (!ENABLED(NOZZLE_CLEAN_PATTERN_CIRCULAR) && NOZZLE_CLEAN_DEFAULT_PATTERN == 2)
		#error "NOZZLE_CLEAN_DEFAULT_PATTERN is a non-available pattern"
  #endif
#endif
