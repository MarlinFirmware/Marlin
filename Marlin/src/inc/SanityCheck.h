 ...
 */
  ...
  #elif !defined(LEVELING_AFTER_G28)
    #error "AUTO_BED_LEVELING_UBL used to set LEVELING_AFTER_G28=ACTIVATE_LVL. To keep this behavior set LEVELING_AFTER_G28=ACTIVATE_LVL. Otherwise define it as 'DEACTIVE_LVL'."
  #elif LEVELING_AFTER_G28 != DEACTIVATE_LVL && LEVELING_AFTER_G28 != ACTIVATE_LVL && LEVELING_AFTER_G28 != RESTORE_LVL
    #error "LEVELING_AFTER_G28 must be an option between DEACTIVATE_LVL, ACTIVATE_LVL or RESTORE_LVL."
  #elif LEVELING_AFTER_G34 != DEACTIVATE_LVL && LEVELING_AFTER_G34 != ACTIVATE_LVL && LEVELING_AFTER_G34 != RESTORE_LVL
    #error "LEVELING_AFTER_G34 must be an option between DEACTIVATE_LVL, ACTIVATE_LVL or RESTORE_LVL."
  #elif LEVELING_AFTER_G35 != DEACTIVATE_LVL && LEVELING_AFTER_G35 != ACTIVATE_LVL && LEVELING_AFTER_G35 != RESTORE_LVL
    #error "LEVELING_AFTER_G35 must be an option between DEACTIVATE_LVL, ACTIVATE_LVL or RESTORE_LVL."
  #endif
