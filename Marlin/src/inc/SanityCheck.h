 ...
 */
  ...
  #if MANY(RESTORE_LEVELING_AFTER_G28, RESTORE_LEVELING_AFTER_G28_XY, ENABLE_LEVELING_AFTER_G28)
    #error "Only enable one of: RESTORE_LEVELING_AFTER_G28 or RESTORE_LEVELING_AFTER_G28_XY or ENABLE_LEVELING_AFTER_G28, but no more."
  #endif
#endif
