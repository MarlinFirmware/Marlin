 ...
 */
    ...
    #error "USE_M73_REMAINING_TIME requires SET_PROGRESS_MANUALLY"
  #elif ENABLED(USE_M73_INTERACTION_TIME)
    #error "USE_M73_INTERACTION_TIME requires SET_PROGRESS_MANUALLY"
  #elif ENABLED(M73_REPORT)
    #error "M73_REPORT requires SET_PROGRESS_MANUALLY"
  #endif
#else
  #if NONE(USE_M73_PERCENT, USE_M73_REMAINING_TIME, USE_M73_INTERACTION_TIME)
    #error "SET_PROGRESS_MANUALLY require at least one of USE_M73_PERCENT, USE_M73_REMAINING_TIME, USE_M73_INTERACTION_TIME to be enabled."
  #endif
#endif
#if MANY(SHOW_PROGRESS_PERCENT, SHOW_ELAPSED_TIME, SHOW_REMAINING_TIME, SHOW_INTERACTION_TIME) \
        && ANY(HAS_MARLINUI_HD44780, DOGLCD, IS_DWIN_MARLINUI) \
        && DISABLED(ROTATE_PROGRESS_DISPLAY)
  #error "Enable ROTATE_PROGRESS_DISPLAY or choose only one of SHOW_PROGRESS_PERCENT, SHOW_ELAPSED_TIME, SHOW_REMAINING_TIME, SHOW_INTERACTION_TIME"
#endif
