 ...
 */
  ...
  #if NONE(HAS_MARLINUI_U8GLIB, HAS_GRAPHICAL_TFT, HAS_MARLINUI_HD44780, EXTENSIBLE_UI, DWIN_CREALITY_LCD, IS_DWIN_MARLINU)
    #error "LCD_SET_PROGRESS_MANUALLY requires LCD_PROGRESS_BAR, Character LCD, Graphical LCD, TFT, DWIN_CREALITY_LCD, EXTENSIBLE_UI, OR DWIN MarlinUI."
  #endif
#endif
