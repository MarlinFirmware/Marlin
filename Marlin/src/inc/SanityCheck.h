 ...
 */
#if ENABLED(DEACTIVATE_SERVOS_AFTER_MOVE) && NONE(HAS_Z_SERVO_PROBE, POLARGRAPH) && !defined(SWITCHING_NOZZLE_SERVO_NR) && !defined(SWITCHING_EXTRUDER_SERVO_NR) && !defined(SST_SERVO_NR) && !defined(MAG_MOUNTED_PROBE_SERVO_NR) && !defined(SST_SERVO_NR)
