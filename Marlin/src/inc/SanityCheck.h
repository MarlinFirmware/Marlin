 ...
 */
  ...
  #elif (PAUSE_PARK_RETRACT_LENGTH <=0 || PAUSE_PARK_RECOVER_FEEDRATE <=0) 
    #error "ADVANCED_PAUSE_FEATURE requires PAUSE_PARK_RETRACT_LENGTH >0 and PAUSE_PARK_RECOVER_FEEDRATE >0"
