 ...
 */
  ...
  #error "SMUFF_EMU_MMU2 is obsolete. Define MMU_MODEL as EXPANSIBLE_EMU_MMU2 instead."
#elif ENABLED(SMUFF_EMU_MMU2S)
  #error "SMUFF_EMU_MMU2S is obsolete. Define MMU_MODEL as EXPANSIBLE_EMU_MMU2S instead."
#endif

/**
 * Multi-Material-Unit 2 / EXPANSIBLE_EMU_MMU2 requirements
 */
#if HAS_PRUSA_MMU2
  #if EXTRUDERS != 5
    #undef SINGLENOZZLE
  ...
  #elif DISABLED(ADVANCED_PAUSE_FEATURE)
    static_assert(nullptr == strstr(MMU2_FILAMENT_RUNOUT_SCRIPT, "M600"), "ADVANCED_PAUSE_FEATURE is required to use M600 with PRUSA_MMU2(S) / HAS_EXPANSIBLE_MMU(S).");
  #endif
#endif
#if HAS_EXPANSIBLE_MMU && EXTRUDERS > 15
...
#elif HAS_PRUSA_MMU1 || HAS_EXPANSIBLE_MMU
