 ...
 */
  ...
  #elif HAS_GRAPHIC_LCD
    #error "LCD_PROGRESS_BAR does not apply to graphical displays."
  #elif ENABLED(FILAMENT_LCD_DISPLAY)
    #error "LCD_PROGRESS_BAR and FILAMENT_LCD_DISPLAY are not fully compatible. Comment out this line to use both."
  #endif
#elif ENABLED(LCD_SET_PROGRESS_MANUALLY) && !HAS_GRAPHIC_LCD
 ...
 */
#if !HAS_GRAPHIC_LCD && (ENABLED(SHOW_CUSTOM_BOOTSCREEN) || ENABLED(CUSTOM_STATUS_SCREEN_IMAGE))
 ...
 */
  ...
  #elif ENABLED(BABYSTEP_ZPROBE_GFX_OVERLAY) && !HAS_GRAPHIC_LCD
...
#if ENABLED(MESH_EDIT_GFX_OVERLAY) && (DISABLED(AUTO_BED_LEVELING_UBL) || !HAS_GRAPHIC_LCD)
 ...
 * ULTIPANEL encoder
 */
#if ENABLED(ULTIPANEL) && DISABLED(ULTIPANEL) && DISABLED(SR_LCD_2W_NL) && !defined(SHIFT_CLK)
