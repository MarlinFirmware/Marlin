 ...
 */
    ...
    static_assert(nullptr == strstr(FILAMENT_RUNOUT_SCRIPT, "M600"), "FILAMENT_RUNOUT_SCRIPT cannot contain M600 unless ADVANCED_PAUSE_FEATURE is enabled");
  #endif
#endif
 ...
 */
    ...
    static_assert(nullptr == strstr(MMU2_FILAMENT_RUNOUT_SCRIPT, "M600"), "MMU2_FILAMENT_RUNOUT_SCRIPT cannot contain M600 unless ADVANCED_PAUSE_FEATURE is enabled");
  #endif
#endif
