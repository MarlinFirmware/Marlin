...
#if ENABLED(NO_LCD_SDCARD) && VOLUME_IS(1, LCD)
  #error "VOLUME1 cannot be set to LCD for the enabled TFT. No available SD card reader."
#endif
...
#if HAS_USB_FLASH_DRIVE && !PINS_EXIST(USB_CS, USB_INTR) && DISABLED(USE_OTG_USB_HOST)
  #error "USB_CS_PIN and USB_INTR_PIN are required for HAS_USB_FLASH_DRIVE."
#endif
