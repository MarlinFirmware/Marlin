 ...
 */
#if ENABLED(DEACTIVATE_SERVOS_AFTER_MOVE) && NONE(HAS_Z_SERVO_PROBE,SWITCHING_NOZZLE_SERVO_NR,SWITCHING_EXTRUDER_SERVO_NR,SWITCHING_TOOLHEAD_SERVO_NR,POLARGRAPH)
