...
#undef _ARR_TEST
  ...
  #elif ENABLED(Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS) && !defined(Z_STEPPER_ALIGN_STEPPER_XY)
    #error "Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS requires Z_STEPPER_ALIGN_STEPPER_XY";
  #elif DISABLED(Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS) && !defined(Z_STEPPER_ALIGN_XY)
    #error "Z_STEPPER_AUTO_ALIGN requires Z_STEPPER_ALIGN_XY or Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS"
  #endif
#endif
