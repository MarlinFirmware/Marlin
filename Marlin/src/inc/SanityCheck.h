 ...
 */
    ...
    #error "MESH_BED_LEVELING and BABYSTEP_ZPROBE_OFFSET are incompatible."
  #elif BOTH(BABYSTEP_ZPROBE_OFFSET, BABYSTEP_HOME_OFFSET)
    #error "BABYSTEP_ZPROBE_OFFSET and BABYSTEP_HOME_OFFSET are incompatible."
...
#undef _ARR_TEST
  ...
  #elif ENABLED(BABYSTEP_HOME_OFFSET)
    #error "BABYSTEP_HOME_OFFSET requires NO_WORKSPACE_OFFSETS to be disabled."
  #endif
#endif
