 ...
 */
  ...
  #elif BOTH(MARKFORGED, BABYSTEP_XY)
 ...
 */
  ...
  + ENABLED(COREZY) \
  + ENABLED(MARKFORGED)
  #error "Please enable only one of DELTA, MORGAN_SCARA, COREXY, COREYX, COREXZ, COREZX, COREYZ, COREZY or MARKFORGED."
#endif
 ...
 */
  ...
  #elif CORE_IS_XY || CORE_IS_XZ || IS_MARKFORGED
    #error "DUAL_X_CARRIAGE cannot be used with COREXY, COREYX, COREXZ, COREZX or MARKFORGED."
...
#elif IS_MARKFORGED && X_SENSORLESS != Y_SENSORLESS
...
#undef _ARR_TEST
  ...
  #error "GCODE_MACROS_SLOTS must be a number from 1 to 10."
    ...
    static_assert(!backlash_arr[MARKFORGED_AXIS_X] && !backlash_arr[MARKFORGED_AXIS_Y],
                  "BACKLASH_COMPENSATION can only apply to " STRINGIFY(NORMAL_AXIS) " with your MARKFORGED system.");
  #elif IS_CORE
    constexpr float backlash_arr[] = BACKLASH_DISTANCE_MM;
