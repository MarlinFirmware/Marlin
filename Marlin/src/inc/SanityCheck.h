...
#if ENABLED(CREALITY_BOOTLOADER_INFO_DUMP) && DISABLED(HAL_STM32) && !defined(__STM32F1__)
  #error "CREALITY_BOOTLOADER_INFO_DUMP requires an STM32F1-based Creality v4.2.x board."
#endif
