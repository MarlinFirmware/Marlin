 ...
 */
  ...
  #define TFT_RES_320x240
  #define TFT_INTERFACE_FSMC
#elif ENABLED(PRUSA_MINI_LCD)                                                 // ST7789V
  #define TFT_DRIVER ST7789
  #define TFT_DEFAULT_ORIENTATION (TFT_INVERT_X | TFT_INVERT_Y)
  #define TFT_RES_320x240
  #define TFT_INTERFACE_SPI
...
#define LCD_ENABLED_COUNT 0 \
  ...
  + COUNT_ENABLED(MKS_TS35_V2_0, MKS_ROBIN_TFT24, MKS_ROBIN_TFT28, MKS_ROBIN_TFT32, MKS_ROBIN_TFT35, MKS_ROBIN_TFT43, \
                  MKS_ROBIN_TFT_V1_1R, ANET_ET4_TFT28, ANET_ET5_TFT35, BIQU_BX_TFT70, BTT_TFT35_SPI_V1_0, PRUSA_MINI_LCD) \
