...
#if ANY(IS_DWIN_MARLINUI, HAS_DWIN_E3V2, HAS_DGUS_LCD, MALYAN_LCD, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, NEXTION_TFT, SOVOL_SV06_RTS, E3S1PRO_RTS)
...
#if ANY(HAS_WIRED_LCD, EXTENSIBLE_UI, HAS_DWIN_E3V2, E3S1PRO_RTS)
  /**
...
#define LCD_ENABLED_COUNT 0 \
  ...
  + COUNT_ENABLED(SOVOL_SV06_RTS, E3S1PRO_RTS) \
