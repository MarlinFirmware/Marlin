...
// https://bitbucket.org/fmalpartida/new-liquidcrystal/wiki/schematics#!shiftregister-connection
  ...
  #define NEWPANEL  // Disable this if buttons use old-style shift register
  #define ULTRA_LCD
  #ifndef LCD_WIDTH
    #define LCD_WIDTH 20
  #endif
...
#define HAS_SMART_LCD ENABLED(ULTRA_LCD)
#define HAS_GRAPHIC_LCD ENABLED(DOGLCD)
#define HAS_CHARACTER_LCD (ENABLED(ULTRA_LCD) && !HAS_GRAPHIC_LCD)
#define HAS_LCD_DISPLAY (HAS_SMART_LCD || ENABLED(MALYAN_LCD))
#define HAS_LCD_ENCODER ENABLED(ULTIPANEL)
#define HAS_BUTTONS (HAS_LCD_ENCODER || ENABLED(REPRAPWORLD_KEYPAD))
#define HAS_LCD_MENU (HAS_SMART_LCD && HAS_BUTTONS)
#define HAS_DEBUG_MENU (ENABLED(ULTIPANEL) && ENABLED(LCD_PROGRESS_BAR_TEST))
#define HAS_RESUME_CONTINUE (HAS_BUTTONS || ENABLED(EMERGENCY_PARSER))
