 ...
 */
  ...
  #define DEACTIVATE_LVL  0
  #define ACTIVATE_LVL    1
  #define RESTORE_LVL     2

  #if DISABLED(AUTO_BED_LEVELING_UBL)
    #define PLANNER_LEVELING 1
  #endif
  #if LEVELING_AFTER_G28 != DEACTIVATE_LVL
    #define CHANGES_LEVELING_AFTER_G28 1
  #endif
  #if LEVELING_AFTER_G34 != DEACTIVATE_LVL
    #define CHANGES_LEVELING_AFTER_G34 1
  #endif
  #if LEVELING_AFTER_G35 != DEACTIVATE_LVL
    #define CHANGES_LEVELING_AFTER_G35 1
  #endif
#endif
