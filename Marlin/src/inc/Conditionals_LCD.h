...
#define HAS_PRINT_PROGRESS_PERCENT   HAS_PRINT_PROGRESS
#define HAS_PRINT_PROGRESS_PERMYRIAD (HAS_PRINT_PROGRESS && (ENABLED(PRINT_PROGRESS_SHOW_DECIMALS) || ENABLED(PRINT_PROGRESS_ESTIMATE_TIME_TO_COMPLETION)))
