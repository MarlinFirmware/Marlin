...
#define HAS_FILAMENT_MOTION_SENSOR (FRS(ENCODER) || FRS(PAT9125))
#define HAS_FILAMENT_SENSOR   (FRS(SWITCH) || HAS_FILAMENT_MOTION_SENSOR)
#define HAS_DELAYED_RUNOUT    (HAS_FILAMENT_MOTION_SENSOR || FILAMENT_RUNOUT_DISTANCE_MM > 0)
