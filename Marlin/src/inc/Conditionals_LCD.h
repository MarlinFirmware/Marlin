...
#define EXPANSIBLE_EMU_MMU2   12
#define EXPANSIBLE_EMU_MMU2S  13
  ...
  #endif
  #if MMU_MODEL == EXPANSIBLE_EMU_MMU2 || MMU_MODEL == EXPANSIBLE_EMU_MMU2S
    #define HAS_EXPANSIBLE_MMU 1
  #endif
#endif
...
#undef PRUSA_MMU2
#undef PRUSA_MMU2S
#undef EXPANSIBLE_EMU_MMU2
#undef EXPANSIBLE_EMU_MMU2S
...
// Průša MMU1, MMU(S) 2.0 and EXPANSIBLE_EMU_MMU2(S) force SINGLENOZZLE
#if HAS_MMU
  #define SINGLENOZZLE
#endif
