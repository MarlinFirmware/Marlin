...
#define _HAS_STATE(A,N,M) (USE_##A##N##_##M || (_ANY_STOP(A,N,M) && A##_SPI_SENSORLESS))
...
#endif
#if ANY(HAS_X_MIN_STATE, HAS_X_MAX_STATE)
...
#endif
#if ANY(HAS_Y_MIN_STATE, HAS_Y_MAX_STATE)
...
#endif
#if ANY(HAS_Z_MIN_STATE, HAS_Z_MAX_STATE)
...
#endif
#if ANY(HAS_I_MIN_STATE, HAS_I_MAX_STATE)
...
#endif
#if ANY(HAS_J_MIN_STATE, HAS_J_MAX_STATE)
...
#endif
#if ANY(HAS_K_MIN_STATE, HAS_K_MAX_STATE)
...
#endif
#if ANY(HAS_U_MIN_STATE, HAS_U_MAX_STATE)
...
#endif
#if ANY(HAS_V_MIN_STATE, HAS_V_MAX_STATE)
...
#endif
#if ANY(HAS_W_MIN_STATE, HAS_W_MAX_STATE)
  #define HAS_W_STATE 1
  ...
  #endif
  #if ANY(HAS_X2_MIN_STATE, HAS_X2_MAX_STATE)
  ...
  #endif
  #if ANY(HAS_Y2_MIN_STATE, HAS_Y2_MAX_STATE)
  ...
  #endif
  #if ANY(HAS_Z2_MIN_STATE, HAS_Z2_MAX_STATE)
    ...
    #endif
    #if ANY(HAS_Z3_MIN_STATE, HAS_Z3_MAX_STATE)
    ...
    #endif
    #if ANY(HAS_Z4_MIN_STATE, HAS_Z4_MAX_STATE)
...
#if ANY(HAS_TEMP_HOTEND, HAS_HEATED_BED, HAS_TEMP_CHAMBER, HAS_TEMP_PROBE, HAS_TEMP_COOLER, HAS_TEMP_BOARD, HAS_TEMP_SOC)
  #define HAS_TEMP_SENSOR 1
#endif

#if ALL(HAS_TEMP_CHAMBER, HAS_HEATER_CHAMBER)
...
// PID heating
#if MANY(PIDTEMP, PIDTEMPBED, PIDTEMPCHAMBER)
...
#endif
#if ANY(HAS_MOTOR_CURRENT_PWM_Z, HAS_MOTOR_CURRENT_PWM_E) || ANY_PIN(MOTOR_CURRENT_PWM_X, MOTOR_CURRENT_PWM_Y, MOTOR_CURRENT_PWM_XY, MOTOR_CURRENT_PWM_I, MOTOR_CURRENT_PWM_J, MOTOR_CURRENT_PWM_K, MOTOR_CURRENT_PWM_U, MOTOR_CURRENT_PWM_V, MOTOR_CURRENT_PWM_W)
