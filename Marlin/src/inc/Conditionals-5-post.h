 ...
 */
    ...
    #define PRINTABLE_RADIUS SQRT(PRINTABLE_RADIUS_2)
      ...
      #define MANUAL_X_HOME_POS (L2 + TPARA_TCP_OFFSET_X - TPARA_OFFSET_X)
    #endif
    #ifndef MANUAL_Y_HOME_POS
      #define MANUAL_Y_HOME_POS (0 + TPARA_TCP_OFFSET_Y - TPARA_OFFSET_Y)
    #endif
    #ifndef MANUAL_Z_HOME_POS
      #define MANUAL_Z_HOME_POS (0 + TPARA_TCP_OFFSET_Z - TPARA_OFFSET_Z)
    #endif
  #else
    #define QUICK_HOME
