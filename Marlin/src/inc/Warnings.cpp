...
// Safety Features
  ...
  && NONE(THERMAL_PROTECTION_VARIANCE_MONITOR, SUPPRESS_VARIANCE_MONITOR_WARNING)
  #warning "Warning! THERMAL_PROTECTION_VARIANCE_MONITOR is disabled. Please see Configuration_adv.h for details. (Define SUPPRESS_VARIANCE_MONITOR_WARNING to suppress this.)"
#endif
