...
// Fan Kickstart
#if EFAN_KICKSTART_TIME && !defined(EFAN_KICKSTART_POWER)
  #define EFAN_KICKSTART_POWER 180
#endif
#if CONTROLLERFAN_KICKSTART_TIME && !defined(CONTROLLERFAN_KICKSTART_POWER)
  #define CONTROLLERFAN_KICKSTART_POWER 180
#endif
#if EXTRUDER_AUTO_FAN_KICKSTART_TIME && !defined(EXTRUDER_AUTO_FAN_KICKSTART_POWER)
  #define EXTRUDER_AUTO_FAN_KICKSTART_POWER 180
#endif
