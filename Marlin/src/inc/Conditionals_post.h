...
#if (MAX6675_0_IS_MAX31855 || MAX6675_1_IS_MAX31855)  && IS_LPC1768
  #define MAX6675_HAS_MAX31855_LPC176X 1
  #define LPC1768_HAS_MAX31855 1 
  #if PIN_EXISTS(MAX6675_DO) || PIN_EXISTS(MAX31855_MISO)
...
#if (MAX6675_0_IS_MAX31865 || MAX6675_1_IS_MAX31865) && IS_LPC1768
  #define LPC1768_HAS_MAX31865 1
  #if PIN_EXISTS(MAX6675_DO) || PIN_EXISTS(MAX31865_MISO)
...
#if (MAX6675_0_IS_MAX6675 || MAX6675_1_IS_MAX6675) && IS_LPC1768
  #define LPC1768_HAS_MAX6675 1
  #if PIN_EXISTS(MAX6675_DO) || PIN_EXISTS(MAX6675_MISO)
