...
#if HAS_TEMPERATURE && ANY(HAS_LCD_MENU, DWIN_CREALITY_LCD, CREALITY_DWIN_EXTUI)
 ...
 */
  ...
  #if HAS_LCD_MENU || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT) || ENABLED(CREALITY_DWIN_EXTUI)
