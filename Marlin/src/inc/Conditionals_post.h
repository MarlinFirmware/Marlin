...
#define HAS_JOY_ADC_X (ENABLED(JOY_XY) && PIN_EXISTS(JOY_X))
#define HAS_JOY_ADC_Y (ENABLED(JOY_XY) && PIN_EXISTS(JOY_Y))
#define HAS_JOY_ADC_Z (ENABLED(JOY_XY) && PIN_EXISTS(JOY_Z))
#define HAS_JOY_ADC_EN (ENABLED(JOY_XY) && PIN_EXISTS(JOY_EN))
