...
#define HAS_POWER_MONITOR EITHER(POWER_MONITOR_CURRENT, POWER_MONITOR_VOLTAGE)
#define HAS_POWER_MONITOR_TIMEOUT (HAS_DISPLAY && HAS_POWER_MONITOR && ENABLED(SDSUPPORT))
