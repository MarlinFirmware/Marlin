...
// Multi Sensors
#define HAS_FIL_RUNOUT0 (PIN_EXISTS(FIL_RUNOUT))
#define HAS_FIL_RUNOUT1 (PIN_EXISTS(FIL_RUNOUT2))
#define HAS_FIL_RUNOUT2 (PIN_EXISTS(FIL_RUNOUT3))
#define HAS_FIL_RUNOUT3 (PIN_EXISTS(FIL_RUNOUT4))
#define HAS_FIL_RUNOUT4 (PIN_EXISTS(FIL_RUNOUT5))
