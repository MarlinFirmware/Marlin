...
#define HAS_POWER_MONITOR (ENABLED(POWER_MONITOR_CURRENT) || ENABLED(POWER_MONITOR_VOLTAGE))
#define HAS_POWER_MONITOR_TIMEOUT HAS_POWER_MONITOR
#define HAS_POWER_MONITOR_CURRENT_SENSOR (ENABLED(POWER_MONITOR_CURRENT) && PIN_EXISTS(POWER_MONITOR_CURRENT))
#define HAS_POWER_MONITOR_VOLTAGE_SENSOR (ENABLED(POWER_MONITOR_VOLTAGE) && PIN_EXISTS(POWER_MONITOR_VOLTAGE))
