 ...
 */
  ...
  #if EITHER(HAS_LCD_MENU, EXTENSIBLE_UI) && DISABLED(DGUS_LCD_UI_CREALITY_TOUCH) || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT) && DISABLED(DGUS_LCD_UI_CREALITY_TOUCH)
