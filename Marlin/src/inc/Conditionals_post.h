...
// Sensors
  ...
  #define HAS_FIL_RUNOUT0 (PIN_EXISTS(FIL_RUNOUT_0))
  #define HAS_FIL_RUNOUT1 (PIN_EXISTS(FIL_RUNOUT_1))
  #define HAS_FIL_RUNOUT2 (PIN_EXISTS(FIL_RUNOUT_2))
  #define HAS_FIL_RUNOUT3 (PIN_EXISTS(FIL_RUNOUT_3))
  #define HAS_FIL_RUNOUT4 (PIN_EXISTS(FIL_RUNOUT_4))
