...
#define HAS_POWER_MONITOR_CURRENT_SENSOR (ENABLED(POWER_MONITOR) && ENABLED(POWER_MONITOR_CURRENT) && PIN_EXISTS(POWER_MONITOR_CURRENT))
#define HAS_POWER_MONITOR_VOLTAGE_SENSOR (ENABLED(POWER_MONITOR) && ENABLED(POWER_MONITOR_VOLTAGE) && PIN_EXISTS(POWER_MONITOR_VOLTAGE))
