...
#define NEEDS_THREE_PROBE_POINTS EITHER(AUTO_BED_LEVELING_UBL, AUTO_BED_LEVELING_3POINT) || (ENABLED(Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS) && !defined(Z_STEPPER_ALIGN_XY))
