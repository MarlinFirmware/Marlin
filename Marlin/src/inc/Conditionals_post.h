...
// Thermal protection
#if BOTH(HAS_BED, THERMAL_PROTECTION_BED)
  ...
  #define WATCH_BED 1
#endif
#if BOTH(HAS_CHAMBER, THERMAL_PROTECTION_CHAMBER) && WATCH_CHAMBER_TEMP_PERIOD > 0
  ...
  && (ENABLED(THERMAL_PROTECTION_BED)     || !HAS_BED) \
  && (ENABLED(THERMAL_PROTECTION_CHAMBER) || !HAS_CHAMBER) \
 ...
 */
  ...
  #endif
  #define WRITE_BED(v) WRITE(HEATER_BED_PIN, (v) ^ HEATER_BED_INVERTING)
#endif
 ...
 */
  ...
  #endif
  #define WRITE_CHAMBER(v) WRITE(HEATER_CHAMBER_PIN, (v) ^ HEATER_CHAMBER_INVERTING)
#endif
 ...
 */
  ...
  #endif
  #define WRITE_COOLER(v) WRITE(COOLER_PIN, (v) ^ COOLER_INVERTING)
#endif

#if HAS_HOTEND || HAS_BED || HAS_CHAMBER || HAS_COOLER
  #define HAS_TEMPERATURE 1
#endif

#if HAS_TEMPERATURE && EITHER(HAS_LCD_MENU, DWIN_CREALITY_LCD)
  #ifdef PREHEAT_5_LABEL
    #define PRESET_TEMP_COUNT 5
  #elif defined(PREHEAT_4_LABEL)
    #define PRESET_TEMP_COUNT 4
  #elif defined(PREHEAT_3_LABEL)
    #define PRESET_TEMP_COUNT 3
  #elif defined(PREHEAT_2_LABEL)
    #define PRESET_TEMP_COUNT 2
  #elif defined(PREHEAT_1_LABEL)
    #define PRESET_TEMP_COUNT 1
  #endif
#endif
