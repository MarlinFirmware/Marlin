...
#if BOTH(HAS_TEMP_BED, HAS_HEATER_BED)
...
#endif
#if EITHER(HAS_HEATED_BED, HAS_TEMP_CHAMBER)
  #define BED_OR_CHAMBER 1
#endif
#if ANY(HAS_TEMP_HOTEND, BED_OR_CHAMBER, HAS_TEMP_PROBE)
...
#if EITHER(BED_OR_CHAMBER, HAS_FAN0)
...
#if HAS_BUZZER
  #if BOTH(LCD_FEEDBACK_FREQUENCY_DURATION_MS, LCD_FEEDBACK_FREQUENCY_HZ)
    #define HAS_CHIRP 1
  #endif
#else
