...
#endif
#if PIN_EXISTS(FILAMENTCHANGE)
  #define HAS_FILAMENTCHANGE 1
#endif
#if PIN_EXISTS(DISABLE_STEPPERS)
  #define HAS_DISABLE_STEPPERS 1
#endif
#if PIN_EXISTS(FAN_ON)
  #define HAS_FAN_ON 1
#endif
#if PIN_EXISTS(FAN_OFF)
  #define HAS_FAN_OFF 1
#endif
