...
// Check if bed zone N (1-based) uses thermistor type I
#define _BED_ZONE_SENSOR_IS(I,N) || (BED_ZONE_SENSOR_TYPE_##N == (I))
#define ANY_THERMISTOR_IS(N) ( ANY_E_SENSOR_IS(N) _SENSOR_IS(N,REDUNDANT) \
  ...
  _BED_ZONE_SENSOR_IS(N,1)  _BED_ZONE_SENSOR_IS(N,2)  _BED_ZONE_SENSOR_IS(N,3)  _BED_ZONE_SENSOR_IS(N,4) \
  _BED_ZONE_SENSOR_IS(N,5)  _BED_ZONE_SENSOR_IS(N,6)  _BED_ZONE_SENSOR_IS(N,7)  _BED_ZONE_SENSOR_IS(N,8) \
  _BED_ZONE_SENSOR_IS(N,9)  _BED_ZONE_SENSOR_IS(N,10) _BED_ZONE_SENSOR_IS(N,11) _BED_ZONE_SENSOR_IS(N,12) \
  _BED_ZONE_SENSOR_IS(N,13) _BED_ZONE_SENSOR_IS(N,14) _BED_ZONE_SENSOR_IS(N,15) )
