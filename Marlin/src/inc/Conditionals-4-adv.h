...
#if ANY(HAS_MULTI_EXTRUDER, HAS_MULTI_HOTEND, HAS_PRUSA_MMU2, HAS_PRUSA_MMU3) || (ENABLED(MIXING_EXTRUDER) && MIXING_VIRTUAL_TOOLS > 1)
...
// Let SD_FINISHED_RELEASECOMMAND stand in for SD_FINISHED_STEPPERRELEASE
  ...
  #endif
  #if NONE(HAS_MARLINUI_MENU, HAS_DWIN_E3V2) && !defined(ENCODER_5X_STEPS_PER_SEC) || !defined(ENCODER_10X_STEPS_PER_SEC) || !defined(ENCODER_100X_STEPS_PER_SEC)
 ...
 */
  ...
  #elif ANY(HAS_TRINAMIC_CONFIG, HAS_TRINAMIC_STANDALONE)
