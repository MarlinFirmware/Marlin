...
#define AXIS_DRIVER_TYPE_O(T) _AXIS_DRIVER_TYPE(O,T)  /**SG**/
#define AXIS_DRIVER_TYPE_P(T) _AXIS_DRIVER_TYPE(P,T)  /**SG**/
#define AXIS_DRIVER_TYPE_Q(T) _AXIS_DRIVER_TYPE(Q,T)  /**SG**/
