...
#define LOOP_NUM_AXES(VAR) for (uint8_t VAR = X_AXIS; VAR < NUM_AXES; ++VAR)
#define LOOP_LOGICAL_AXES(VAR) for (uint8_t VAR = X_AXIS; VAR < LOGICAL_AXES; ++VAR)
#define LOOP_DISTINCT_AXES(VAR) for (uint8_t VAR = X_AXIS; VAR < DISTINCT_AXES; ++VAR)
