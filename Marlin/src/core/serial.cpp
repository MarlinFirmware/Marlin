...
void serial_echopair_PGM(PGM_P const s_P, const ROString & v)   { serialprintPGM(s_P); SERIAL_ECHO(v); }
void serial_echopair_PGM(PGM_P const s_P, const StringBase & v) { serialprintPGM(s_P); SERIAL_ECHO((const char*)v); }
