...
PGMSTR(SP_M_STR, " " AXIS7_STR); PGMSTR(SP_O_STR, " " AXIS8_STR); PGMSTR(SP_Q_STR, " " AXIS9_STR);
PGMSTR(SP_E_STR, " E");
...
void print_pos(LINEAR_AXIS_ARGS(const_float_t), PGM_P const prefix/*=nullptr*/, PGM_P const suffix/*=nullptr*/) {
  ...
  SERIAL_ECHOPGM_P(
    LIST_N(DOUBLE(LINEAR_AXES), SP_X_STR, x, SP_Y_STR, y, SP_Z_STR, z, SP_I_STR, i, SP_J_STR, j, SP_K_STR, k, SP_M_STR, m, SP_O_STR, o, SP_Q_STR, q)
  );
