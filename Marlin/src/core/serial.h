...
#define _SELP_2(PRE,V)    serial_echopair_PGM(PSTR(PRE),V)
#define _SELP_3(a,b,c)    do{ _SELP_2(a,b); SERIAL_ECHOPGM(c); }while(0)
...
#define SERIAL_ECHOLNPAIR(...) do{ _SELP_N(NUM_ARGS(__VA_ARGS__),__VA_ARGS__); SERIAL_EOL(); }while(0)
