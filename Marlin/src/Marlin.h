...
extern millis_t max_inactive_time, stepper_inactive_time;
  ...
  #define PSU_PIN_ON()  do{ OUT_WRITE(PS_ON_PIN, LOW  ^ POWER_SUPPLY_PIN_INVERTING); powersupply_on = true; }while(0)
  #define PSU_PIN_OFF() do{ OUT_WRITE(PS_ON_PIN, HIGH ^ POWER_SUPPLY_PIN_INVERTING); powersupply_on = false; }while(0)
