...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter 18.09.03" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Stock Hotend of ANYCUBIC Kossel
  #define DEFAULT_Kp 23.87
  #define DEFAULT_Ki 1.89
  #define DEFAULT_Kd 75.28
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 48.34
  #define DEFAULT_bedKd 332.22
...
#define DELTA
  ...
  #define DELTA_RADIUS 98.4 //mm  Get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -15.4  // Z offset: -below +above  [the nozzle]
