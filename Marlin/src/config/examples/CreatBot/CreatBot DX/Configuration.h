...
#define STRING_CONFIG_H_AUTHOR "(ModMike, Creatbot DX)" // Who made the changes.
...
//#define AUTO_POWER_CONTROL        // Enable automatic control of the PS_ON pin
    ...
    #define POWER_WATCH_BED_TEMP_PERIOD 30
  #endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 46.60
  #define DEFAULT_bedKi .62
  #define DEFAULT_bedKd 875.16
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.74, 78.74, 808, 607.10 }
