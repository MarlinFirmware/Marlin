...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -29     // Y offset: -front +behind [of the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -12.35  // Z offset: -below +above  [of the nozzle]
