...
//
  ...
  void tmc_init(TMCMarlin<TMC2660Stepper, AXIS_LETTER, DRIVER_ID, AXIS_ID> &st,
    ...
    st.rms_current(mA);
    st.microsteps(microsteps);
    IF_ENABLED(EDGE_STEPPING, st.dedge(true));
    st.intpol(interpolate);
    st.diss2g(true); // Disable short to ground protection. Too many false readings?
    IF_ENABLED(TMC_DEBUG, st.rdsel(0b01));
  }
#endif // TMC2660
...
void restore_trinamic_drivers() {
  IF_ENABLED(X_IS_TRINAMIC,  stepperX.push());
  IF_ENABLED(X2_IS_TRINAMIC, stepperX2.push());
  IF_ENABLED(Y_IS_TRINAMIC,  stepperY.push());
  IF_ENABLED(Y2_IS_TRINAMIC, stepperY2.push());
  IF_ENABLED(Z_IS_TRINAMIC,  stepperZ.push());
  IF_ENABLED(Z2_IS_TRINAMIC, stepperZ2.push());
  IF_ENABLED(Z3_IS_TRINAMIC, stepperZ3.push());
  IF_ENABLED(Z4_IS_TRINAMIC, stepperZ4.push());
  IF_ENABLED(I_IS_TRINAMIC,  stepperI.push());
  IF_ENABLED(J_IS_TRINAMIC,  stepperJ.push());
  IF_ENABLED(K_IS_TRINAMIC,  stepperK.push());
  IF_ENABLED(U_IS_TRINAMIC,  stepperU.push());
  IF_ENABLED(V_IS_TRINAMIC,  stepperV.push());
  IF_ENABLED(W_IS_TRINAMIC,  stepperW.push());
  IF_ENABLED(E0_IS_TRINAMIC, stepperE0.push());
  IF_ENABLED(E1_IS_TRINAMIC, stepperE1.push());
  IF_ENABLED(E2_IS_TRINAMIC, stepperE2.push());
  IF_ENABLED(E3_IS_TRINAMIC, stepperE3.push());
  IF_ENABLED(E4_IS_TRINAMIC, stepperE4.push());
  IF_ENABLED(E5_IS_TRINAMIC, stepperE5.push());
  IF_ENABLED(E6_IS_TRINAMIC, stepperE6.push());
  IF_ENABLED(E7_IS_TRINAMIC, stepperE7.push());
}
...
void reset_trinamic_drivers() {
  ...
  IF_ENABLED(X_IS_TRINAMIC,  TMC_INIT(X,  STEALTH_AXIS_X));
  IF_ENABLED(X2_IS_TRINAMIC, TMC_INIT(X2, STEALTH_AXIS_X));
  IF_ENABLED(Y_IS_TRINAMIC,  TMC_INIT(Y,  STEALTH_AXIS_Y));
  IF_ENABLED(Y2_IS_TRINAMIC, TMC_INIT(Y2, STEALTH_AXIS_Y));
  IF_ENABLED(Z_IS_TRINAMIC,  TMC_INIT(Z,  STEALTH_AXIS_Z));
  IF_ENABLED(Z2_IS_TRINAMIC, TMC_INIT(Z2, STEALTH_AXIS_Z));
  IF_ENABLED(Z3_IS_TRINAMIC, TMC_INIT(Z3, STEALTH_AXIS_Z));
  IF_ENABLED(Z4_IS_TRINAMIC, TMC_INIT(Z4, STEALTH_AXIS_Z));
  IF_ENABLED(I_IS_TRINAMIC,  TMC_INIT(I,  STEALTH_AXIS_I));
  IF_ENABLED(J_IS_TRINAMIC,  TMC_INIT(J,  STEALTH_AXIS_J));
  IF_ENABLED(K_IS_TRINAMIC,  TMC_INIT(K,  STEALTH_AXIS_K));
  IF_ENABLED(U_IS_TRINAMIC,  TMC_INIT(U,  STEALTH_AXIS_U));
  IF_ENABLED(V_IS_TRINAMIC,  TMC_INIT(V,  STEALTH_AXIS_V));
  IF_ENABLED(W_IS_TRINAMIC,  TMC_INIT(W,  STEALTH_AXIS_W));
  IF_ENABLED(E0_IS_TRINAMIC, TMC_INIT(E0, STEALTH_AXIS_E));
  IF_ENABLED(E1_IS_TRINAMIC, TMC_INIT(E1, STEALTH_AXIS_E));
  IF_ENABLED(E2_IS_TRINAMIC, TMC_INIT(E2, STEALTH_AXIS_E));
  IF_ENABLED(E3_IS_TRINAMIC, TMC_INIT(E3, STEALTH_AXIS_E));
  IF_ENABLED(E4_IS_TRINAMIC, TMC_INIT(E4, STEALTH_AXIS_E));
  IF_ENABLED(E5_IS_TRINAMIC, TMC_INIT(E5, STEALTH_AXIS_E));
  IF_ENABLED(E6_IS_TRINAMIC, TMC_INIT(E6, STEALTH_AXIS_E));
  IF_ENABLED(E7_IS_TRINAMIC, TMC_INIT(E7, STEALTH_AXIS_E));

  #if USE_SENSORLESS
    IF_ENABLED(X_SENSORLESS,  stepperX.homing_threshold(X_STALL_SENSITIVITY));
    IF_ENABLED(X2_SENSORLESS, stepperX2.homing_threshold(X2_STALL_SENSITIVITY));
    IF_ENABLED(Y_SENSORLESS,  stepperY.homing_threshold(Y_STALL_SENSITIVITY));
    IF_ENABLED(Y2_SENSORLESS, stepperY2.homing_threshold(Y2_STALL_SENSITIVITY));
    IF_ENABLED(Z_SENSORLESS,  stepperZ.homing_threshold(Z_STALL_SENSITIVITY));
    IF_ENABLED(Z2_SENSORLESS, stepperZ2.homing_threshold(Z2_STALL_SENSITIVITY));
    IF_ENABLED(Z3_SENSORLESS, stepperZ3.homing_threshold(Z3_STALL_SENSITIVITY));
    IF_ENABLED(Z4_SENSORLESS, stepperZ4.homing_threshold(Z4_STALL_SENSITIVITY));
    IF_ENABLED(I_SENSORLESS,  stepperI.homing_threshold(I_STALL_SENSITIVITY));
    IF_ENABLED(J_SENSORLESS,  stepperJ.homing_threshold(J_STALL_SENSITIVITY));
    IF_ENABLED(K_SENSORLESS,  stepperK.homing_threshold(K_STALL_SENSITIVITY));
    IF_ENABLED(U_SENSORLESS,  stepperU.homing_threshold(U_STALL_SENSITIVITY));
    IF_ENABLED(V_SENSORLESS,  stepperV.homing_threshold(V_STALL_SENSITIVITY));
    IF_ENABLED(W_SENSORLESS,  stepperW.homing_threshold(W_STALL_SENSITIVITY));
  #endif
