...
constexpr uint32_t isr_shaping_loop_cycles(const int R) { return (TERN0(HAS_ZV_SHAPING, (isr_loop_base_cycles + TERN0(INPUT_SHAPING_X, isr_x_stepper_cycles) + TERN0(INPUT_SHAPING_Y, isr_y_stepper_cycles)) << R)); }
