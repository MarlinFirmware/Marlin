...
void __O2 Endstops::report_states() {
  ...
  DEBUG_ECHOLNPGM_P(axis_is_trusted(X_AXIS) ? PSTR("test_axis_known_x_flag = true") : PSTR("test_axis_known_x_flag = false"));
  DEBUG_ECHOLNPGM_P(axis_is_trusted(Y_AXIS) ? PSTR("test_axis_known_y_flag = true") : PSTR("test_axis_known_y_flag = false"));
  DEBUG_ECHOLNPGM_P(axis_is_trusted(Z_AXIS) ? PSTR("test_axis_known_z_flag = true") : PSTR("test_axis_known_z_flag = false"));
