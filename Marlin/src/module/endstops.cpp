...
void Endstops::update() {
  ...
  #if ENABLED(G38_PROBE_TARGET) && PIN_EXISTS(Z_MIN_PROBE) && !(CORE_IS_XY || CORE_IS_XZ || IS_MARKFORGED)
  ...
  #if CORE_IS_XY || CORE_IS_XZ || IS_MARKFORGED
    #define X_AXIS_HEAD X_HEAD
  #else
    #define X_AXIS_HEAD X_AXIS
  #endif
  #if CORE_IS_XY || CORE_IS_YZ || IS_MARKFORGED
  ...
  bool Endstops::tmc_spi_homing_check() {
    bool hit = false;
      ...
      if (tmc_spi_homing.x && (stepperX.test_stall_status()
        #if (CORE_IS_XY || IS_MARKFORGED) && Y_SPI_SENSORLESS
      ...
      if (tmc_spi_homing.y && (stepperY.test_stall_status()
        #if (CORE_IS_XY || IS_MARKFORGED) && X_SPI_SENSORLESS
