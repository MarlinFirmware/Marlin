...
//#define DEBUG_TOOLCHANGE_MIGRATION_FEATURE
  ...
  inline void pe_solenoid_magnet_on(const uint8_t extruder_num)  { pe_set_solenoid(extruder_num,  PE_MAGNET_ON_STATE); }
  inline void pe_solenoid_magnet_off(const uint8_t extruder_num) { pe_set_solenoid(extruder_num, !PE_MAGNET_ON_STATE); }
