...
public:
  ...
  static bool stow()   { return set_deployed(false); }
    ...
    static float min_x() { return _min_x() TERN_(NOZZLE_AS_PROBE, MINUS_TERN0(HAS_HOME_OFFSET, home_offset.x)); }
    static float max_x() { return _max_x() TERN_(NOZZLE_AS_PROBE, MINUS_TERN0(HAS_HOME_OFFSET, home_offset.x)); }
    static float min_y() { return _min_y() TERN_(NOZZLE_AS_PROBE, MINUS_TERN0(HAS_HOME_OFFSET, home_offset.y)); }
    static float max_y() { return _max_y() TERN_(NOZZLE_AS_PROBE, MINUS_TERN0(HAS_HOME_OFFSET, home_offset.y)); }
