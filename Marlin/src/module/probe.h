    ...
    public:
      ...
      static void get_three_points(T points[3]) {
          ...
          points[2] = xy_float_t(PROBE_PT_3);
            ...
            points[0] = xy_float_t({ _MAX(bedlevel.mesh_min.x, min_x()), _MAX(bedlevel.mesh_min.y, min_y()) });
            points[1] = xy_float_t({ _MIN(bedlevel.mesh_max.x, max_x()), _MAX(bedlevel.mesh_min.y, min_y()) });
            points[2] = xy_float_t({ (_MAX(bedlevel.mesh_min.x, min_x()) + _MIN(bedlevel.mesh_max.x, max_x())) / 2, _MIN(bedlevel.mesh_max.y, max_y()) });
          #else
