...
#define QUAD_SEPARATE_APPLY_STEP(A,V)             \
  ...
  #define X_APPLY_DIR(FWD,Q) do{ X_DIR_WRITE(FWD); X2_DIR_WRITE(INVERT_DIR_X2_VS_X(FWD)); }while(0)
  #if ENABLED(X_DUAL_ENDSTOPS)
  ...
  #define Y_APPLY_DIR(FWD,Q) do{ Y_DIR_WRITE(FWD); Y2_DIR_WRITE(INVERT_DIR_Y2_VS_Y(FWD)); }while(0)
  #if ENABLED(Y_DUAL_ENDSTOPS)
  ...
  #define Z_APPLY_DIR(FWD,Q) do{ \
    Z_DIR_WRITE(FWD); Z2_DIR_WRITE(INVERT_DIR_Z2_VS_Z(FWD)); \
    Z3_DIR_WRITE(INVERT_DIR_Z3_VS_Z(FWD)); Z4_DIR_WRITE(INVERT_DIR_Z4_VS_Z(FWD)); \
  }while(0)
  ...
  #define Z_APPLY_DIR(FWD,Q) do{ \
    Z_DIR_WRITE(FWD); Z2_DIR_WRITE(INVERT_DIR_Z2_VS_Z(FWD)); Z3_DIR_WRITE(INVERT_DIR_Z3_VS_Z(FWD)); \
  }while(0)
  #if ENABLED(Z_MULTI_ENDSTOPS)
  ...
  #define Z_APPLY_DIR(FWD,Q) do{ Z_DIR_WRITE(FWD); Z2_DIR_WRITE(INVERT_DIR_Z2_VS_Z(FWD)); }while(0)
  #if ENABLED(Z_MULTI_ENDSTOPS)
