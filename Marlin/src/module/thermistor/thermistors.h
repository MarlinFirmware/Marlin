...
#define TT_NAME(_N) _TT_NAME(_N)
  ...
  #ifndef HEATER_0_USER_THERMISTOR
  ...
  #ifndef HEATER_1_USER_THERMISTOR
  ...
  #ifndef HEATER_2_USER_THERMISTOR
  ...
  #ifndef HEATER_3_USER_THERMISTOR
  ...
  #ifndef HEATER_4_USER_THERMISTOR
  ...
  #ifndef HEATER_5_USER_THERMISTOR
...
#ifdef THERMISTORBED
  #ifndef HEATER_BED_USER_THERMISTOR
    #define BED_TEMPTABLE TT_NAME(THERMISTORBED)
    #define BED_TEMPTABLE_LEN COUNT(BEDTEMPTABLE)
  #else
  ...
  #ifndef HEATER_CHAMBER_USER_THERMISTOR
    #define CHAMBER_TEMPTABLE TT_NAME(THERMISTORCHAMBER)
    #define CHAMBER_TEMPTABLE_LEN COUNT(CHAMBERTEMPTABLE)
  #else
