...
void Temperature::init() {
  ...
  #if HAS_HEATER_0
    OUT_WRITE(HEATER_0_PIN, LOW ^ HEATER_0_INVERTING);
  #endif
  #if HAS_HEATER_1
    OUT_WRITE(HEATER_1_PIN, LOW ^ HEATER_1_INVERTING);
  #endif
  #if HAS_HEATER_2
    OUT_WRITE(HEATER_2_PIN, LOW ^ HEATER_2_INVERTING);
  #endif
  #if HAS_HEATER_3
    OUT_WRITE(HEATER_3_PIN, LOW ^ HEATER_3_INVERTING);
  #endif
  #if HAS_HEATER_4
    OUT_WRITE(HEATER_3_PIN, LOW ^ HEATER_4_INVERTING);
  #endif
  #if HAS_HEATER_BED
    OUT_WRITE(HEATER_BED_PIN, LOW ^ HEATER_BED_INVERTING);
  #endif
