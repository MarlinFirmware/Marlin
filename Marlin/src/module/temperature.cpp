 ...
 */
  ...
  void Temperature::PID_autotune(const celsius_t target, const heater_id_t heater_id, const int8_t ncycles, const bool set_result/*=false*/) {
    ...
    TERN_(EXTENSIBLE_UI, ExtUI::onPIDTuning(TERN_(PIDTEMPCHAMBER, ischamber ? ExtUI::pidresult_t::PID_CHAMBER_STARTED :) isbed ? ExtUI::pidresult_t::PID_BED_STARTED : ExtUI::pidresult_t::PID_STARTED));
