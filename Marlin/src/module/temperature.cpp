...
void Temperature::init() {
  ...
  #if HAS_HEATER_0
    SET_OUTPUT(HEATER_0_PIN ^ HEATER_0_INVERTING);
  #endif
  #if HAS_HEATER_1
    SET_OUTPUT(HEATER_1_PIN ^ HEATER_1_INVERTING);
  #endif
  #if HAS_HEATER_2
    SET_OUTPUT(HEATER_2_PIN ^ HEATER_2_INVERTING);
  #endif
  #if HAS_HEATER_3
    SET_OUTPUT(HEATER_3_PIN ^ HEATER_3_INVERTING);
  #endif
  #if HAS_HEATER_4
    SET_OUTPUT(HEATER_3_PIN ^ HEATER_4_INVERTING);
  #endif
  #if HAS_HEATER_BED
    SET_OUTPUT(HEATER_BED_PIN ^ HEATER_BED_INVERTING);
  #endif
