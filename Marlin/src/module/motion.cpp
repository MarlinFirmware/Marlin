...
void restore_feedrate_and_scaling() {
  ...
  void update_software_endstops(const AxisEnum axis
      ...
      soft_endstop.max[axis] = (axis == Z_AXIS) ? delta_height MINUS_TERN0(HAS_BED_PROBE, probe.offset.z) : base_max_pos(axis);
...
void set_axis_is_at_home(const AxisEnum axis) {
  ...
  #elif ENABLED(DELTA)
    current_position[axis] = (axis == Z_AXIS) ? delta_height MINUS_TERN0(HAS_BED_PROBE, probe.offset.z) : base_home_pos(axis);
  #else
