...
#define AXIS_IS_SHAPING(A)    TERN0(HAS_##A##_AXIS, (ftMotion.cfg.shaper.A != ftMotionShaper_NONE))
#define AXIS_IS_EISHAPING(A)  TERN0(HAS_##A##_AXIS, WITHIN(ftMotion.cfg.shaper.A, ftMotionShaper_EI, ftMotionShaper_3HEI))
