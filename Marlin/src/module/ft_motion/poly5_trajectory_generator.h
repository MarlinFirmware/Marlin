...
public:
  ...
  void plan(float initial_speed, float final_speed, float acceration, float nominal_speed, float distance) override {
    ...
    const float ldiff = distance + 0.5f * one_over_acc * (this->initial_speed * this->initial_speed + this->final_speed * this->final_speed);
    ...
    T3 = (this->nominal_speed - this->final_speed) * one_over_acc;
    ...
    // Deceration phase
    const float d3 = (this->nominal_speed + this->final_speed) * T3 * 0.5f;
    ...
    dec_c2 = 0.0f;
    dec_c3 = (10.0f * d3 - (6.0f * this->nominal_speed + 4.0f * this->final_speed) * T3) / T3_3;
    dec_c4 = (15.0f * d3 - (8.0f * this->nominal_speed + 7.0f * this->final_speed) * T3) / -T3_4;
    dec_c5 = (6.0f * d3 - 3.0f * (this->nominal_speed + this->final_speed) * T3) / T3_5;
  }
