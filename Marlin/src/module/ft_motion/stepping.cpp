...
uint32_t Stepping::plan() {
  ...
  #define _DIVIDEND_RECIP(A) (stepper_plan.advance_dividend_q0_32.A ==0) ? advance_dividend_reciprocal.A = UINT32_MAX : advance_dividend_reciprocal.A = UINT32_MAX / stepper_plan.advance_dividend_q0_32.A;
