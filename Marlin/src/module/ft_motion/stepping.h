...
constexpr uint8_t TICKS_BITS = __builtin_clzl(FRAME_TICKS + 1UL); // Bits to represent the max value (duration of a frame, +1 one for FTM_NEVER).
constexpr uint8_t FTM_Q_INT = 32 - TICKS_BITS;                    // Bits remaining
