...
/**
 * Melzi (Creality) pin assignments, new board for Ender 2 and CR10S
 *
...
#define BOARD_NAME "Melzi (Creality, new)"
...
#define BEEPER_PIN         -1   // Ender2-Board without beeper
...
/**
  ...
  .                          SCL                         Input  = 1, no twi
  PIN:  17   Port: C1        LCD_PINS_ENABLE             Output = 0, no lcd_en, Port OFF, right pin neopixel
  .                          SDA                         Output = 0, no twi
  ...
  PIN:  27   Port: A4        BEEPER_PIN                  Output = 0, no beeper, Port OFF, left pin
  PIN:  28   Port: A3        LCD_PINS_RS                 Output = 0
  .                          DOGLCD_CS                   Output = 0
  PIN:  29   Port: A2        <unused/unknown>            Input  = 0, Port CHECK, filament_run_out
  PIN:  30   Port: A1        LCD_PINS_D4                 Output = 1, a0-DOGLCD 
