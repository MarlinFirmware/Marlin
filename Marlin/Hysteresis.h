...
public:
  ...
  float GetAxis( int axis ); // returns mm correction value for axis
  void Set( float x_mm, float y_mm, float z_mm, float e_mm ); // set mm correction for all axes
  void SetAxis( int axis, float mm ); // set mm correction for axis
  void ReportToSerial(); // print parameters to serial
