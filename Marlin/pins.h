...
#ifndef AT90USBxx_TEENSYPP_ASSIGNMENTS  // use Teensyduino Teensy++2.0 pin assignments instead of Marlin traditional.
#error The Teensylu/Printrboard assignments depend on AT90USBxx_TEENSYPP_ASSIGNMENTS in fastio.h
#endif
