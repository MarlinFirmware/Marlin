 ...
 *   1. All pin numbers were translated to the TEENSYPP pin mapping.
 ...
 *      download page http://www.pjrc.com/teensy/td_download.html
 ...
 *   e) Check that the fuses support the largest bootloader. I recommend E:F0, H:DB, L:DE.
 *      To check the current fuse settings, open a command window and issue the the
 *      command  "avrdude -c usbtiny -p at90usb1286".  If you need to change the fuses
 *      then issue "avrdude -c usbtiny -p at90usb1286 -U lfuse:w:0xDE:m -U hfuse:w:0xDB:m
 *      -U efuse:w:0xF0:m".
 *      AVRDUDE can be downloaded from http://savannah.nongnu.org/projects/avrdude/
 *   f) In the Arduino IDE select the Printrboard and select the USBtinyISP programmer.
 *   g) In the Arduino IDE click on "burn bootloader".  Don't worry about the "verify
 *      failed at 1F000" error message.
 *   h) The USBtinyISP programmer is no longer needed.  Remove it from the Teensylu.
 *   i) In FASTIO.h uncomment the "#define AT90USBxx_TEENSYPP_ASSIGNMENTS" line.
 *   j) To upload a sketch do the following:
 *       1. remove the jumper
 *       2. press reset
 ...
 */
  ...
  */
  ...
  #error "Oops!  Make sure you have 'Printrboard' or "Teensy++ 2.0" selected from the 'Tools -> Boards' menu."
#endif
...
//
//#define X_STOP_PIN              25  // 13 Rev A pin #
//#define Y_STOP_PIN              26  // 14 Rev A pin #
//#define Z_STOP_PIN              27  // 15 Rev A pin #
//#define E_STOP_PIN              36  // 36 Rev A pin #

//
// Limit Switche definitions that match the silkscreen
//
#define X_STOP_PIN              26  // 14 Rev A pin #
#define Y_STOP_PIN              27  // 15 Rev A pin #
#define Z_STOP_PIN              36  // 36 Rev A pin #
//#define E_STOP_PIN              25  // 13 Rev A pin #

//
// Steppers
//
#define X_STEP_PIN              28  // 0 Rev A pin #
#define X_DIR_PIN               29  // 1 Rev A pin #
#define X_ENABLE_PIN            19  // 39 Rev A pin #

#define Y_STEP_PIN              30  // 2 Rev A pin #
#define Y_DIR_PIN               31  // 3 Rev A pin #
#define Y_ENABLE_PIN            18  // 38 Rev A pin #

#define Z_STEP_PIN              32  // 4 Rev A pin #
#define Z_DIR_PIN               33  // 5 Rev A pin #
#define Z_ENABLE_PIN            17  // 23 Rev A pin #

#define E0_STEP_PIN             34  // 6 Rev A pin #
#define E0_DIR_PIN              35  // 7 Rev A pin #
#define E0_ENABLE_PIN           13  // 19 Rev A pin #
...
// Heaters / Fans
//
#define HEATER_0_PIN            15  // Extruder   21 Rev A pin #
#define HEATER_BED_PIN          14  // 20 Rev A pin #


#define FAN_PIN                 16  // 22 Rev A pin #


//
// Misc. Functions
//
#define SDSS                    20  // 8 Rev A pin #
...
//
  ...
  #define BEEPER_PIN       -1
    ...
    #define BTN_EN1                  3  // 27 Rev A pin #
    #define BTN_EN2                  2  // 26 Rev A pin #
    #define BTN_ENC                 41  // 43 Rev A pin #
    #define SDSS                    38  // use SD card on Panelolu2   40 Rev A pin #
...
// added 9 DEC 2016
#define SPINDLE_SPEED_PIN       24  // 12 Rev A pin #
#define SPINDLE_ENABLE_PIN      39  // should have a pullup resistor on this pin   41 Rev A pin #
#define SPINDLE_DIR_PIN         40  // 42 Rev A pin #

// misc
#define CASE_LIGHT_PIN           0  // 24 Rev A pin #


/**
 *
 *                      alternate  TEENSYPP(Rev B) Rev A               name on
