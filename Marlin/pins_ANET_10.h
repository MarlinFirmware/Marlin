...
/*
 * Additional info
 *   https://github.com/ralf-e/ANET-3D-Board-V1.0 - Anet schematics
 *   http://www.thingiverse.com/thing:2103748 - wiring Anet V1.0 to REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER
 *   https://github.com/SkyNet3D/Marlin/ - SkyNet3D software develepoment for the Anet printers
 *     Many thanks to Hans Raaf (oderwat) for developing the Anet specific software and supporting the Anet community
 *   https://www.facebook.com/skynet3ddevelopment/ - Facebook page for Anet users and the Skynet developed software
*/
