...
#if (defined THERMAL_RUNAWAY_PROTECTION_PERIOD || defined THERMAL_RUNAWAY_PROTECTION_BED_PERIOD) && (THERMAL_RUNAWAY_PROTECTION_PERIOD > 0 || THERMAL_RUNAWAY_PROTECTION_BED_PERIOD > 0)
