...
#define DEFAULT_MAX_ACCELERATION      {1000, 1000, 100, 750}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
