...
const char MSG_SCREEN_UNLOAD_ABORT[] PROGMEM         = "Please wait";
...
const char MSG_SCREEN_LOAD_ABORT[] PROGMEM           = "Please wait";
...
const char MSG_SCREEN_LEVEL_ABORT[] PROGMEM          = "Please wait";
...
const char MSG_SCREEN_UNLOAD_ABORT[] PROGMEM         = "Por favor, espere";
...
const char MSG_SCREEN_UNLOADING_TEXT[] PROGMEM       = "Descargando...";
...
const char MSG_SCREEN_LOAD_ABORT[] PROGMEM           = "Por favor, espere";
...
const char MSG_SCREEN_MOVE_BOX0[] PROGMEM            = "Por favor, espere";
...
const char MSG_SCREEN_CHANGE_BOX[] PROGMEM           = "Pulse para continuar";
