...
#define STRING_CONFIG_H_AUTHOR "(bq Witbox 2 FW v1.4.2)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {2*80,2*80,2*600*8/3,2*102.073}  // default steps per unit for Ultimaker
