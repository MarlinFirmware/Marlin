...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 0//26.3
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0//5
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0//-0.9 //-2.4
