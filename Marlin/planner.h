...
class Planner {
  public:
    ...
    static uint32_t max_acceleration_mm_per_s2[NUM_AXIS_N],    // (mm/s^2) M201 XYZE
                    ...
                    min_segment_time_us;                       // (Вµs) M205 Q
  ...
  private:
    ...
    static uint32_t cutoff_long;
      ...
      volatile static uint32_t block_buffer_runtime_us; //Theoretical block buffer runtime in Вµs
    #endif
  ...
  public:
    ...
    FORCE_INLINE static void discard_current_block() {
      ...
      static uint16_t block_buffer_runtime() {
        ...
        // To translate Вµs to ms a division by 1000 would be required.
