...
const char ES_SCREEN_LOAD_INFO_TEXT[] PROGMEM           = "Introduce el filamento y pulsa el botón para cargarlo";
...
const char ES_SCREEN_CONTACT_TEXT[] PROGMEM             = "www.bq.com Support3D""\x40""bq.com";
...
const char ES_SCREEN_CHANGE_INFO1_TEXT[] PROGMEM        = "Espera a que expulse el filamento y luego ret""\xed""ralo";
...
const char ES_SCREEN_RESET_INIT_TEXT[] PROGMEM          = "¿Restaurar valores?";
const char ES_SCREEN_RESET_INFO_TITLE[] PROGMEM         = "¡Atención!";
const char ES_SCREEN_RESET_INFO_TEXT[] PROGMEM          = "Si continua se restaurarán los valores de fábrica";
