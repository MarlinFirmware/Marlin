...
#define MSG_PREHEAT_1                       _UxGT("EsilГ¤mmitГ¤ PLA")
#define MSG_PREHEAT_1_N                     _UxGT("EsilГ¤mmitГ¤ PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("EsilГ¤. PLA Kaikki")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("EsilГ¤. PLA Alusta")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("EsilГ¤mm. PLA konf")
#define MSG_PREHEAT_2                       _UxGT("EsilГ¤mmitГ¤ ABS")
#define MSG_PREHEAT_2_N                     _UxGT("EsilГ¤mmitГ¤ ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("EsilГ¤. ABS Kaikki")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("EsilГ¤. ABS Alusta")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("EsilГ¤mm. ABS konf")
#define MSG_COOLDOWN                        _UxGT("JГ¤Г¤hdytГ¤")
#define MSG_SWITCH_PS_ON                    _UxGT("Virta pГ¤Г¤lle")
#define MSG_SWITCH_PS_OFF                   _UxGT("Virta pois")
#define MSG_EXTRUDE                         _UxGT("Pursota")
#define MSG_RETRACT                         _UxGT("VedГ¤ takaisin")
...
#define MSG_TEMPERATURE                     _UxGT("LГ¤mpГ¶tila")
#define MSG_MOTION                          _UxGT("Liike")
#define MSG_FILAMENT                        _UxGT("Filament")
#define MSG_VOLUMETRIC_ENABLED              _UxGT("E in mmВі")
...
#define MSG_REFRESH                         _UxGT("PГ¤ivitГ¤")
#define MSG_WATCH                           _UxGT("Seuraa")
#define MSG_PREPARE                         _UxGT("Valmistele")
#define MSG_TUNE                            _UxGT("SГ¤Г¤dГ¤")
#define MSG_PAUSE_PRINT                     _UxGT("KeskeytГ¤ tulostus")
#define MSG_RESUME_PRINT                    _UxGT("Jatka tulostusta")
#define MSG_STOP_PRINT                      _UxGT("PysГ¤ytГ¤ tulostus")
...
#define MSG_CONTROL_RETRACT                 _UxGT("VedГ¤ mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Va. VedГ¤ mm")
#define MSG_CONTROL_RETRACTF                _UxGT("VedГ¤ V")
