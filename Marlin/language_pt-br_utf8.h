...
#define MSG_EDITING_STOPPED                 _UxGT("Fim da Edição da Malha")
...
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Fim da Edição da Malha")
...
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("Nivelação da malha em grade")
...
#define MSG_RESTORE_FAILSAFE                _UxGT("Restauração de emergência")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Erro: Máxima Temperatura")
#define MSG_ERR_MINTEMP                     _UxGT("Erro: Mínima Temperatura")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Erro: Mesa Máxima Temperatura")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Erro: Mesa Mínima Temperatura")
...
#define MSG_DELTA_AUTO_CALIBRATE            _UxGT("Calibração Automática")
...
#define MSG_INFO_PRINT_COUNT                _UxGT("Contagem de Impressão")
...
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("OPÇÕES PARA CONTINUAR:")
...
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temperatura Mínima é ")
...
#define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("extrusão de filamento")
