...
#define MSG_LEVEL_BED_DONE                  _UxGT("Fim nivelaГ§ГЈo!")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Suavizar altura")
#define MSG_SET_HOME_OFFSETS                _UxGT("Compensar origem")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("AlteraГ§ГЈo feita")
...
#define MSG_BED_LEVELING                    _UxGT("NivelaГ§ГЈo Mesa")
#define MSG_LEVEL_BED                       _UxGT("Nivelar Mesa")
#define MSG_LEVEL_CORNERS                   _UxGT("Nivelar Cantos")
#define MSG_NEXT_CORNER                     _UxGT("PrГіximo Canto")
#define MSG_EDITING_STOPPED                 _UxGT("Fim da EdiГ§ГЈo")
...
#define MSG_UBL_BC_INSERT                   _UxGT("CalГ§ar e calibrar")
#define MSG_UBL_BC_INSERT2                  _UxGT("Medir")
#define MSG_UBL_BC_REMOVE                   _UxGT("Remover e calibrar")

#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Indo para o PrГіximo")
...
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Fim da EdiГ§ГЈo")
...
#define MSG_UBL_MESH_HEIGHT_AMOUNT          _UxGT("Tamanho da ElevaГ§ГЈo")
...
#define MSG_UBL_MESH_LEVELING               _UxGT("NivelaГ§ГЈo da Malha")
#define MSG_UBL_3POINT_MESH_LEVELING        _UxGT("NivelaГ§ГЈo 3 pontos")
#define MSG_UBL_GRID_MESH_LEVELING          _UxGT("NivelaГ§ГЈo Grid")
...
#define MSG_UBL_INFO_UBL                    _UxGT("InformaГ§ГЈo do UBL")
...
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Invalidar prГіximo")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("Ajuste Fino de Todos")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("Ajuar Mais PrГіximo")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Armazenamento Malha")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot de MemГіria")
...
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("CompensaГ§ГЈo Z parou")
...
#define MSG_LED_PRESETS                     _UxGT("ConfiguraГ§ГЈo da Luz")
...
#define MSG_SET_LEDS_DEFAULT                _UxGT("Luz PadrГЈo")
...
#define MSG_VOLUMETRIC_ENABLED              _UxGT("ExtrusГЈo em mm3")
#define MSG_FILAMENT_DIAM                   _UxGT("DiГўmetro Fil.")
#define MSG_ADVANCE_K                       _UxGT("AvanГ§ar K")
#define MSG_CONTRAST                        _UxGT("Contraste")
#define MSG_STORE_EEPROM                    _UxGT("Salvar ConfiguraГ§ГЈo")
#define MSG_LOAD_EEPROM                     _UxGT("Ler ConfiguraГ§ГЈo")
#define MSG_RESTORE_FAILSAFE                _UxGT("Restauro seguro")
#define MSG_INIT_EEPROM                     _UxGT("Iniciar EEPROM")
#define MSG_REFRESH                         LCD_STR_REFRESH _UxGT(" AtualizaГ§ГЈo")
#define MSG_WATCH                           _UxGT("InformaГ§Гµes")
#define MSG_PREPARE                         _UxGT("Preparar")
#define MSG_TUNE                            _UxGT("Ajustar")
#define MSG_PAUSE_PRINT                     _UxGT("Pausar impressГЈo")
#define MSG_RESUME_PRINT                    _UxGT("Resumir impressГЈo")
...
#define MSG_PRINT_ABORTED                   _UxGT("ImpressГЈo Abortada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("PARADA DE EMERGГЉNCIA")
...
#define MSG_AUTORETRACT                     _UxGT("RetraГ§ГЈo AutomГЎtica")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("ESCAPE TГ‰RMICO")
#define MSG_ERR_MAXTEMP                     _UxGT("Erro:Temp MГЎxima")
#define MSG_ERR_MINTEMP                     _UxGT("Erro:Temp MГ­nima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Erro:Temp Mesa MГЎx")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Erro:Temp Mesa MГ­n")
...
#define MSG_DELTA_SETTINGS                  _UxGT("ConfiguraГ§ГЈo Delta")
#define MSG_DELTA_AUTO_CALIBRATE            _UxGT("Auto-CalibraГ§ГЈo")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("ForГ§a do Motor")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Continuar ImpressГЈo")
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp. MГ­nima Г© ")
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Bocal: ")
#define MSG_ERR_HOMING_FAILED               _UxGT("Falha ao ir Г  origem")
#define MSG_ERR_PROBING_FAILED              _UxGT("Falha ao sondar")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("remoГ§ГЈo de filamento")

  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Coloque Filamento")
  #define MSG_FILAMENT_CHANGE_INSERT_2      _UxGT("pressione o botГЈo")
  #define MSG_FILAMENT_CHANGE_INSERT_3      _UxGT("para continuar...")

  #define MSG_FILAMENT_CHANGE_HEAT_1        _UxGT("Pressione o botГЈo")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1     _UxGT("Esperando extrusГЈo")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2     _UxGT("de filamento")

  #define MSG_FILAMENT_CHANGE_RESUME_1      _UxGT("Esperando impressГЈo")
